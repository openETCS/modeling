...
edit::addRMSG 20 {nid_message 3 m_ack 1 nid_lrbg 42600902} {
  ...
  q_scale     1
  n_iter      0
  d_mamode(0) 235   m_mamode(0) 0   v_mamode(0) 127   l_mamode(0) 110   l_ackmamode(0) 50   q_mamode(0) 0
}
...
# 360m: MSG 3 (Pkt 15, 41, 5, 21, 27), LRBG 906
edit::addRMSG 360 {nid_message 3 m_ack 1 nid_lrbg 42600906} {
  nid_packet 15
  q_dir      1
  q_scale    1
  v_loa      0
  ...
  q_scale    1
  n_iter     12
  d_link(0) 175  q_newcountry(0) 0  nid_bg(0) 907   q_linkorientation(0) 1   q_linkreaction(0) 0   q_locacc(0) 2
  d_link(1) 169  q_newcountry(1) 0  nid_bg(1) 908   q_linkorientation(1) 1   q_linkreaction(1) 0   q_locacc(1) 2
  d_link(2)  55  q_newcountry(2) 0  nid_bg(2) 909   q_linkorientation(2) 1   q_linkreaction(2) 0   q_locacc(2) 2
  d_link(3) 428  q_newcountry(3) 0  nid_bg(3) 910   q_linkorientation(3) 1   q_linkreaction(3) 0   q_locacc(3) 2
  d_link(4)  54  q_newcountry(4) 0  nid_bg(4) 911   q_linkorientation(4) 1   q_linkreaction(4) 0   q_locacc(4) 2
  d_link(5) 238  q_newcountry(5) 0  nid_bg(5) 912   q_linkorientation(5) 1   q_linkreaction(5) 0   q_locacc(5) 2
  d_link(6) 54   q_newcountry(6) 0  nid_bg(6) 913   q_linkorientation(6) 1   q_linkreaction(6) 0   q_locacc(6) 2
  d_link(7) 172  q_newcountry(7) 0  nid_bg(7) 914   q_linkorientation(7) 1   q_linkreaction(7) 0   q_locacc(7) 2
  d_link(8) 55   q_newcountry(8) 0  nid_bg(8) 915   q_linkorientation(8) 1   q_linkreaction(8) 0   q_locacc(8) 2
  d_link(9) 152  q_newcountry(9) 0  nid_bg(9) 916   q_linkorientation(9) 1   q_linkreaction(9) 0   q_locacc(9) 2
  d_link(10) 141 q_newcountry(10) 0 nid_bg(10) 917  q_linkorientation(10) 1  q_linkreaction(10) 0  q_locacc(10) 2
  d_link(11) 53  q_newcountry(11) 0 nid_bg(11) 918  q_linkorientation(11) 1  q_linkreaction(11) 0  q_locacc(11) 2
  d_link(12) 471 q_newcountry(12) 0 nid_bg(12) 919  q_linkorientation(12) 1  q_linkreaction(12) 0  q_locacc(12) 2
}
...
# 1700m: MSG 3 (Pkt 15, 41, 5, 21, 27), LRBG 912
