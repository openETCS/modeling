...
edit::addRMSG 20 {nid_message 3 m_ack 1 nid_lrbg 42600902} {
  ...
  d_link(1) 985  q_newcountry(1) 0   nid_bg(1) 904   q_linkorientation(1) 1   q_linkreaction(1) 0   q_locacc(1) 2
  d_link(2) 1985 q_newcountry(2) 0   nid_bg(2) 905   q_linkorientation(2) 1   q_linkreaction(2) 0   q_locacc(2) 2
  d_link(3) 2985 q_newcountry(3) 0   nid_bg(3) 906   q_linkorientation(3) 1   q_linkreaction(3) 0   q_locacc(3) 2
  d_link(4) 3985 q_newcountry(4) 0   nid_bg(4) 907   q_linkorientation(4) 1   q_linkreaction(4) 0   q_locacc(4) 2
} {
  nid_packet    21
  q_dir         1
  q_scale       1
...
track::title "User Story 13: Movement Authority ([clock format [clock seconds] -format {%d.%m.%y %R}])"
