...
D3.6 deploys the SRS Subset 26 Functional Model. The deliverable consists of the Scade Model.
The release is stored on Github under the follwoing link:
\url{https://github.com/openETCS/modeling/releases/tag/v0.1-D3.6.1}.

The First Iteration functionality is documented in the following design specification:
