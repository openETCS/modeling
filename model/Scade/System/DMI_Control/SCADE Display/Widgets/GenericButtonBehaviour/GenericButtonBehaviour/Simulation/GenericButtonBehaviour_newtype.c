...
static SimEnumValUtils SSM_ST_SM1_values[] = {
    { "Released", SSM_st_Released_SM1},
    { "Released", SSM_st_Released_SM1},
    { "Pressed", SSM_st_Pressed_SM1},
    { "Pressed", SSM_st_Pressed_SM1},
};
...
{
    *(SSM_ST_SM1*)pValue = SSM_st_Released_SM1;
    return 1;
}
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_SM1_no_trans", 0},
    { "Released:<1>", SSM_TR_Released_1_SM1},
    { "Released:<1>", SSM_TR_Released_1_SM1},
    { "Pressed:<1>", SSM_TR_Pressed_1_SM1},
    { "Pressed:<1>", SSM_TR_Pressed_1_SM1},
};
