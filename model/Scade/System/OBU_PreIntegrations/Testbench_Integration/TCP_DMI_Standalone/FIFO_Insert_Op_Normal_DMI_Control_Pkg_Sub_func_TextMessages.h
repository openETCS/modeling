...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  array__31785 /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Insert_Op_Normal::queue */ queue;
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  array__31785 /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Insert_Op_Normal::queue */ rem_queue;
  /* ---------------------  sub nodes' contexts  --------------------- */
