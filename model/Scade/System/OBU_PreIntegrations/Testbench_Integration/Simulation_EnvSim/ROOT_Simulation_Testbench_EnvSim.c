  ...
  outC_ROOT_Simulation_Testbench_EnvSim *outC)
{
  ...
  /* Testbench_EnvSim::ROOT_Simulation::_L240 */
  static TIU_Output_msg_API_TIU_Pkg _L240;
  /* Testbench_EnvSim::ROOT_Simulation::_L241 */
  static RadioManagement_T_API_RadioCommunication_Pkg _L241;
  /* Testbench_EnvSim::ROOT_Simulation::_L245 */
  static M_TrainTrack_Message_T_TM_radio_messages _L245;
  /* Testbench_EnvSim::ROOT_Simulation::_L258 */
