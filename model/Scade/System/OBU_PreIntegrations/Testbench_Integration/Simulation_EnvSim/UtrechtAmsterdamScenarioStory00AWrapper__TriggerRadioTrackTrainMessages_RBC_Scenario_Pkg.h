...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Amstel_RBC_Scenario_Pkg /* 1 */ _9_Context_1;
  outC_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer_RBC_Scenario_Pk /* 1 */ _8_Context_1;
  outC_Triggers_Sheet07_RBC_Scenario_Pkg /* 1 */ _7_Context_1;
  outC_Triggers_Sheet08A_RBC_Scenario_Pkg /* 1 */ _6_Context_1;
  outC_Triggers_Sheet08B_RBC_Scenario_Pkg /* 2 */ Context_2;
  outC_Triggers_Sheet09_RBC_Scenario_Pkg /* 1 */ _5_Context_1;
  outC_Triggers_Sheet11_RBC_Scenario_Pkg /* 1 */ _4_Context_1;
  outC_Triggers_Sheet12_RBC_Scenario_Pkg /* 1 */ _3_Context_1;
  outC_Triggers_Sheet13_RBC_Scenario_Pkg /* 1 */ _2_Context_1;
  outC_Triggers_Sheet14_RBC_Scenario_Pkg /* 1 */ _1_Context_1;
  outC_Triggers_UserStory13_RBC_Scenario_Pkg /* 1 */ Context_1;
