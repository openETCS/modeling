  ...
  *Stacksize_new = Stacksize_old + 4;
  if (_L34) {
    ...
    kcg_copy_array__165722(
      &(*Buffer_Out)[0],
      (array__165722 *) &(*Message_In)[1]);
    kcg_copy_array__158696(&(*Buffer_Out)[4], &_L40);
  }
  else {
    ...
    kcg_copy_array__156467(
      &(*Buffer_Out)[0],
      (array__156467 *) &(*Message_In)[0]);
  }
  kcg_copy_array__166215(&(*Buffer_Out)[5], (array__166215 *) &(*Buffer_In)[0]);
}
