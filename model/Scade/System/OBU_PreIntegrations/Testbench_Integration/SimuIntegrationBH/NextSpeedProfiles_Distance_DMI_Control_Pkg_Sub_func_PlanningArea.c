  ...
  outC_NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  outC->_L40 = 0.0;
  for (i2 = 0; i2 < 10; i2++) {
    outC->SpeedProfiles_Distance[i2] = 0.0;
  }
}
...
void NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea(
  ...
  outC_NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  kcg_copy_array_real_32(&outC->_L32, inSpeedProfiles_Distance);
  ...
  kcg_copy_array_real_10(&outC->SpeedProfiles_Distance, &outC->_L38);
}
