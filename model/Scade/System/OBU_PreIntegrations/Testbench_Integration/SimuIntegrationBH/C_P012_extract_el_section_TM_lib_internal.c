...
{
  /* TM_lib_internal::C_P012_extract_el_section::_L1 */
  static kcg_int _L1;
  /* TM_lib_internal::C_P012_extract_el_section::_L2 */
  static P012_sections_array_flat_T_TM _L2;
  /* TM_lib_internal::C_P012_extract_el_section::_L3 */
  static kcg_int _L3;
  /* TM_lib_internal::C_P012_extract_el_section::_L5 */
  static kcg_int _L5;
  /* TM_lib_internal::C_P012_extract_el_section::_L6 */
  static kcg_int _L6;
  /* TM_lib_internal::C_P012_extract_el_section::element */
  static kcg_int element;
  
  _L1 = offset;
  kcg_copy_P012_sections_array_flat_T_TM(&_L2, flat);
  _L3 = modulo;
  _L5 = _L1 + _L3;
  if ((0 <= _L5) & (_L5 < 128)) {
    _L6 = _L2[_L5];
