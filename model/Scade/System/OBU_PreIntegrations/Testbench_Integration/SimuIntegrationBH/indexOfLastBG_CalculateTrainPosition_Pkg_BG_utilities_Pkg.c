  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::indexValid */ kcg_bool *indexValid)
{
  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L1 */
  static kcg_int _L1;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L3 */
  static kcg_int _L3;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L4 */
  static positionedBGs_T_TrainPosition_Types_Pck _L4;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L5 */
  static kcg_int _L5;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L6 */
  static kcg_bool _L6;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L12 */
  static kcg_int _L12;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L10 */
  static kcg_bool _L10;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L9 */
  static kcg_bool _L9;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L8 */
  static kcg_bool _L8;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L7 */
  static positionedBG_T_TrainPosition_Types_Pck _L7;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L13 */
  static kcg_bool _L13;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastBG::_L14 */
