  ...
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::l_doubtunder */ L_DOUBTUNDER l_doubtunder)
{
  ...
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::_L1 */
  static L_DOUBTUNDER _L1;
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::_L10 */
  static kcg_int _L10;
  /* TM_conversions::CAST_L_DOUBTUNDER_to_int::_L11 */
  static kcg_int _L11;
