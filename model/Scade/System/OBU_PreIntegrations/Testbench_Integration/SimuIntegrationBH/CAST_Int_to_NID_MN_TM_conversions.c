  ...
  /* TM_conversions::CAST_Int_to_NID_MN::nid_mn_int */ kcg_int nid_mn_int)
{
  ...
  /* TM_conversions::CAST_Int_to_NID_MN::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_NID_MN::_L5 */
  static kcg_int _L5;
  /* TM_conversions::CAST_Int_to_NID_MN::_L4 */
  static kcg_bool _L4;
  /* TM_conversions::CAST_Int_to_NID_MN::_L3 */
  static kcg_int _L3;
  /* TM_conversions::CAST_Int_to_NID_MN::_L2 */
  static kcg_bool _L2;
