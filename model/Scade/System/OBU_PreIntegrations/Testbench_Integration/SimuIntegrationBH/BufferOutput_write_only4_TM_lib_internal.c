  ...
  /* TM_lib_internal::BufferOutput_write_only4::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* TM_lib_internal::BufferOutput_write_only4::_L1 */
  static M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _L1;
  /* TM_lib_internal::BufferOutput_write_only4::_L2 */
  static kcg_int _L2;
  /* TM_lib_internal::BufferOutput_write_only4::_L3 */
  static M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _L3;
  /* TM_lib_internal::BufferOutput_write_only4::_L4 */
  static array_170759 _L4;
  /* TM_lib_internal::BufferOutput_write_only4::_L5 */
  static M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _L5;
  /* TM_lib_internal::BufferOutput_write_only4::_L6 */
  static array_169506 _L6;
  /* TM_lib_internal::BufferOutput_write_only4::_L7 */
  static kcg_int _L7;
  /* TM_lib_internal::BufferOutput_write_only4::_L8 */
  static kcg_int _L8;
  /* TM_lib_internal::BufferOutput_write_only4::_L9 */
  static M_TrainTrack_Message_T_TM_radio_messages _L9;
  /* TM_lib_internal::BufferOutput_write_only4::_L10 */
  static kcg_int _L10;
  /* TM_lib_internal::BufferOutput_write_only4::_L11 */
  static kcg_bool _L11;
  /* TM_lib_internal::BufferOutput_write_only4::_L12 */
  static kcg_int _L12;
  ...
  kcg_copy_array_169506(&_L6, (array_169506 *) &_L3[0]);
  kcg_copy_array_170759(&_L4, (array_170759 *) &_L1[0]);
  kcg_copy_array_169506(&_L5[0], &_L6);
  kcg_copy_array_170759(&_L5[4], &_L4);
