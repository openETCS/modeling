  ...
  /* TM_conversions::CAST_NID_ENGINE_to_int::nid_ctraction */ NID_CTRACTION nid_ctraction)
{
  ...
  /* TM_conversions::CAST_NID_ENGINE_to_int::_L1 */
  static NID_CTRACTION _L1;
  /* TM_conversions::CAST_NID_ENGINE_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_NID_ENGINE_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_NID_ENGINE_to_int::_L10 */
  static kcg_int _L10;
  /* TM_conversions::CAST_NID_ENGINE_to_int::_L11 */
  static kcg_int _L11;
