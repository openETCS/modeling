...
typedef struct {
  ...
  kcg_bool /* SoMProcedure_Pkg::SoM_NTC_SN::Level_NTC_and_Mode_SN */ Level_NTC_and_Mode_SN_reset_act;
  kcg_bool /* SoMProcedure_Pkg::SoM_NTC_SN::Level_NTC_and_Mode_SN */ Level_NTC_and_Mode_SN_reset_nxt;
