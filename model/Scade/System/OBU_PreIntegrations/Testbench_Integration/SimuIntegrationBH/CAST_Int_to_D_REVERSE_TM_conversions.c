  ...
  /* TM_conversions::CAST_Int_to_D_REVERSE::d_reverse_int */ kcg_int d_reverse_int)
{
  ...
  /* TM_conversions::CAST_Int_to_D_REVERSE::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_D_REVERSE::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_D_REVERSE::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_D_REVERSE::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_D_REVERSE::_L6 */
  static kcg_int _L6;
