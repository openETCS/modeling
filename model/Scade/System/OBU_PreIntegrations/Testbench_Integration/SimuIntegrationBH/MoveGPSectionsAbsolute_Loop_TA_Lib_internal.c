...
{
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::offset */
  static L_internal_Type_Obu_BasicTypes_Pkg _1_offset;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::IfBlock1::then::_L1 */
  ...
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::IfBlock1::else::else::_L1 */
  static kcg_int _L15_IfBlock1;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::offset */
  static L_internal_Type_Obu_BasicTypes_Pkg _2_offset;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::IfBlock1::else::then::_L1 */
  ...
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L1 */
  static kcg_int _L1;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L2 */
  ...
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L7 */
  static GradientProfile_t_TrackAtlasTypes _L7;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L9 */
  static Gradient_section_t_TrackAtlasTypes _L9;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L10 */
  static kcg_int _L10;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L130 */
  static L_internal_Type_Obu_BasicTypes_Pkg _L130;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L141 */
  static L_internal_Type_Obu_BasicTypes_Pkg _L141;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L143 */
  static kcg_bool _L143;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L254 */
  static L_internal_Type_Obu_BasicTypes_Pkg _L254;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L255 */
  static kcg_int _L255;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L256 */
  static Gradient_section_t_TrackAtlasTypes _L256;
  /* TA_Lib_internal::MoveGPSectionsAbsolute_Loop::_L257 */
  static kcg_int _L257;
  
  _L1 = i;
  kcg_copy_GradientProfile_t_TrackAtlasTypes(&_L2, ProfileIn);
  if ((0 <= _L1) & (_L1 < 50)) {
    kcg_copy_Gradient_section_t_TrackAtlasTypes(&_L6, &_L2[_L1]);
  }
  else {
  ...
  _L257 = 0;
  kcg_copy_Gradient_section_t_TrackAtlasTypes(&_L256, &_L6);
  if (kcg_true) {
    _L256.Loc_LRBG = _L257;
  }
  _L130 = _L6.Loc_Absolute;
  _L143 = _L6.valid;
  ...
  _L10 = _L130 + _L254;
  kcg_copy_Gradient_section_t_TrackAtlasTypes(&_L9, &_L256);
  if (kcg_true) {
    _L9.Loc_Absolute = _L10;
  }
  kcg_copy_GradientProfile_t_TrackAtlasTypes(&_L7, &_L2);
  if ((0 <= _L1) & (_L1 < 50)) {
    kcg_copy_Gradient_section_t_TrackAtlasTypes(&_L7[_L1], &_L9);
  }
  kcg_copy_GradientProfile_t_TrackAtlasTypes(ProfileOut, &_L7);
}
