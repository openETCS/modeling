  ...
  /* TA_SpeedProfiles::SP_STM_SystemSpeed::STM_SystemSpeed */ SSP_cat_t_TA_MRSP *STM_SystemSpeed)
{
  ...
  /* TA_SpeedProfiles::SP_STM_SystemSpeed::_L1 */
  static ReceivedMessage_T_Common_Types_Pkg _L1;
  /* TA_SpeedProfiles::SP_STM_SystemSpeed::_L2 */
  static SSP_cat_t_TA_MRSP _L2;
  /* TA_SpeedProfiles::SP_STM_SystemSpeed::_L3 */
  static kcg_bool _L3;
  ...
  kcg_copy_SSP_cat_t_TA_MRSP(STM_SystemSpeed, &_L2);
  _L3 = reset;
  _1_noname = _L3;
}
