...
{
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L8 */
  static kcg_bool _L8;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L7 */
  static T_TRAIN _L7;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L6 */
  static kcg_bool _L6;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L5 */
  static Q_MARQSTREASON _L5;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L4 */
  static Q_MARQSTREASON _L4;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L3 */
  static T_TRAIN _L3;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L2 */
  static Radio_TrainTrack_Header_T_Radio_Types_Pkg _L2;
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentHeader::_L1 */
  static kcg_bool _L1;
