  ...
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::t_nvovtrp_int */ kcg_int t_nvovtrp_int)
{
  ...
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_T_NVOVTRP::_L6 */
  static kcg_int _L6;
