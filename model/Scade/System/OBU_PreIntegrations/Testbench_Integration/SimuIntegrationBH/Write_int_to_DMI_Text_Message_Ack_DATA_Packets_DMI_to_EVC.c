  ...
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::dmi_text_message_ack_ct */ DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg *dmi_text_message_ack_ct)
{
  ...
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L8 */
  static DMI_Text_Message_Ack_int_array_T_DATA _L8;
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L12 */
  static DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg _L12;
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L15 */
  static kcg_bool _L15;
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L14 */
  static kcg_int _L14;
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L13 */
  static kcg_int _L13;
  /* DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack::_L16 */
  static DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg _L16;
  ...
  _L15 = _L13 == _L14;
  ck_every = _L15;
  /* ck_Write_int_to_DMI_Text_Message_Ack */ if (ck_every) {
    /* 1 */
    C_int_to_DMI_Text_Message_Ack_DATA_Packets_DMI_to_EVC(&_L8, &op_call);
  }
  ...
  /* ck_Write_int_to_DMI_Text_Message_Ack */ if (ck_every) {
    ...
    kcg_copy_DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg(&_L12, &_L16);
  }
  kcg_copy_DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg(
