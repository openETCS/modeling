  ...
  /* TM_lib_internal::C_P021_unflatten_sections::sections */ P021_OBU_sectionlist_enum_T_TM *sections)
{
  ...
  /* TM_lib_internal::C_P021_unflatten_sections::_L1 */
  static P021_sections_array_flat_T_TM _L1;
  /* TM_lib_internal::C_P021_unflatten_sections::_L3 */
  static kcg_int _L3;
  /* TM_lib_internal::C_P021_unflatten_sections::_L5 */
  static array_int_33 _L5;
  /* TM_lib_internal::C_P021_unflatten_sections::_L6 */
  static array_int_99_33 _L6;
  /* TM_lib_internal::C_P021_unflatten_sections::_L7 */
  static kcg_int _L7;
  /* TM_lib_internal::C_P021_unflatten_sections::_L9 */
  static P021_OBU_sectionlist_enum_T_TM _L9;
  /* TM_lib_internal::C_P021_unflatten_sections::_L11 */
  ...
  /* pow */ for (i1 = 0; i1 < 33; i1++) {
    kcg_copy_P021_sections_array_flat_T_TM(&_L6[i1], &_L1);
  }
  _L11 = nid_packet_ok;
  if (_L11) {
    for (i = 0; i < 33; i++) {
      /* 1 */
      C_P021_us_array_TM_lib_internal(i, _L5[i], &_L6[i], &cond_iterw, &_L9[i]);
      _L7 = i + 1;
      if (!cond_iterw) {
        break;
      }
  ...
  kcg_copy_P021_OBU_sectionlist_enum_T_TM(sections, &_L9);
  noname = _L7;
}
