...
typedef struct {
  ...
  kcg_bool /* ComputeModesConditions::Failure_Occured */ rem_Failure_Occured;
  ...
  M_LEVEL /* ComputeModesConditions::Current_Level */ rem_Current_Level;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Procedure_Train_Trip_Procedures /* 1 */ _10_Context_1;
  outC_Procedure_StartOfMission_Procedures /* 1 */ _9_Context_1;
  outC_Procedure_Train_Reversing_Procedures /* 1 */ _8_Context_1;
  outC_ToTrip_Conditions /* 1 */ _7_Context_1;
