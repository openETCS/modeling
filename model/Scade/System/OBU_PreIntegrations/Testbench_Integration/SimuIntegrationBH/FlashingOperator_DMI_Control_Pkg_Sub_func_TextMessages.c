...
{
  outC->SM1_fired = _5_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _5_SSM_TR_no_trans_SM1;
  ...
  outC_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  static _6_SSM_TR_SM1 _5_SM1_fired;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static kcg_bool _4_SM1_reset_nxt;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static _4_SSM_ST_SM1 _3_SM1_state_nxt;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::active */
  static kcg_bool _2_active;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::flashigOut */
  static kcg_bool _1_flashigOut;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static _6_SSM_TR_SM1 SM1_fired;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static kcg_bool SM1_reset_nxt;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static _4_SSM_ST_SM1 SM1_state_nxt;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::active */
  static kcg_bool active;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::flashigOut */
  static kcg_bool flashigOut;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1::start::Counter */
  static kcg_int last_Counter_SM1_start;
  static kcg_bool _9_noname;
  static kcg_bool noname;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static _6_SSM_TR_SM1 _8_SM1_fired_strong;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static kcg_bool _7_SM1_reset_act;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1 */
  static _4_SSM_ST_SM1 _6_SM1_state_act;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1::stop */
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::FlashingOperator::SM1::start */
  ...
  /* sel_SM1 */ switch (outC->SM1_state_sel) {
    case SSM_st_stop_SM1 :
      ...
      if (br_1_guard_SM1_stop) {
        _6_SM1_state_act = SSM_st_start_SM1;
      }
      else {
        _6_SM1_state_act = SSM_st_stop_SM1;
      }
  ...
  /* sel_SM1 */ switch (outC->SM1_state_sel) {
    case SSM_st_stop_SM1 :
      if (br_1_guard_SM1_stop) {
        _8_SM1_fired_strong = SSM_TR_stop_1_SM1;
      }
      else {
        _8_SM1_fired_strong = _5_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _8_SM1_fired_strong;
      break;
    case SSM_st_start_SM1 :
      if (br_1_guard_SM1_start) {
        SM1_fired_strong = SSM_TR_start_1_SM1;
      }
      else {
  ...
  /* act_SM1 */ switch (outC->SM1_state_act) {
    case SSM_st_stop_SM1 :
      ...
      _3_SM1_state_nxt = SSM_st_stop_SM1;
    ...
    case SSM_st_start_SM1 :
      ...
      outC->_L19_SM1_start = 20;
      outC->_L20_SM1_start = last_Counter_SM1_start;
      outC->_L18_SM1_start = outC->_L19_SM1_start == outC->_L20_SM1_start;
      outC->_L23_SM1_start = 0;
      outC->_L22_SM1_start = 1;
      outC->_L21_SM1_start = outC->_L20_SM1_start + outC->_L22_SM1_start;
      /* 3 */ if (outC->_L18_SM1_start) {
        outC->_L17_SM1_start = outC->_L23_SM1_start;
      }
      else {
        outC->_L17_SM1_start = outC->_L21_SM1_start;
      }
      outC->Counter_SM1_start = outC->_L17_SM1_start;
      outC->_L25_SM1_start = outC->Counter_SM1_start;
      outC->_L26_SM1_start = 0;
      outC->_L24_SM1_start = outC->_L25_SM1_start == outC->_L26_SM1_start;
      outC->_L9_SM1_start = !outC->_L3_SM1_start;
      /* 2 */ if (outC->_L24_SM1_start) {
      ...
      outC->active = active;
      SM1_state_nxt = SSM_st_start_SM1;
