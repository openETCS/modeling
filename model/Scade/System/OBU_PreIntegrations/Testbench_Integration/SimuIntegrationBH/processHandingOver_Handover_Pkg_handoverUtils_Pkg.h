...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  p131_q_rbcTransitionOrder_T_Handover_Pkg /* linear::Memory::_L8 */ _L8_1;
  kcg_bool /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::handoverInprogress */ handoverInprogress;
  kcg_bool /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::useInformationFromAcceptingRBC_loc */ useInformationFromAcceptingRBC_loc;
