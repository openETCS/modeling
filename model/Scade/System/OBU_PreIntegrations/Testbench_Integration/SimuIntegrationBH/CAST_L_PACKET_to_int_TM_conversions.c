  ...
  /* TM_conversions::CAST_L_PACKET_to_int::l_packet */ L_PACKET l_packet)
{
  ...
  /* TM_conversions::CAST_L_PACKET_to_int::_L1 */
  static L_PACKET _L1;
  /* TM_conversions::CAST_L_PACKET_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_L_PACKET_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_L_PACKET_to_int::_L12 */
  static kcg_int _L12;
  /* TM_conversions::CAST_L_PACKET_to_int::_L13 */
  static kcg_int _L13;
