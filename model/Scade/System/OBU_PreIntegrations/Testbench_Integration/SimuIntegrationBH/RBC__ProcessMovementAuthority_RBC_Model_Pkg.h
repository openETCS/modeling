...
typedef struct {
  ...
  kcg_bool /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM */ MOVEMENT_AUTHORITY_SM_reset_act;
  kcg_bool /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM */ MOVEMENT_AUTHORITY_SM_reset_nxt;
