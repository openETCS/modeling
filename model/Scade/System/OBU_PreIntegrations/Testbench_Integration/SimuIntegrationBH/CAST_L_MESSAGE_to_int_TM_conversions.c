  ...
  /* TM_conversions::CAST_L_MESSAGE_to_int::l_message */ L_MESSAGE l_message)
{
  ...
  /* TM_conversions::CAST_L_MESSAGE_to_int::_L1 */
  static L_MESSAGE _L1;
  /* TM_conversions::CAST_L_MESSAGE_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_L_MESSAGE_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_L_MESSAGE_to_int::_L12 */
  static kcg_int _L12;
  /* TM_conversions::CAST_L_MESSAGE_to_int::_L13 */
  static kcg_int _L13;
