  ...
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::d_tafdisplay_int */ kcg_int d_tafdisplay_int)
{
  ...
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L6 */
  static kcg_int _L6;
  /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::d_tafdisplay */
  static D_TAFDISPLAY d_tafdisplay;
  
  _L1 = d_tafdisplay_int;
  d_tafdisplay = _L1;
