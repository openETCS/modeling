  ...
  /* TM_conversions::C_P041_tracksim_compr::P005_compressed */ CompressedPacketData_T_Common_Types_Pkg *P005_compressed)
{
  ...
  /* TM_conversions::C_P041_tracksim_compr::p_size */
  static kcg_int p_size;
  /* TM_conversions::C_P041_tracksim_compr::_L1 */
  static P041_trackside_int_T_TM _L1;
  /* TM_conversions::C_P041_tracksim_compr::_L204 */
  static MetadataElement_T_Common_Types_Pkg _L204;
  /* TM_conversions::C_P041_tracksim_compr::_L206 */
  static kcg_int _L206;
  /* TM_conversions::C_P041_tracksim_compr::_L209 */
  static array_int_395 _L209;
  /* TM_conversions::C_P041_tracksim_compr::_L212 */
  static kcg_int _L212;
  /* TM_conversions::C_P041_tracksim_compr::_L213 */
  static kcg_int _L213;
  /* TM_conversions::C_P041_tracksim_compr::_L336 */
  static kcg_int _L336;
  /* TM_conversions::C_P041_tracksim_compr::_L219 */
  static kcg_int _L219;
  /* TM_conversions::C_P041_tracksim_compr::_L218 */
  static kcg_int _L218;
  /* TM_conversions::C_P041_tracksim_compr::_L217 */
  static kcg_int _L217;
  /* TM_conversions::C_P041_tracksim_compr::_L216 */
  static kcg_int _L216;
  /* TM_conversions::C_P041_tracksim_compr::_L215 */
  static kcg_int _L215;
  /* TM_conversions::C_P041_tracksim_compr::_L214 */
  static kcg_bool _L214;
  /* TM_conversions::C_P041_tracksim_compr::_L356 */
  static Q_DIR _L356;
  /* TM_conversions::C_P041_tracksim_compr::_L371 */
  static kcg_int _L371;
  /* TM_conversions::C_P041_tracksim_compr::_L370 */
  static kcg_int _L370;
  /* TM_conversions::C_P041_tracksim_compr::_L369 */
  static kcg_int _L369;
  /* TM_conversions::C_P041_tracksim_compr::_L368 */
  static P041_trackide_sectionlist_T_TM _L368;
  /* TM_conversions::C_P041_tracksim_compr::_L373 */
  static array_int_5 _L373;
  /* TM_conversions::C_P041_tracksim_compr::_L375 */
  static P041_section_int_T_TM _L375;
  /* TM_conversions::C_P041_tracksim_compr::_L376 */
  static P044_other_data_TM_TrainToTrack _L376;
  /* TM_conversions::C_P041_tracksim_compr::_L378 */
  static kcg_int _L378;
  /* TM_conversions::C_P041_tracksim_compr::_L379 */
  static kcg_int _L379;
  /* TM_conversions::C_P041_tracksim_compr::_L380 */
  static P041_sections_array_flat_T_TM _L380;
  /* TM_conversions::C_P041_tracksim_compr::_L381 */
  static array_int_6 _L381;
  /* TM_conversions::C_P041_tracksim_compr::_L383 */
  static CompressedPacketData_T_Common_Types_Pkg _L383;
  /* TM_conversions::C_P041_tracksim_compr::_L384 */
  static array_int_105 _L384;
  /* TM_conversions::C_P041_tracksim_compr::_L386 */
  static array_168759 _L386;
  /* TM_conversions::C_P041_tracksim_compr::_L385 */
  static P041_OBU_sectionlist_int_T_TM _L385;
  /* TM_conversions::C_P041_tracksim_compr::_L387 */
  static kcg_int _L387;
  /* TM_conversions::C_P041_tracksim_compr::_L388 */
  static nid_packet_meta_TM _L388;
  
  kcg_copy_P041_trackside_int_T_TM(&_L1, P041_from_track);
  ...
  kcg_copy_array_int_5(&_L381[0], &_L373);
  kcg_copy_P044_other_data_TM_TrainToTrack(&_L381[5], &_L376);
  _L219 = _L1.M_LEVELTR;
  _L371 = _L1.NID_NTC;
  _L370 = _L1.L_ACKLEVELTR;
  _L375.M_LEVELTR = _L219;
  _L375.NID_NTC = _L371;
  _L375.L_ACKLEVELTR = _L370;
  /* pow */ for (i1 = 0; i1 < 1; i1++) {
    kcg_copy_P041_section_int_T_TM(&_L386[i1], &_L375);
  }
  kcg_copy_P041_trackide_sectionlist_T_TM(&_L368, &_L1.SECTIONS);
  kcg_copy_array_168759(&_L385[0], &_L386);
  kcg_copy_P041_trackide_sectionlist_T_TM(&_L385[1], &_L368);
  /* 1 */ C_P041_flatten_sections_TM_lib_internal(&_L385, &_L380);
  kcg_copy_array_int_6(&_L384[0], &_L381);
  kcg_copy_P041_sections_array_flat_T_TM(&_L384[6], &_L380);
  _L336 = 0;
  /* pow */ for (i = 0; i < 395; i++) {
    _L209[i] = _L336;
  }
  kcg_copy_array_int_105(&_L383[0], &_L384);
  kcg_copy_array_int_395(&_L383[105], &_L209);
  ...
  _L214 = _L1.valid;
  _L206 = 0;
  _L379 = /* 1 */ T_DeterminePacketSizeInt_TM_lib_internal(_L369, 5 + 1 + 3, 3);
  p_size = _L379;
  _L378 = p_size;
  _L213 = 1;
  _L212 = _L378 - _L213;
