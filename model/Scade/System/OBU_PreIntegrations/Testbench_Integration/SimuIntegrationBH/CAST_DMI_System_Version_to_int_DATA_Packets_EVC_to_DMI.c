...
{
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L1 */
  static DMI_System_Version_T_DMI_Messages_EVC_to_DMI_Pkg _L1;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L2 */
  static array_int_3 _L2;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L5 */
  static kcg_bool _L5;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L4 */
  static T_internal_Type_Obu_BasicTypes_Pkg _L4;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L3 */
  static M_VERSION _L3;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L6 */
  static kcg_int _L6;
  /* DATA::Packets::EVC_to_DMI::CAST_DMI_System_Version_to_int::_L7 */
  static kcg_int _L7;
  ...
  _L3 = _L1.system_version;
  _L7 = /* 1 */ CAST_M_VERSION_to_int_TM_conversions(_L3);
  _L2[0] = _L6;
  _L2[1] = _L4;
  _L2[2] = _L7;
  kcg_copy_DMI_System_Version_int_array_T_DATA(dmi_system_version_int, &_L2);
}
