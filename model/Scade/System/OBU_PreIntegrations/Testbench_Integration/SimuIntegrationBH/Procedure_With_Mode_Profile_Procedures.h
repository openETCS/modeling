...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside::Futher_location::SM_Futher_Location */ SM_Futher_Location_reset_nxt_SM_Mode_Profile_By_Trackside_Futher_location;
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside::Futher_location::SM_Futher_Location */ SM_Futher_Location_reset_act_SM_Mode_Profile_By_Trackside_Futher_location;
  ...
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside::Current_Location::SM_Current_Location */ SM_Current_Location_reset_nxt_SM_Mode_Profile_By_Trackside_Current_Location;
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside::Current_Location::SM_Current_Location */ SM_Current_Location_reset_act_SM_Mode_Profile_By_Trackside_Current_Location;
  ...
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside */ SM_Mode_Profile_By_Trackside_reset_act;
  kcg_bool /* Procedures::Procedure_With_Mode_Profile::SM_Mode_Profile_By_Trackside */ SM_Mode_Profile_By_Trackside_reset_nxt;
