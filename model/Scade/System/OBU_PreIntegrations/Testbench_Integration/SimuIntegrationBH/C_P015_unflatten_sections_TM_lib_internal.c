  ...
  /* TM_lib_internal::C_P015_unflatten_sections::sections */ P015_OBU_sectionlist_enum_T_TM *sections)
{
  ...
  /* TM_lib_internal::C_P015_unflatten_sections::_L1 */
  static P015_sections_array_flat_T_TM _L1;
  /* TM_lib_internal::C_P015_unflatten_sections::_L3 */
  static kcg_int _L3;
  /* TM_lib_internal::C_P015_unflatten_sections::_L5 */
  static array_int_32 _L5;
  /* TM_lib_internal::C_P015_unflatten_sections::_L6 */
  static array_int_128_32 _L6;
  /* TM_lib_internal::C_P015_unflatten_sections::_L7 */
  static kcg_int _L7;
  /* TM_lib_internal::C_P015_unflatten_sections::_L9 */
  static P015_OBU_sectionlist_enum_T_TM _L9;
  /* TM_lib_internal::C_P015_unflatten_sections::_L11 */
  static kcg_bool _L11;
  /* TM_lib_internal::C_P015_unflatten_sections::_L12 */
  static kcg_bool _L12;
  /* TM_lib_internal::C_P015_unflatten_sections::_L13 */
  static kcg_int _L13;
  /* TM_lib_internal::C_P015_unflatten_sections::_L14 */
  ...
  /* pow */ for (i1 = 0; i1 < 32; i1++) {
    kcg_copy_P015_sections_array_flat_T_TM(&_L6[i1], &_L1);
  }
  _L11 = nid_packet_ok;
  _L13 = 0;
  _L12 = _L13 < _L3;
  ...
  if (_L14) {
    for (i = 0; i < 32; i++) {
      /* 1 */
      C_P015_us_array_TM_lib_internal(i, _L5[i], &_L6[i], &cond_iterw, &_L9[i]);
      _L7 = i + 1;
      if (!cond_iterw) {
        break;
      }
