  ...
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::l_tafdisplay_int */ kcg_int l_tafdisplay_int)
{
  ...
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L10 */
  static kcg_int _L10;
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L11 */
  static kcg_int _L11;
  /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::l_tafdisplay */
  static L_TAFDISPLAY l_tafdisplay;
  
  _L1 = l_tafdisplay_int;
