...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* Procedures::Procedure_StartOfMission::SM_StartOfMissionProcedure::Procedure_On::SM_SoM_On */ SM_SoM_On_reset_nxt_SM_StartOfMissionProcedure_Procedure_On;
  kcg_bool /* Procedures::Procedure_StartOfMission::SM_StartOfMissionProcedure::Procedure_On::SM_SoM_On */ SM_SoM_On_reset_act_SM_StartOfMissionProcedure_Procedure_On;
  ...
  kcg_bool /* Procedures::Procedure_StartOfMission::SM_StartOfMissionProcedure */ SM_StartOfMissionProcedure_reset_act;
  kcg_bool /* Procedures::Procedure_StartOfMission::SM_StartOfMissionProcedure */ SM_StartOfMissionProcedure_reset_nxt;
  /* ---------------------  sub nodes' contexts  --------------------- */
