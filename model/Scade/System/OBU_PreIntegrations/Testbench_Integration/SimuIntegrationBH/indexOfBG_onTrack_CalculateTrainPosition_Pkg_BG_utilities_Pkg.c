  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::indexValid */ kcg_bool *indexValid)
{
  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L1 */
  static positionedBG_T_TrainPosition_Types_Pck _L1;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L2 */
  static positionedBGs_T_TrainPosition_Types_Pck _L2;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L3 */
  static kcg_bool _L3;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L6 */
  static kcg_int _L6;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L8 */
  static kcg_int _L8;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L9 */
  static kcg_int _L9;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L11 */
  static positionedBGs_T_TrainPosition_Types_Pck _L11;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L12 */
  static positionedBG_T_TrainPosition_Types_Pck _L12;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L17 */
  static kcg_int _L17;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L18 */
  static kcg_bool _L18;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L19 */
  static kcg_bool _L19;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack::_L20 */
