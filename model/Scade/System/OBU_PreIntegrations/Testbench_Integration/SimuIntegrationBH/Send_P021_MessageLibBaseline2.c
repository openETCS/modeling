  ...
  /* MessageLibBaseline2::Send_P021::B_data_out */ CompressedPackets_T_Common_Types_Pkg *B_data_out)
{
  ...
  /* MessageLibBaseline2::Send_P021::_L3 */
  static CompressedPackets_T_Common_Types_Pkg _L3;
  /* MessageLibBaseline2::Send_P021::_L4 */
  static P021_trackside_int_T_TM _L4;
  /* MessageLibBaseline2::Send_P021::_L8 */
  static kcg_bool _L8;
  /* MessageLibBaseline2::Send_P021::_L6 */
  static kcg_bool _L6;
  /* MessageLibBaseline2::Send_P021::_L7 */
  static CompressedPackets_T_Common_Types_Pkg _L7;
  /* MessageLibBaseline2::Send_P021::_L5 */
  static kcg_bool _L5;
  
  kcg_copy_P021_trackside_int_T_TM(&_L4, P021);
  _L5 = _L4.valid;
  ck_every = _L5;
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&_L3, B_data_in);
  /* ck_Send_P021 */ if (ck_every) {
    /* 1 */ Write_P021_TM_trackside(&_L4, &_L3, &_1_op_call, &op_call);
