  ...
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::l_reversearea_int */ kcg_int l_reversearea_int)
{
  ...
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L10 */
  static kcg_int _L10;
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L11 */
  static kcg_int _L11;
  /* TM_conversions::CAST_Int_to_L_REVERSEAREA::l_reversearea */
  static L_REVERSEAREA l_reversearea;
  
  _L1 = l_reversearea_int;
