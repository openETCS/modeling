  ...
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::dmi_speedProfile_int */ DMI_speedProfile_int_array_T_DATA *dmi_speedProfile_int)
{
  ...
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L1 */
  static DMI_speedProfile_T_DMI_Types_Pkg _L1;
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L3 */
  static kcg_bool _L3;
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L2 */
  static DMI_SpeedProfileArray_T_DMI_Types_Pkg _L2;
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L4 */
  static kcg_int _L4;
  ...
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L9 */
  static P044_other_data_TM_TrainToTrack _L9;
  /* DATA::Variables::CAST_DMI_speedProfile_to_int::_L10 */
  static array_int_129 _L10;
  
  kcg_copy_DMI_speedProfile_T_DMI_Types_Pkg(&_L1, dmi_speedProfile);
  kcg_copy_DMI_SpeedProfileArray_T_DMI_Types_Pkg(&_L2, &_L1.speedProfiles);
  ...
  _L9[0] = _L4;
  kcg_copy_P044_other_data_TM_TrainToTrack(&tmp[0], &_L9);
  kcg_copy_array_int_32(&tmp[1], &_L5);
  kcg_copy_array_int_33(&tmp1[0], &tmp);
  kcg_copy_array_int_32(&tmp1[33], &_L6);
  kcg_copy_array_int_65(&tmp2[0], &tmp1);
  kcg_copy_array_int_32(&tmp2[65], &_L7);
  kcg_copy_array_int_97(&_L10[0], &tmp2);
  kcg_copy_array_int_32(&_L10[97], &_L8);
  kcg_copy_DMI_speedProfile_int_array_T_DATA(dmi_speedProfile_int, &_L10);
}
