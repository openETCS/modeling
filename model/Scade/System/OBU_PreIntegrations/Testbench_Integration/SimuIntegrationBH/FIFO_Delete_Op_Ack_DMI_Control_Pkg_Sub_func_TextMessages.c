  ...
  outC_FIFO_Delete_Op_Ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  static kcg_int i1;
  static kcg_int i;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L1 */
  static array_170229 _L1;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L2 */
  static kcg_int _L2;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L3 */
  static array_int_5 _L3;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L5 */
  static array_170229 _L5;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L6 */
  static array_170229 _L6;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L7 */
  static array_170229 _L7;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L8 */
  static array_169894 _L8;
  /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_Delete_Op_Ack::_L9 */
  static array_168496 _L9;
  
  kcg_copy_array_170229(&_L5, queueIn);
  kcg_copy_array_170229(&_L7, queueIn);
  kcg_copy_array_169894(&_L8, (array_169894 *) &_L7[1]);
  kcg_copy_MsgStructure(
    &_L9[0],
    (MsgStructure *) &cMsgStructure_DMI_Control_Pkg);
  kcg_copy_array_169894(&_L6[0], &_L8);
  kcg_copy_array_168496(&_L6[4], &_L9);
  _L2 = DeletePos;
  ...
  kcg_copy_array_170229(&outC->Queue, &_L1);
}
