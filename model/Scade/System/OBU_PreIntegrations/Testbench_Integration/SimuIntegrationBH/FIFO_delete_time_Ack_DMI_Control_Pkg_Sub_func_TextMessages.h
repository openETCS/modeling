...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_delete_time_Ack::new_mm_array */ new_mm_array;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::FIFO_delete_time_Ack::new_hh_array */ new_hh_array;
  /* -----------------------  no local probes  ----------------------- */
