  ...
  /* TM_conversions::CAST_Int_to_D_NVSTFF::d_nvstff_int */ kcg_int d_nvstff_int)
{
  ...
  /* TM_conversions::CAST_Int_to_D_NVSTFF::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_D_NVSTFF::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_D_NVSTFF::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_D_NVSTFF::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_D_NVSTFF::_L6 */
  static kcg_int _L6;
