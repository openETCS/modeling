  ...
  /* TM_conversions::CAST_Int_to_NID_RBC::nid_rbc_int */ kcg_int nid_rbc_int)
{
  ...
  /* TM_conversions::CAST_Int_to_NID_RBC::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_NID_RBC::_L5 */
  static kcg_int _L5;
  /* TM_conversions::CAST_Int_to_NID_RBC::_L4 */
  static kcg_bool _L4;
  /* TM_conversions::CAST_Int_to_NID_RBC::_L3 */
  static kcg_int _L3;
  /* TM_conversions::CAST_Int_to_NID_RBC::_L2 */
  static kcg_bool _L2;
