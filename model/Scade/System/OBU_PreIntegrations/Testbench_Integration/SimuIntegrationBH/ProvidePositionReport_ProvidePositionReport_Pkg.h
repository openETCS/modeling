...
typedef struct {
  ...
  ModeLevel2PositionReport_T_ProvidePositionReport_Pkg /* ProvidePositionReport_Pkg::ProvidePositionReport::modeLevelStatus */ rem_modeLevelStatus;
  odometry_T_Obu_BasicTypes_Pkg /* ProvidePositionReport_Pkg::ProvidePositionReport::odometry */ rem_odometry;
  /* ---------------------  sub nodes' contexts  --------------------- */
