  ...
  /* TM_conversions::CAST_D_REF_to_int::d_ref */ D_REF d_ref)
{
  ...
  /* TM_conversions::CAST_D_REF_to_int::_L1 */
  static D_REF _L1;
  /* TM_conversions::CAST_D_REF_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_D_REF_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_D_REF_to_int::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_D_REF_to_int::_L10 */
  static kcg_int _L10;
