  ...
  /* TM_conversions::CAST_D_TRACKCOND_to_int::d_trackcond */ D_TRACKCOND d_trackcond)
{
  ...
  /* TM_conversions::CAST_D_TRACKCOND_to_int::_L1 */
  static D_TRACKCOND _L1;
  /* TM_conversions::CAST_D_TRACKCOND_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_D_TRACKCOND_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_D_TRACKCOND_to_int::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_D_TRACKCOND_to_int::_L6 */
  static kcg_int _L6;
