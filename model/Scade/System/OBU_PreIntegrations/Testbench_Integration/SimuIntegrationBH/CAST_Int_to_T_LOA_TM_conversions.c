  ...
  /* TM_conversions::CAST_Int_to_T_LOA::t_loa_int */ kcg_int t_loa_int)
{
  ...
  /* TM_conversions::CAST_Int_to_T_LOA::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_T_LOA::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_T_LOA::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_T_LOA::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_T_LOA::_L6 */
  static kcg_int _L6;
