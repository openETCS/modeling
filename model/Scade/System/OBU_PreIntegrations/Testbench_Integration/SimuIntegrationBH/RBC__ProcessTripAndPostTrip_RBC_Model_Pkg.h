...
typedef struct {
  ...
  kcg_bool /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM */ TRIP_AND_POST_TRIP_SM_reset_act;
  kcg_bool /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM */ TRIP_AND_POST_TRIP_SM_reset_nxt;
