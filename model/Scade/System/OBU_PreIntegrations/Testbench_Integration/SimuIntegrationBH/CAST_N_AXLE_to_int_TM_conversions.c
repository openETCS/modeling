  ...
  /* TM_conversions::CAST_N_AXLE_to_int::n_axlle */ N_AXLE n_axlle)
{
  ...
  /* TM_conversions::CAST_N_AXLE_to_int::_L1 */
  static N_AXLE _L1;
  /* TM_conversions::CAST_N_AXLE_to_int::_L12 */
  static kcg_bool _L12;
  /* TM_conversions::CAST_N_AXLE_to_int::_L11 */
  static kcg_int _L11;
  /* TM_conversions::CAST_N_AXLE_to_int::_L10 */
  static kcg_bool _L10;
  /* TM_conversions::CAST_N_AXLE_to_int::_L9 */
  static kcg_int _L9;
