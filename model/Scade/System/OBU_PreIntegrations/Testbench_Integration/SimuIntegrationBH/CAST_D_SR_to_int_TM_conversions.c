  ...
  /* TM_conversions::CAST_D_SR_to_int::d_sr */ D_SR d_sr)
{
  ...
  /* TM_conversions::CAST_D_SR_to_int::_L1 */
  static D_SR _L1;
  /* TM_conversions::CAST_D_SR_to_int::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_D_SR_to_int::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_D_SR_to_int::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_D_SR_to_int::_L6 */
  static kcg_int _L6;
