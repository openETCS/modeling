  ...
  /* TM_lib_internal::SEND_WriteMessageHeader::NewEndAddr */ kcg_int *NewEndAddr)
{
  ...
  static kcg_int i;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L1 */
  static Metadata_T_Common_Types_Pkg _L1;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L4 */
  static kcg_bool _L4;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L5 */
  static kcg_int _L5;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L8 */
  static Metadata_T_Common_Types_Pkg _L8;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L9 */
  static MetadataElement_T_Common_Types_Pkg _L9;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L16 */
  static kcg_int _L16;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L17 */
  static kcg_int _L17;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L18 */
  static kcg_int _L18;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L22 */
  static kcg_int _L22;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L23 */
  static Metadata_T_Common_Types_Pkg _L23;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L24 */
  static Metadata_T_Common_Types_Pkg _L24;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L31 */
  static kcg_int _L31;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L32 */
  static kcg_bool _L32;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L33 */
  static kcg_int _L33;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L34 */
  static kcg_int _L34;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L35 */
  static kcg_int _L35;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L36 */
  static kcg_int _L36;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L37 */
  static kcg_int _L37;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L43 */
  static MetadataElement_T_Common_Types_Pkg _L43;
  /* TM_lib_internal::SEND_WriteMessageHeader::_L44 */
