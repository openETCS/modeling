...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  struct_169664 /* ManageProcedure_Pkg::Master_Procedure::_L214 */ fby__L214;
  struct_169664 /* ManageProcedure_Pkg::Master_Procedure::_L212 */ fby__L212;
  kcg_bool /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train::SM3 */ SM3_reset_nxt_SM1_Awakness_of_Train;
  kcg_bool /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train::SM3 */ SM3_reset_act_SM1_Awakness_of_Train;
  ...
  _61_SSM_ST_SM1 /* ManageProcedure_Pkg::Master_Procedure::SM1 */ SM1_state_nxt;
  kcg_bool /* ManageProcedure_Pkg::Master_Procedure::SM1 */ SM1_reset_act;
