  ...
  /* TM_conversions::CAST_NID_MN_to_int::nid_mn */ NID_MN nid_mn)
{
  ...
  /* TM_conversions::CAST_NID_MN_to_int::_L1 */
  static NID_MN _L1;
  /* TM_conversions::CAST_NID_MN_to_int::_L5 */
  static kcg_int _L5;
  /* TM_conversions::CAST_NID_MN_to_int::_L4 */
  static kcg_bool _L4;
  /* TM_conversions::CAST_NID_MN_to_int::_L3 */
  static kcg_int _L3;
  /* TM_conversions::CAST_NID_MN_to_int::_L2 */
  static kcg_bool _L2;
