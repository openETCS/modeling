  ...
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::v_maxtrain_int */ kcg_int v_maxtrain_int)
{
  ...
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L6 */
  static kcg_int _L6;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L11 */
  static kcg_int _L11;
  /* TM_conversions::CAST_Int_to_V_MAXTRAIN::_L12 */
  static kcg_int _L12;
