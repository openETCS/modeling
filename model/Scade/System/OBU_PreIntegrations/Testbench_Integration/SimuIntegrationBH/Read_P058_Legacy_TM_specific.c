  ...
  /* TM_specific::Read_P058_Legacy::P058_legacy_out */ P58_PositionReportParameters_T_Packet_Types_Pkg *P058_legacy_out)
{
  ...
  static kcg_bool _L1;
  /* TM_specific::Read_P058_Legacy::_L3 */
  static CompressedPackets_T_Common_Types_Pkg _L3;
  /* TM_specific::Read_P058_Legacy::_L4 */
  static P58_PositionReportParameters_T_Packet_Types_Pkg _L4;
  
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&_L3, Message_IN);
  /* 1 */ Read_P058_TM(&_L3, &_L1, &_L2);
  ck_every = _L1;
  /* ck_Read_P058_Legacy */ if (ck_every) {
    /* 1 */ C_P058_to_legacy_t_TM_conversions(&_L2, &op_call);
    kcg_copy_P58_PositionReportParameters_T_Packet_Types_Pkg(&_L4, &op_call);
  }
  else {
