  ...
  /* TM_lib_internal::BufferOutput_read_only::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* TM_lib_internal::BufferOutput_read_only::index */
  static kcg_int index;
  /* TM_lib_internal::BufferOutput_read_only::_L1 */
  static M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _L1;
  /* TM_lib_internal::BufferOutput_read_only::_L2 */
  static kcg_int _L2;
  /* TM_lib_internal::BufferOutput_read_only::_L3 */
  static M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _L3;
  /* TM_lib_internal::BufferOutput_read_only::_L8 */
  static kcg_int _L8;
  /* TM_lib_internal::BufferOutput_read_only::_L9 */
  static kcg_int _L9;
  /* TM_lib_internal::BufferOutput_read_only::_L12 */
  static M_TrainTrack_Message_T_TM_radio_messages _L12;
  /* TM_lib_internal::BufferOutput_read_only::_L13 */
  static kcg_bool _L13;
  /* TM_lib_internal::BufferOutput_read_only::_L14 */
  static kcg_int _L14;
  /* TM_lib_internal::BufferOutput_read_only::_L15 */
  static kcg_int _L15;
  /* TM_lib_internal::BufferOutput_read_only::_L18 */
  static kcg_int _L18;
  /* TM_lib_internal::BufferOutput_read_only::_L19 */
  static kcg_int _L19;
  /* TM_lib_internal::BufferOutput_read_only::_L21 */
  static M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _L21;
  /* TM_lib_internal::BufferOutput_read_only::_L22 */
  ...
  index = _L15;
  _L19 = index;
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(&_L21, &_L1);
  if ((0 <= _L19) & (_L19 < 100)) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(&_L21[_L19], &_L22);
  }
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(Buffer_Out, &_L21);
  *Stacksize_new = _L15;
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(&noname, &_L3);
  _L18 = index;
  if ((0 <= _L18) & (_L18 < 100)) {
