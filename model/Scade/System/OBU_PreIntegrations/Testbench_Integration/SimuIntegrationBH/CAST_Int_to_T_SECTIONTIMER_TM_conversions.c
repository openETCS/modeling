  ...
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::t_sectiontimer_int */ kcg_int t_sectiontimer_int)
{
  ...
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::_L1 */
  static kcg_int _L1;
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::_L9 */
  static kcg_bool _L9;
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::_L8 */
  static kcg_bool _L8;
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::_L7 */
  static kcg_int _L7;
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::_L6 */
  static kcg_int _L6;
  /* TM_conversions::CAST_Int_to_T_SECTIONTIMER::t_sectiontimer */
  static T_SECTIONTIMER t_sectiontimer;
  
  _L1 = t_sectiontimer_int;
  t_sectiontimer = _L1;
  _L6 = 0;
  _L7 = 1023;
  _L9 = _L1 > _L7;
