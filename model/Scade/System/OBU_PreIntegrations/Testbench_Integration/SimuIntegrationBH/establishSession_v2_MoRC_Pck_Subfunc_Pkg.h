...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  _27_SSM_ST_SM1 /* MoRC_Pck::Subfunc_Pkg::establishSession_v2::SM1 */ SM1_state_nxt;
  kcg_bool /* MoRC_Pck::Subfunc_Pkg::establishSession_v2::SM1 */ SM1_reset_act;
  kcg_bool /* MoRC_Pck::Subfunc_Pkg::establishSession_v2::SM1 */ SM1_reset_nxt;
  /* ---------------------  sub nodes' contexts  --------------------- */
