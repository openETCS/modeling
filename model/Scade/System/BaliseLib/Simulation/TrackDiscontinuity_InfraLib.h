...
/* ========================  input structure  ====================== */
typedef struct {
  TrackSectionData_T_InfraLib /* InfraLib::TrackDiscontinuity::SectionData_in */ SectionData_in;
  kcg_int /* InfraLib::TrackDiscontinuity::StartSection */ StartSection;
  kcg_int /* InfraLib::TrackDiscontinuity::EndSection */ EndSection;
} inC_TrackDiscontinuity_InfraLib;
...
extern void TrackDiscontinuity_InfraLib(
  inC_TrackDiscontinuity_InfraLib *inC,
