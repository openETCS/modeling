  ...
  outC_TrackDiscontinuity_InfraLib *outC)
{
  ...
  kcg_copy_TrackSectionData_T_InfraLib(&outC->_L16, &inC->SectionData_in);
  kcg_copy_TrainPosRaw_T_InfraLib(&outC->_L81, &outC->_L16.TrainPosRaw);
  outC->_L83 = outC->_L81.OffsetTotal;
  outC->_L8_3 = 0;
  outC->_L3 = inC->EndSection;
  outC->_L2 = inC->StartSection;
  ...
  outC->tmp = outC->_L63;
  kcg_copy_TrackSectionData_T_InfraLib(&outC->_L80, &inC->SectionData_in);
  if (outC->tmp) {
    /* 2 */
