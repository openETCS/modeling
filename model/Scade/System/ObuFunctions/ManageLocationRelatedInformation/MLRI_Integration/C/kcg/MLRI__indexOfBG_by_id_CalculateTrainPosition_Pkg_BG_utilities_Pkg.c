...
void MLRI__indexOfBG_by_id_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  ...
  *indexOfBG = MLRI__cNoValidIndex_CalculateTrainPosition_Pkg;
  if (enable) {
    for (i = 0; i < 8; i++) {
      tmp2 = *indexOfBG;
      /* 1 */
      MLRI__indexOfBG_by_id_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
        i,
        tmp2,
        BG,
        &(*BGs)[i],
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** MLRI__indexOfBG_by_id_CalculateTrainPosition_Pkg_BG_utilities_Pkg.c
** Generation date: 2014-12-12T12:03:54
*************************************************************$ */
