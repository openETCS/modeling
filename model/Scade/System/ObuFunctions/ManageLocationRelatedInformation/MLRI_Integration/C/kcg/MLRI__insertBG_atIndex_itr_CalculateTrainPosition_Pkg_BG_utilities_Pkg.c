...
void MLRI__insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_toBeInserted */MLRI__positionedBG_T_TrainPosition_Types_Pck *BG_toBeInserted,
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_in */MLRI__positionedBG_T_TrainPosition_Types_Pck *BG_in,
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_shifted_in */MLRI__positionedBG_T_TrainPosition_Types_Pck *BG_shifted_in,
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::cont */kcg_bool *cont,
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_out */MLRI__positionedBG_T_TrainPosition_Types_Pck *BG_out)
{
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** MLRI__insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg.c
** Generation date: 2014-12-12T12:03:54
*************************************************************$ */
