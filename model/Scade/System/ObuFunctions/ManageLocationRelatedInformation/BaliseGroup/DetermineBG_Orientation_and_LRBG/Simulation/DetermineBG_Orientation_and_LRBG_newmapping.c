...
/* DetermineBGOrientation_LRBG::FinalCheck3/ FinalCheck3_DetermineBGOrientation_LRBG */
static const MappingEntry scope_3_entries[31] = {
  /* 0 */ { MAP_OUTPUT, "FilteredBGMessage", NULL, sizeof(FilteredBGMessage_DetermineBGOrientation_LRBG_DataDctionary_FilteredBGMessage), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, FilteredBGMessage), &_Type_FilteredBGMessage_DetermineBGOrientation_LRBG_DataDctionary_FilteredBGMessage_Utils, NULL, NULL, &scope_20, 1, 30},
  /* 1 */ { MAP_OUTPUT, "RBCReport", NULL, sizeof(Train_Position_Report_DetermineBGOrientation_LRBG_DataDctionary_Packets), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, RBCReport), &_Type_Train_Position_Report_DetermineBGOrientation_LRBG_DataDctionary_Packets_Utils, NULL, NULL, &scope_13, 1, 29},
  /* 2 */ { MAP_LOCAL, "_L1", NULL, sizeof(CheckedBGMessage_DetermineBGOrientation_LRBG_DataDctionary_CheckedBGMessage), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L1), &_Type_CheckedBGMessage_DetermineBGOrientation_LRBG_DataDctionary_CheckedBGMessage_Utils, NULL, NULL, &scope_19, 1, 0},
  /* 3 */ { MAP_LOCAL, "_L2", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L2), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 1},
  /* 4 */ { MAP_LOCAL, "_L27", NULL, sizeof(Train_Position_Report_DetermineBGOrientation_LRBG_DataDctionary_Packets), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L27), &_Type_Train_Position_Report_DetermineBGOrientation_LRBG_DataDctionary_Packets_Utils, NULL, NULL, &scope_13, 1, 3},
  /* 5 */ { MAP_LOCAL, "_L28", NULL, sizeof(FilteredBGMessage_DetermineBGOrientation_LRBG_DataDctionary_FilteredBGMessage), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L28), &_Type_FilteredBGMessage_DetermineBGOrientation_LRBG_DataDctionary_FilteredBGMessage_Utils, NULL, NULL, &scope_20, 1, 4},
  /* 6 */ { MAP_LOCAL, "_L29", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L29), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 5},
  /* 7 */ { MAP_LOCAL, "_L3", NULL, sizeof(RBCOrientationReport_DetermineBGOrientation_LRBG_DataDctionary_RBCOrientationReport), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L3), &_Type_RBCOrientationReport_DetermineBGOrientation_LRBG_DataDctionary_RBCOrientationReport_Utils, NULL, NULL, &scope_12, 1, 2},
  /* 8 */ { MAP_LOCAL, "_L54", NULL, sizeof(TrainInfo_DetermineBGOrientation_LRBG_DataDctionary_TrainInfo), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L54), &_Type_TrainInfo_DetermineBGOrientation_LRBG_DataDctionary_TrainInfo_Utils, NULL, NULL, &scope_14, 1, 6},
  /* 9 */ { MAP_LOCAL, "_L57", NULL, sizeof(M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L57), &_Type_M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 8},
  /* 10 */ { MAP_LOCAL, "_L58", NULL, sizeof(M_MODE_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L58), &_Type_M_MODE_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 7},
  /* 11 */ { MAP_LOCAL, "_L60", NULL, sizeof(kcg_bool), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L60), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 9},
  /* 12 */ { MAP_LOCAL, "_L61", NULL, sizeof(kcg_bool), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L61), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 10},
  /* 13 */ { MAP_LOCAL, "_L62", NULL, sizeof(kcg_bool), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L62), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 11},
  /* 14 */ { MAP_LOCAL, "_L63", NULL, sizeof(M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L63), &_Type_M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 12},
  /* 15 */ { MAP_LOCAL, "_L64", NULL, sizeof(M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L64), &_Type_M_LEVELTR_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 13},
  /* 16 */ { MAP_LOCAL, "_L66", NULL, sizeof(Assignment_of_coordinate_system_DetermineBGOrientation_LRBG_DataDctionary_Packets), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L66), &_Type_Assignment_of_coordinate_system_DetermineBGOrientation_LRBG_DataDctionary_Packets_Utils, NULL, NULL, &scope_11, 1, 14},
  /* 17 */ { MAP_LOCAL, "_L85", NULL, sizeof(NID_MESSAGE_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L85), &_Type_NID_MESSAGE_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 20},
  /* 18 */ { MAP_LOCAL, "_L86", NULL, sizeof(L_MESSAGE_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L86), &_Type_L_MESSAGE_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 19},
  /* 19 */ { MAP_LOCAL, "_L87", NULL, sizeof(T_TRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L87), &_Type_T_TRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 18},
  /* 20 */ { MAP_LOCAL, "_L88", NULL, sizeof(M_ACK_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L88), &_Type_M_ACK_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 17},
  /* 21 */ { MAP_LOCAL, "_L89", NULL, sizeof(NID_LRBG_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L89), &_Type_NID_LRBG_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 16},
  /* 22 */ { MAP_LOCAL, "_L90", NULL, sizeof(Q_ORIENTATION_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L90), &_Type_Q_ORIENTATION_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 15},
  /* 23 */ { MAP_LOCAL, "_L91", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L91), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 21},
  /* 24 */ { MAP_LOCAL, "_L92", NULL, sizeof(kcg_bool), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L92), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 22},
  /* 25 */ { MAP_LOCAL, "_L93", NULL, sizeof(M_ACK_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L93), &_Type_M_ACK_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 23},
  /* 26 */ { MAP_LOCAL, "_L95", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L95), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 24},
  /* 27 */ { MAP_LOCAL, "_L96", NULL, sizeof(kcg_bool), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L96), &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 25},
  /* 28 */ { MAP_LOCAL, "_L97", NULL, sizeof(Q_ORIENTATION_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L97), &_Type_Q_ORIENTATION_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 26},
  /* 29 */ { MAP_LOCAL, "_L98", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L98), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 27},
  /* 30 */ { MAP_LOCAL, "_L99", NULL, sizeof(Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable), offsetof(outC_FinalCheck3_DetermineBGOrientation_LRBG, _L99), &_Type_Q_DIRTRAIN_DetermineBGOrientation_LRBG_DataDctionary_Variable_Utils, NULL, NULL, NULL, 1, 28}
};
...
static const MappingEntry scope_1_entries[19] = {
  ...
  /* 3 */ { MAP_INSTANCE, "DetermineBGOrientation_LRBG::FinalCheck3 1", NULL, sizeof(outC_FinalCheck3_DetermineBGOrientation_LRBG), (int)&outputs_ctx._2_Context_1, NULL, NULL, NULL, &scope_3, 1, 1},
