...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  struct__9753 /* linear::MemoryBasic::_L4 */ _L4_1;
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  struct__9753 /* linear::MemoryBasic::_L2 */ _L2_1;
  kcg_bool /* linear::MemoryBasic::_L5 */ _L5_1;
  struct__9753 /* linear::MemoryBasic::_L6 */ _L6_1;
  struct__9753 /* linear::MemoryBasic::_L7 */ _L7_1;
  struct__9753 /* linear::MemoryBasic::Memorized */ Memorized_1;
  kcg_bool /* linear::MemoryBasic::Write */ Write_1;
  struct__9753 /* linear::MemoryBasic::Init */ Init_1;
  struct__9753 /* linear::MemoryBasic::BM_Input */ BM_Input_1;
