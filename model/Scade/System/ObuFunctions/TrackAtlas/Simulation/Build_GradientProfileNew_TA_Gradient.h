...
#include "kcg_types.h"
#include "_3_Convert_P21_to_DistancePr_TA_Gradient.h"
...
/* ========================  input structure  ====================== */
typedef struct {
  kcg_bool /* TA_Gradient::Build_GradientProfileNew::reset */ reset;
  ReceivedMessage_T_Common_Types_Pkg /* TA_Gradient::Build_GradientProfileNew::MessageIn */ MessageIn;
  trainPosition_T_TrainPosition_Types_Pck /* TA_Gradient::Build_GradientProfileNew::train_position */ train_position;
} inC_Build_GradientProfileNew_TA_Gradient;
...
typedef struct {
  ...
  outC__3_Convert_P21_to_DistancePr_TA_Gradient /* 2 */ Context_2;
