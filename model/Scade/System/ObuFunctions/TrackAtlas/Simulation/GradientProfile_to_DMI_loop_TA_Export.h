...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _3_GradientProfile_for_DMI_section_t_TrackAtlasTypes /* TA_Export::GradientProfile_to_DMI_loop::Gradiient_section_for_DMI_out */ Gradiient_section_for_DMI_out;
  /* -----------------------  no local probes  ----------------------- */
  ...
  _3_GradientProfile_for_DMI_section_t_TrackAtlasTypes /* TA_Export::GradientProfile_to_DMI_loop::_L12 */ _L12;
