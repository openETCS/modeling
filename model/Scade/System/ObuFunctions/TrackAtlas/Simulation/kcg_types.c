...
kcg_bool kcg_comp_array__2406(array__2406 *kcg_c1, array__2406 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 30; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__2398(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_array__2454(array__2454 *kcg_c1, array__2454 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  kcg_equ = kcg_true;
  for (kcg_ci = 0; kcg_ci < 32; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__2449(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_struct__2398(struct__2398 *kcg_c1, struct__2398 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__2412(struct__2412 *kcg_c1, struct__2412 *kcg_c2)
{
  kcg_bool kcg_equ;
  ...
  kcg_equ = kcg_equ & kcg_comp_array_int_500(
      &kcg_c1->PacketData,
      &kcg_c2->PacketData);
  kcg_equ = kcg_equ & kcg_comp_array__2406(
      &kcg_c1->PacketHeaders,
      &kcg_c2->PacketHeaders);
  return kcg_equ;
}

kcg_bool kcg_comp_struct__2420(struct__2420 *kcg_c1, struct__2420 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__2449(struct__2449 *kcg_c1, struct__2449 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__2457(struct__2457 *kcg_c1, struct__2457 *kcg_c2)
{
  kcg_bool kcg_equ;
  ...
  kcg_equ = kcg_equ & (kcg_c1->v_nvstff == kcg_c2->v_nvstff);
  kcg_equ = kcg_equ & (kcg_c1->v_nvshunt == kcg_c2->v_nvshunt);
  kcg_equ = kcg_equ & kcg_comp_array__2454(
      &kcg_c1->SECTIONS,
      &kcg_c2->SECTIONS);
  kcg_equ = kcg_equ & (kcg_c1->n_iter == kcg_c2->n_iter);
  kcg_equ = kcg_equ & (kcg_c1->d_validnv == kcg_c2->d_validnv);
