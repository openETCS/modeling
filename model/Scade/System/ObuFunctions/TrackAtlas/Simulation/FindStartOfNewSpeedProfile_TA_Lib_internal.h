...
/* ========================  input structure  ====================== */
typedef struct {
  SSP_cat_t_TA_MRSP /* TA_Lib_internal::FindStartOfNewSpeedProfile::Profile_in */ Profile_in;
  SSP_cat_t_TA_MRSP /* TA_Lib_internal::FindStartOfNewSpeedProfile::New_Profile */ New_Profile;
} inC_FindStartOfNewSpeedProfile_TA_Lib_internal;
...
typedef struct {
  ...
  array__184 /* TA_Lib_internal::FindStartOfNewSpeedProfile::_L98 */ _L98;
...
extern void FindStartOfNewSpeedProfile_TA_Lib_internal(
  inC_FindStartOfNewSpeedProfile_TA_Lib_internal *inC,
