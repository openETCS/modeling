#ifndef DETERMINE_VALID_SPEED_PER_CAT_TYPES_CONVERTION
#define DETERMINE_VALID_SPEED_PER_CAT_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__243_Utils;
extern TypeUtils _SCSIM_array__248_Utils;
 ...
 ** struct__243
 ****************************************************************/
extern const char * struct__243_to_string(const void* pValue);
extern int check_struct__243_string(const char* strValue);
extern int string_to_struct__243(const char* strValue, void* pValue);
int is_struct__243_allow_double_convertion();
extern const char * get_struct__243_signature();
extern int compare_struct__243_type(int*, const char*, const void*);
#define struct__243_filter_size 2
extern FilterUtils get_struct__243_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__243_filter_values[2];
/****************************************************************
 ** array__248
 ****************************************************************/
extern const char * array__248_to_string(const void* pValue);
extern int check_array__248_string(const char* strValue);
extern int string_to_array__248(const char* strValue, void* pValue);
int is_array__248_allow_double_convertion();
extern const char * get_array__248_signature();
extern int compare_array__248_type(int*, const char*, const void*);
#define array__248_filter_size 3
extern FilterUtils get_array__248_filter_utils(const char* strFilter, void* pValue);
#define array__248_filter_values 0
/****************************************************************
 ** array_int_3
 ****************************************************************/
...
#define get_SSP_section_t_signature get_struct__243_signature
#define compare_SSP_section_t_type compare_struct__243_type
#define SSP_section_t_filter_size struct__243_filter_size
#define get_SSP_section_t_filter_utils get_struct__243_filter_utils
#define SSP_section_t_filter_values struct__243_filter_values
/****************************************************************
 ** SSP_t_section_t
 ****************************************************************/
...
#define get_SSP_cat_t_signature get_array__248_signature
#define compare_SSP_cat_t_type compare_array__248_type
#define SSP_cat_t_filter_size array__248_filter_size
#define get_SSP_cat_t_filter_utils get_array__248_filter_utils
#define SSP_cat_t_filter_values array__248_filter_values

#endif /*DETERMINE_VALID_SPEED_PER_CAT_TYPES_CONVERTION */
