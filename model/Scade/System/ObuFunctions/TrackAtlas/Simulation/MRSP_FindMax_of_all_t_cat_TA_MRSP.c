...
#include "MRSP_FindMax_of_all_t_cat_TA_MRSP.h"

void MRSP_FindMax_of_all_t_cat_reset_TA_MRSP(
  outC_MRSP_FindMax_of_all_t_cat_TA_MRSP *outC)
{
}

/* TA_MRSP::MRSP_FindMax_of_all_t_cats_LOOP */
void MRSP_FindMax_of_all_t_cat_TA_MRSP(
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** MRSP_FindMax_of_all_t_cat_TA_MRSP.c
** Generation date: 2015-08-07T17:15:59
*************************************************************$ */
