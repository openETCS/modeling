...
TypeUtils _SCSIM_struct__111_Utils = {struct__111_to_string,
	check_struct__111_string,
	string_to_struct__111,
	is_struct__111_allow_double_convertion,
	0,
	compare_struct__111_type,
	get_struct__111_signature,
	get_struct__111_filter_utils,
	struct__111_filter_size,
	struct__111_filter_values};
 ...
 ** struct__111
 ****************************************************************/
static void Fill_struct__111_StructSimValue(struct__111 * pStruct, StructSimValue * pValues) {
...
const char * struct__111_to_string(const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__111_StructSimValue(((struct__111*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 3);
}

int string_to_struct__111(const char* strValue, void* pValue) {
	static struct__111 rTemp;
	int nResult = 0;
	static StructSimValue values[3];
	kcg_copy_struct__111(&(rTemp), &(*((struct__111*)pValue)));
	Fill_struct__111_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 3);
	if (nResult == 1)
		kcg_copy_struct__111(&(*((struct__111*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__111_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__111_StructSimValue((struct__111*)pValue, values);
...
int is_struct__111_allow_double_convertion() {
	return 0;
}


const char * get_struct__111_signature() {
	static StructSimValue values[3];
	Fill_struct__111_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 3);
}

FilterUtils get_struct__111_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[3];
	Fill_struct__111_StructSimValue((struct__111*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 3, strFilter);
}

const char * struct__111_filter_values[3] = {"Category_Index", "Pos_Index", "Loc"};
int check_struct__111_string(const char* strValue) {
	static struct__111 rTemp;
	return string_to_struct__111(strValue, &rTemp);
}
...
const char * SSP_indexed_matrix_element_to_string(const void* pValue) {
	...
	return struct__111_to_string(pValue);
}
...
int string_to_SSP_indexed_matrix_element(const char* strValue, void* pValue) {
	if (pSimSSP_indexed_matrix_elementVTable != 0 && pSimSSP_indexed_matrix_elementVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__111(&(*((SSP_indexed_matrix_element*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__111(strValue, pValue);
}
...
int is_SSP_indexed_matrix_element_allow_double_convertion() {
	...
	return is_struct__111_allow_double_convertion();
}
...
int SSP_indexed_matrix_element_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__111_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__111_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
