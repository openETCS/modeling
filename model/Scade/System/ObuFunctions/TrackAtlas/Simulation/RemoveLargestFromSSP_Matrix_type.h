#ifndef REMOVELARGESTFROMSSP_MATRIX_TYPES_CONVERTION
#define REMOVELARGESTFROMSSP_MATRIX_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__111_Utils;
 ...
 ** struct__111
 ****************************************************************/
extern const char * struct__111_to_string(const void* pValue);
extern int check_struct__111_string(const char* strValue);
extern int string_to_struct__111(const char* strValue, void* pValue);
int is_struct__111_allow_double_convertion();
extern const char * get_struct__111_signature();
extern int compare_struct__111_type(int*, const char*, const void*);
#define struct__111_filter_size 3
extern FilterUtils get_struct__111_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__111_filter_values[3];
/****************************************************************
 ** array_int_3
 ****************************************************************/
...
#define get_SSP_indexed_matrix_element_signature get_struct__111_signature
#define compare_SSP_indexed_matrix_element_type compare_struct__111_type
#define SSP_indexed_matrix_element_filter_size struct__111_filter_size
#define get_SSP_indexed_matrix_element_filter_utils get_struct__111_filter_utils
#define SSP_indexed_matrix_element_filter_values struct__111_filter_values
/****************************************************************
 ** SSP_target_t
 ****************************************************************/
...
#endif /*REMOVELARGESTFROMSSP_MATRIX_TYPES_CONVERTION */
