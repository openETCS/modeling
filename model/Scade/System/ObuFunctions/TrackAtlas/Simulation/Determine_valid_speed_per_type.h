#ifndef DETERMINE_VALID_SPEED_PER_TYPES_CONVERTION
#define DETERMINE_VALID_SPEED_PER_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__127_Utils;
 ...
 ** struct__127
 ****************************************************************/
extern const char * struct__127_to_string(const void* pValue);
extern int check_struct__127_string(const char* strValue);
extern int string_to_struct__127(const char* strValue, void* pValue);
int is_struct__127_allow_double_convertion();
extern const char * get_struct__127_signature();
extern int compare_struct__127_type(int*, const char*, const void*);
#define struct__127_filter_size 2
extern FilterUtils get_struct__127_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__127_filter_values[2];
/****************************************************************
 ** SSP_section_t
 ****************************************************************/
...
#define get_SSP_section_t_signature get_struct__127_signature
#define compare_SSP_section_t_type compare_struct__127_type
#define SSP_section_t_filter_size struct__127_filter_size
#define get_SSP_section_t_filter_utils get_struct__127_filter_utils
#define SSP_section_t_filter_values struct__127_filter_values
/****************************************************************
 ** SSP_t_section_t
 ****************************************************************/
...
#endif /*DETERMINE_VALID_SPEED_PER_TYPES_CONVERTION */
