...
#include "SmuTypes.h"
#include "kcg_types.h"
#include "Find_First_in_each_SSP_cat_type.h"
...
TypeUtils _SCSIM_struct__159_Utils = {struct__159_to_string,
	check_struct__159_string,
	string_to_struct__159,
	is_struct__159_allow_double_convertion,
	0,
	compare_struct__159_type,
	get_struct__159_signature,
	get_struct__159_filter_utils,
	struct__159_filter_size,
	struct__159_filter_values};
TypeUtils _SCSIM_array__164_Utils = {array__164_to_string,
	check_array__164_string,
	string_to_array__164,
	is_array__164_allow_double_convertion,
	0,
	compare_array__164_type,
	get_array__164_signature,
	get_array__164_filter_utils,
	array__164_filter_size,
	array__164_filter_values};
 ...
 ** struct__159
 ****************************************************************/
static void Fill_struct__159_StructSimValue(struct__159 * pStruct, StructSimValue * pValues) {
	/*Index label.*/
...
const char * struct__159_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__159_StructSimValue(((struct__159*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__159(const char* strValue, void* pValue) {
	static struct__159 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__159(&(rTemp), &(*((struct__159*)pValue)));
	Fill_struct__159_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__159(&(*((struct__159*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__159_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__159_StructSimValue((struct__159*)pValue, values);
...
const char * get_struct__159_signature() {
	static StructSimValue values[2];
	Fill_struct__159_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__159_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__159_StructSimValue((struct__159*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__159_filter_values[2] = {"Index", "Loc"};
int check_struct__159_string(const char* strValue) {
	static struct__159 rTemp;
	return string_to_struct__159(strValue, &rTemp);
}
 ...
 ** array__164
 ****************************************************************/
void* array__164_projection(void** pValues, int nIndex) {
	return &((*(array__164*)pValues)[nIndex]);
}

const char * array__164_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, struct__159_to_string, 11, array__164_projection);
}

int compare_array__164_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_struct__159_type , 11, array__164_projection);
}
...
int string_to_array__164(const char* strValue, void* pValue) {
	static array__164 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_struct__159, 11, array__164_projection);
	if (nResult == 1)
		kcg_copy_array__164(&(*((array__164*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array__164_signature() {
	return pSimulator->m_pfnArraySignature(get_struct__159_signature, 11);
}

FilterUtils get_array__164_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_struct__159_Utils, strFilter, (void**)pValue, 11, array__164_projection);
}

int check_array__164_string(const char* strValue) {
	static array__164 rTemp;
	return string_to_array__164(strValue, &rTemp);
}
...
const char * SSP_indexed_trgt_t_to_string(const void* pValue) {
	...
	return struct__159_to_string(pValue);
}
...
int string_to_SSP_indexed_trgt_t(const char* strValue, void* pValue) {
	if (pSimSSP_indexed_trgt_tVTable != 0 && pSimSSP_indexed_trgt_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__159(&(*((SSP_indexed_trgt_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__159(strValue, pValue);
}
...
int is_SSP_indexed_trgt_t_allow_double_convertion() {
	...
	return is_struct__159_allow_double_convertion();
}
...
int SSP_indexed_trgt_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__159_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__159_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * SSP_indexed_targets_list_t_to_string(const void* pValue) {
	...
	return array__164_to_string(pValue);
}
...
int string_to_SSP_indexed_targets_list_t(const char* strValue, void* pValue) {
	if (pSimSSP_indexed_targets_list_tVTable != 0 && pSimSSP_indexed_targets_list_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_array__164(&(*((SSP_indexed_targets_list_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_array__164(strValue, pValue);
}
...
int is_SSP_indexed_targets_list_t_allow_double_convertion() {
	...
	return is_array__164_allow_double_convertion();
}
...
int SSP_indexed_targets_list_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_array__164_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_array__164_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
