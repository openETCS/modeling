...
TypeUtils _SCSIM_struct__175_Utils = {struct__175_to_string,
	check_struct__175_string,
	string_to_struct__175,
	is_struct__175_allow_double_convertion,
	0,
	compare_struct__175_type,
	get_struct__175_signature,
	get_struct__175_filter_utils,
	struct__175_filter_size,
	struct__175_filter_values};
TypeUtils _SCSIM_array__180_Utils = {array__180_to_string,
	check_array__180_string,
	string_to_array__180,
	is_array__180_allow_double_convertion,
	0,
	compare_array__180_type,
	get_array__180_signature,
	get_array__180_filter_utils,
	array__180_filter_size,
	array__180_filter_values};
 ...
 ** struct__175
 ****************************************************************/
static void Fill_struct__175_StructSimValue(struct__175 * pStruct, StructSimValue * pValues) {
	/*target label.*/
...
const char * struct__175_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__175_StructSimValue(((struct__175*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__175(const char* strValue, void* pValue) {
	static struct__175 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__175(&(rTemp), &(*((struct__175*)pValue)));
	Fill_struct__175_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__175(&(*((struct__175*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__175_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__175_StructSimValue((struct__175*)pValue, values);
...
int is_struct__175_allow_double_convertion() {
	return 0;
}


const char * get_struct__175_signature() {
	static StructSimValue values[2];
	Fill_struct__175_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__175_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__175_StructSimValue((struct__175*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__175_filter_values[2] = {"target", "speed"};
int check_struct__175_string(const char* strValue) {
	static struct__175 rTemp;
	return string_to_struct__175(strValue, &rTemp);
}
 ...
 ** array__180
 ****************************************************************/
void* array__180_projection(void** pValues, int nIndex) {
	return &((*(array__180*)pValues)[nIndex]);
}

const char * array__180_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, struct__175_to_string, 3, array__180_projection);
}

int compare_array__180_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_struct__175_type , 3, array__180_projection);
}

int is_array__180_allow_double_convertion() {
	return 0;
}

int string_to_array__180(const char* strValue, void* pValue) {
	static array__180 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_struct__175, 3, array__180_projection);
	if (nResult == 1)
		kcg_copy_array__180(&(*((array__180*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array__180_signature() {
	return pSimulator->m_pfnArraySignature(get_struct__175_signature, 3);
}

FilterUtils get_array__180_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_struct__175_Utils, strFilter, (void**)pValue, 3, array__180_projection);
}

int check_array__180_string(const char* strValue) {
	static array__180 rTemp;
	return string_to_array__180(strValue, &rTemp);
}
...
const char * SSP_section_t_to_string(const void* pValue) {
	...
	return struct__175_to_string(pValue);
}
...
int string_to_SSP_section_t(const char* strValue, void* pValue) {
	if (pSimSSP_section_tVTable != 0 && pSimSSP_section_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__175(&(*((SSP_section_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__175(strValue, pValue);
}
...
int is_SSP_section_t_allow_double_convertion() {
	...
	return is_struct__175_allow_double_convertion();
}
...
int SSP_section_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__175_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__175_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * SSP_cat_t_to_string(const void* pValue) {
	...
	return array__180_to_string(pValue);
}
...
int string_to_SSP_cat_t(const char* strValue, void* pValue) {
	if (pSimSSP_cat_tVTable != 0 && pSimSSP_cat_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_array__180(&(*((SSP_cat_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_array__180(strValue, pValue);
}
...
int is_SSP_cat_t_allow_double_convertion() {
	...
	return is_array__180_allow_double_convertion();
}
...
int SSP_cat_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_array__180_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_array__180_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
