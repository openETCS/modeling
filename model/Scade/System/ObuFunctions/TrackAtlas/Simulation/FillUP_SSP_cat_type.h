#ifndef FILLUP_SSP_CAT_TYPES_CONVERTION
#define FILLUP_SSP_CAT_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__175_Utils;
extern TypeUtils _SCSIM_array__180_Utils;
 ...
 ** struct__175
 ****************************************************************/
extern const char * struct__175_to_string(const void* pValue);
extern int check_struct__175_string(const char* strValue);
extern int string_to_struct__175(const char* strValue, void* pValue);
int is_struct__175_allow_double_convertion();
extern const char * get_struct__175_signature();
extern int compare_struct__175_type(int*, const char*, const void*);
#define struct__175_filter_size 2
extern FilterUtils get_struct__175_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__175_filter_values[2];
/****************************************************************
 ** array__180
 ****************************************************************/
extern const char * array__180_to_string(const void* pValue);
extern int check_array__180_string(const char* strValue);
extern int string_to_array__180(const char* strValue, void* pValue);
int is_array__180_allow_double_convertion();
extern const char * get_array__180_signature();
extern int compare_array__180_type(int*, const char*, const void*);
#define array__180_filter_size 3
extern FilterUtils get_array__180_filter_utils(const char* strFilter, void* pValue);
#define array__180_filter_values 0
/****************************************************************
 ** SSP_section_t
 ****************************************************************/
...
#define get_SSP_section_t_signature get_struct__175_signature
#define compare_SSP_section_t_type compare_struct__175_type
#define SSP_section_t_filter_size struct__175_filter_size
#define get_SSP_section_t_filter_utils get_struct__175_filter_utils
#define SSP_section_t_filter_values struct__175_filter_values
/****************************************************************
 ** SSP_t_section_t
 ****************************************************************/
...
#define get_SSP_cat_t_signature get_array__180_signature
#define compare_SSP_cat_t_type compare_array__180_type
#define SSP_cat_t_filter_size array__180_filter_size
#define get_SSP_cat_t_filter_utils get_array__180_filter_utils
#define SSP_cat_t_filter_values array__180_filter_values

#endif /*FILLUP_SSP_CAT_TYPES_CONVERTION */
