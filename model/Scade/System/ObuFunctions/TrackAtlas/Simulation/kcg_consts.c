...
const _4_MovementAuthoritySectionlist_t_TrackAtlasTypes DEFAULT_MA_sectionlist_TrackAtlasTypes = {
...
const P003V1_OBU_T_TM_baseline2 INIT_P3V1_TA_Storage = { kcg_false,
  ...
  Q_NVSBTSMPERM_No, _14_Q_NVEMRRLS_Revoke_emergency_brake_command_at_standstill,
  0, 0, 0, 0, 0, M_NVCONTACT_Train_trip, 0, M_NVDERUN_No, 0,
