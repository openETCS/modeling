...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_MoveGPSectionsAbsolute_Loop_TA_Lib_internal /* 1 */ Context_1[33];
  ...
  array_bool_33 /* TA_Lib_internal::MoveGPSectionsAbsolute::_L6 */ _L6;
  ...
  array_bool_33 /* TA_Lib_internal::MoveGPSectionsAbsolute::_L39 */ _L39;
  array_int_33 /* TA_Lib_internal::MoveGPSectionsAbsolute::_L40 */ _L40;
  array_int_33 /* TA_Lib_internal::MoveGPSectionsAbsolute::_L41 */ _L41;
