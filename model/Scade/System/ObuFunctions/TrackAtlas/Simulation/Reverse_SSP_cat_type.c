...
TypeUtils _SCSIM_struct__174_Utils = {struct__174_to_string,
	check_struct__174_string,
	string_to_struct__174,
	is_struct__174_allow_double_convertion,
	0,
	compare_struct__174_type,
	get_struct__174_signature,
	get_struct__174_filter_utils,
	struct__174_filter_size,
	struct__174_filter_values};
TypeUtils _SCSIM_array__179_Utils = {array__179_to_string,
	check_array__179_string,
	string_to_array__179,
	is_array__179_allow_double_convertion,
	0,
	compare_array__179_type,
	get_array__179_signature,
	get_array__179_filter_utils,
	array__179_filter_size,
	array__179_filter_values};
 ...
 ** struct__174
 ****************************************************************/
static void Fill_struct__174_StructSimValue(struct__174 * pStruct, StructSimValue * pValues) {
	/*target label.*/
...
const char * struct__174_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__174_StructSimValue(((struct__174*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__174(const char* strValue, void* pValue) {
	static struct__174 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__174(&(rTemp), &(*((struct__174*)pValue)));
	Fill_struct__174_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__174(&(*((struct__174*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__174_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__174_StructSimValue((struct__174*)pValue, values);
...
const char * get_struct__174_signature() {
	static StructSimValue values[2];
	Fill_struct__174_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__174_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__174_StructSimValue((struct__174*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__174_filter_values[2] = {"target", "speed"};
int check_struct__174_string(const char* strValue) {
	static struct__174 rTemp;
	return string_to_struct__174(strValue, &rTemp);
}
 ...
 ** array__179
 ****************************************************************/
void* array__179_projection(void** pValues, int nIndex) {
	return &((*(array__179*)pValues)[nIndex]);
}

const char * array__179_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, struct__174_to_string, 3, array__179_projection);
}

int compare_array__179_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_struct__174_type , 3, array__179_projection);
}
...
int string_to_array__179(const char* strValue, void* pValue) {
	static array__179 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_struct__174, 3, array__179_projection);
	if (nResult == 1)
		kcg_copy_array__179(&(*((array__179*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array__179_signature() {
	return pSimulator->m_pfnArraySignature(get_struct__174_signature, 3);
}

FilterUtils get_array__179_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_struct__174_Utils, strFilter, (void**)pValue, 3, array__179_projection);
}

int check_array__179_string(const char* strValue) {
	static array__179 rTemp;
	return string_to_array__179(strValue, &rTemp);
}
...
const char * SSP_section_t_to_string(const void* pValue) {
	...
	return struct__174_to_string(pValue);
}
...
int string_to_SSP_section_t(const char* strValue, void* pValue) {
	if (pSimSSP_section_tVTable != 0 && pSimSSP_section_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__174(&(*((SSP_section_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__174(strValue, pValue);
}
...
int is_SSP_section_t_allow_double_convertion() {
	...
	return is_struct__174_allow_double_convertion();
}
...
int SSP_section_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__174_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__174_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * SSP_cat_t_to_string(const void* pValue) {
	...
	return array__179_to_string(pValue);
}
...
int string_to_SSP_cat_t(const char* strValue, void* pValue) {
	if (pSimSSP_cat_tVTable != 0 && pSimSSP_cat_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_array__179(&(*((SSP_cat_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_array__179(strValue, pValue);
}
...
int is_SSP_cat_t_allow_double_convertion() {
	...
	return is_array__179_allow_double_convertion();
}
...
int SSP_cat_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_array__179_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_array__179_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
