...
TypeUtils _SCSIM_struct__160_Utils = {struct__160_to_string,
	check_struct__160_string,
	string_to_struct__160,
	is_struct__160_allow_double_convertion,
	0,
	compare_struct__160_type,
	get_struct__160_signature,
	get_struct__160_filter_utils,
	struct__160_filter_size,
	struct__160_filter_values};
TypeUtils _SCSIM_struct__165_Utils = {struct__165_to_string,
	check_struct__165_string,
	string_to_struct__165,
	is_struct__165_allow_double_convertion,
	0,
	compare_struct__165_type,
	get_struct__165_signature,
	get_struct__165_filter_utils,
	struct__165_filter_size,
	struct__165_filter_values};
TypeUtils _SCSIM_struct__170_Utils = {struct__170_to_string,
	check_struct__170_string,
	string_to_struct__170,
	is_struct__170_allow_double_convertion,
	0,
	compare_struct__170_type,
	get_struct__170_signature,
	get_struct__170_filter_utils,
	struct__170_filter_size,
	struct__170_filter_values};
 ...
 ** struct__160
 ****************************************************************/
static void Fill_struct__160_StructSimValue(struct__160 * pStruct, StructSimValue * pValues) {
	/*index label.*/
...
const char * struct__160_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__160_StructSimValue(((struct__160*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__160(const char* strValue, void* pValue) {
	static struct__160 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__160(&(rTemp), &(*((struct__160*)pValue)));
	Fill_struct__160_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__160(&(*((struct__160*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__160_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__160_StructSimValue((struct__160*)pValue, values);
...
const char * get_struct__160_signature() {
	static StructSimValue values[2];
	Fill_struct__160_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__160_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__160_StructSimValue((struct__160*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__160_filter_values[2] = {"index", "target"};
int check_struct__160_string(const char* strValue) {
	static struct__160 rTemp;
	return string_to_struct__160(strValue, &rTemp);
}
 ...
 ** struct__165
 ****************************************************************/
static void Fill_struct__165_StructSimValue(struct__165 * pStruct, StructSimValue * pValues) {
	/*target label.*/
...
const char * struct__165_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__165_StructSimValue(((struct__165*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__165(const char* strValue, void* pValue) {
	static struct__165 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__165(&(rTemp), &(*((struct__165*)pValue)));
	Fill_struct__165_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__165(&(*((struct__165*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__165_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__165_StructSimValue((struct__165*)pValue, values);
	return pSimulator->m_pfnStructureComparison(pResult, toCompare, values, 2);
}
...
const char * get_struct__165_signature() {
	static StructSimValue values[2];
	Fill_struct__165_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__165_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__165_StructSimValue((struct__165*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__165_filter_values[2] = {"target", "speed"};
int check_struct__165_string(const char* strValue) {
	static struct__165 rTemp;
	return string_to_struct__165(strValue, &rTemp);
}
 ...
 ** struct__170
 ****************************************************************/
static void Fill_struct__170_StructSimValue(struct__170 * pStruct, StructSimValue * pValues) {
	/*found label.*/
...
const char * struct__170_to_string(const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__170_StructSimValue(((struct__170*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 3);
}

int string_to_struct__170(const char* strValue, void* pValue) {
	static struct__170 rTemp;
	int nResult = 0;
	static StructSimValue values[3];
	kcg_copy_struct__170(&(rTemp), &(*((struct__170*)pValue)));
	Fill_struct__170_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 3);
	if (nResult == 1)
		kcg_copy_struct__170(&(*((struct__170*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__170_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__170_StructSimValue((struct__170*)pValue, values);
...
const char * get_struct__170_signature() {
	static StructSimValue values[3];
	Fill_struct__170_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 3);
}

FilterUtils get_struct__170_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[3];
	Fill_struct__170_StructSimValue((struct__170*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 3, strFilter);
}

const char * struct__170_filter_values[3] = {"found", "index", "target"};
int check_struct__170_string(const char* strValue) {
	static struct__170 rTemp;
	return string_to_struct__170(strValue, &rTemp);
}
...
const char * SSP_valid_section_t_to_string(const void* pValue) {
	...
	return struct__170_to_string(pValue);
}
...
int string_to_SSP_valid_section_t(const char* strValue, void* pValue) {
	if (pSimSSP_valid_section_tVTable != 0 && pSimSSP_valid_section_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__170(&(*((SSP_valid_section_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__170(strValue, pValue);
}
...
int is_SSP_valid_section_t_allow_double_convertion() {
	...
	return is_struct__170_allow_double_convertion();
}
...
int SSP_valid_section_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__170_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__170_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * SSP_section_t_to_string(const void* pValue) {
	...
	return struct__165_to_string(pValue);
}
...
int string_to_SSP_section_t(const char* strValue, void* pValue) {
	if (pSimSSP_section_tVTable != 0 && pSimSSP_section_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__165(&(*((SSP_section_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__165(strValue, pValue);
}
...
int is_SSP_section_t_allow_double_convertion() {
	...
	return is_struct__165_allow_double_convertion();
}
...
int SSP_section_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__165_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__165_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * SSP_relevant_target_t_to_string(const void* pValue) {
	...
	return struct__160_to_string(pValue);
}
...
int string_to_SSP_relevant_target_t(const char* strValue, void* pValue) {
	if (pSimSSP_relevant_target_tVTable != 0 && pSimSSP_relevant_target_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__160(&(*((SSP_relevant_target_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__160(strValue, pValue);
}
...
int is_SSP_relevant_target_t_allow_double_convertion() {
	...
	return is_struct__160_allow_double_convertion();
}
...
int SSP_relevant_target_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__160_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__160_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
