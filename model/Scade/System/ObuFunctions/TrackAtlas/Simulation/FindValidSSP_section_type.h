#ifndef FINDVALIDSSP_SECTION_TYPES_CONVERTION
#define FINDVALIDSSP_SECTION_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__140_Utils;
 ...
 ** struct__140
 ****************************************************************/
extern const char * struct__140_to_string(const void* pValue);
extern int check_struct__140_string(const char* strValue);
extern int string_to_struct__140(const char* strValue, void* pValue);
int is_struct__140_allow_double_convertion();
extern const char * get_struct__140_signature();
extern int compare_struct__140_type(int*, const char*, const void*);
#define struct__140_filter_size 2
extern FilterUtils get_struct__140_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__140_filter_values[2];
/****************************************************************
 ** SSP_section_t
 ****************************************************************/
...
#define get_SSP_section_t_signature get_struct__140_signature
#define compare_SSP_section_t_type compare_struct__140_type
#define SSP_section_t_filter_size struct__140_filter_size
#define get_SSP_section_t_filter_utils get_struct__140_filter_utils
#define SSP_section_t_filter_values struct__140_filter_values
/****************************************************************
 ** SSP_t_section_t
 ****************************************************************/
...
#endif /*FINDVALIDSSP_SECTION_TYPES_CONVERTION */
