...
void Calculate_MRSP_reset_TA_MRSP(outC_Calculate_MRSP_TA_MRSP *outC)
{
  ...
  /* 1 */ _18_MRSP_Determine_LengthOfTa_reset_TA_MRSP(&outC->_2_Context_1);
  /* 1 */ MRSP_BuildTargetList_reset_TA_MRSP(&outC->_1_Context_1);
  /* 1 */ MRSP_Split_And_Reverse_SS_reset_TA_MRSP(&outC->Context_1);
}
  ...
  outC_Calculate_MRSP_TA_MRSP *outC)
{
  ...
  /* 1 */ MRSP_Split_And_Reverse_SS_TA_MRSP(&outC->_L15, &outC->Context_1);
  ...
  /* 1 */
  _18_MRSP_Determine_LengthOfTa_TA_MRSP(&outC->_L1, &outC->_2_Context_1);
