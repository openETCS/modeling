...
TypeUtils _SCSIM_struct__140_Utils = {struct__140_to_string,
	check_struct__140_string,
	string_to_struct__140,
	is_struct__140_allow_double_convertion,
	0,
	compare_struct__140_type,
	get_struct__140_signature,
	get_struct__140_filter_utils,
	struct__140_filter_size,
	struct__140_filter_values};
 ...
 ** struct__140
 ****************************************************************/
static void Fill_struct__140_StructSimValue(struct__140 * pStruct, StructSimValue * pValues) {
	/*target label.*/
...
const char * struct__140_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__140_StructSimValue(((struct__140*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__140(const char* strValue, void* pValue) {
	static struct__140 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__140(&(rTemp), &(*((struct__140*)pValue)));
	Fill_struct__140_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__140(&(*((struct__140*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__140_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__140_StructSimValue((struct__140*)pValue, values);
...
int is_struct__140_allow_double_convertion() {
	return 0;
}


const char * get_struct__140_signature() {
	static StructSimValue values[2];
	Fill_struct__140_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__140_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__140_StructSimValue((struct__140*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__140_filter_values[2] = {"target", "speed"};
int check_struct__140_string(const char* strValue) {
	static struct__140 rTemp;
	return string_to_struct__140(strValue, &rTemp);
}
...
const char * SSP_section_t_to_string(const void* pValue) {
	...
	return struct__140_to_string(pValue);
}
...
int string_to_SSP_section_t(const char* strValue, void* pValue) {
	if (pSimSSP_section_tVTable != 0 && pSimSSP_section_tVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__140(&(*((SSP_section_t*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__140(strValue, pValue);
}
...
int is_SSP_section_t_allow_double_convertion() {
	...
	return is_struct__140_allow_double_convertion();
}
...
int SSP_section_t_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__140_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__140_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
