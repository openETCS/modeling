...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC__16_Convert_P27_to_DistancePr_TA_SSP /* 3 */ _1_Context_3[33];
...
extern void _17_Convert_P27_to_DistancePr_TA_SSP(
...
extern void _17_Convert_P27_to_DistancePr_reset_TA_SSP(
  outC__17_Convert_P27_to_DistancePr_TA_SSP *outC);
