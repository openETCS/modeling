 ...
 ** struct__129 
 ****************************************************************/
extern int struct__129_to_string(const void *pValue, PFNSTRAPPEND pfnStrAppend, void *pData);
extern int check_struct__129_string(const char *str, char **endptr);
extern int string_to_struct__129(const char *str, void *pValue, char **endptr);
extern int is_struct__129_allow_double_conversion();
extern int struct__129_to_double(const void *pValue, double *nValue);
extern int get_struct__129_signature(int (*pfnStrAppend)(const char *str, void *pData), void *pData);
extern void compare_struct__129(int *nStatus, const void *pValue1, const void *pValue2, void *pData, const char *pszPath, PFNSTRAPPEND pfnStrListAppend, void *pListErrPaths);
extern int set_struct__129_default_value(void *pValue);
extern SimTypeUtils _Type_struct__129_Utils;
