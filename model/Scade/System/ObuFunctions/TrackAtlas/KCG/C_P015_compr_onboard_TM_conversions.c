...
{
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1::else */ kcg_bool _4_else_clock_2_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1::else::else */ kcg_bool _3_else_clock_2_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1 */ kcg_bool _2_IfBlock1_clock_2;
  ...
  _2_IfBlock1_clock_2 = _L125[1] == INT_Q_DIR_nomiinal_TM_conversions;
  if (_2_IfBlock1_clock_2) {
  }
  else {
    _4_else_clock_2_IfBlock1 = _L125[1] == INT_Q_DIR_reverse_TM_conversions;
    if (_4_else_clock_2_IfBlock1) {
    }
    else {
      _3_else_clock_2_IfBlock1 = _L125[1] == INT_Q_DIR_both_TM_conversions;
    }
  }
  ...
  else if (_4_else_clock_2_IfBlock1) {
    (*P015_onboard).q_dir = ENUM_Q_DIR_reverse_TM_conversions;
  }
  else if (_3_else_clock_2_IfBlock1) {
  ...
  else if (_1_else_clock_2_IfBlock1) {
