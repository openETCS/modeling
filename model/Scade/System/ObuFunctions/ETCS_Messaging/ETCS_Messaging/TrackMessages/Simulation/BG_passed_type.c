...
TypeUtils _SCSIM_struct__371_Utils = {struct__371_to_string,
	check_struct__371_string,
	string_to_struct__371,
	is_struct__371_allow_double_convertion,
	0,
	compare_struct__371_type,
	get_struct__371_signature,
	get_struct__371_filter_utils,
	struct__371_filter_size,
	struct__371_filter_values};
 ...
 ** struct__371
 ****************************************************************/
static void Fill_struct__371_StructSimValue(struct__371 * pStruct, StructSimValue * pValues) {
	/*NID_C label.*/
...
const char * struct__371_to_string(const void* pValue) {
	static StructSimValue values[5];
	Fill_struct__371_StructSimValue(((struct__371*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 5);
}

int string_to_struct__371(const char* strValue, void* pValue) {
	static struct__371 rTemp;
	int nResult = 0;
	static StructSimValue values[5];
	kcg_copy_struct__371(&(rTemp), &(*((struct__371*)pValue)));
	Fill_struct__371_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 5);
	if (nResult == 1)
		kcg_copy_struct__371(&(*((struct__371*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__371_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[5];
	Fill_struct__371_StructSimValue((struct__371*)pValue, values);
...
const char * get_struct__371_signature() {
	static StructSimValue values[5];
	Fill_struct__371_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 5);
}

FilterUtils get_struct__371_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[5];
	Fill_struct__371_StructSimValue((struct__371*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 5, strFilter);
}

const char * struct__371_filter_values[5] = {"NID_C", "NID_BG", "Pos", "Or_BG", "Or_Line"};
int check_struct__371_string(const char* strValue) {
	static struct__371 rTemp;
	return string_to_struct__371(strValue, &rTemp);
}
...
const char * BaliseGroupData_to_string(const void* pValue) {
	...
	return struct__371_to_string(pValue);
}
...
int string_to_BaliseGroupData(const char* strValue, void* pValue) {
	if (pSimBaliseGroupDataVTable != 0 && pSimBaliseGroupDataVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__371(&(*((BaliseGroupData*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__371(strValue, pValue);
}
...
int is_BaliseGroupData_allow_double_convertion() {
	...
	return is_struct__371_allow_double_convertion();
}
...
int BaliseGroupData_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__371_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__371_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
