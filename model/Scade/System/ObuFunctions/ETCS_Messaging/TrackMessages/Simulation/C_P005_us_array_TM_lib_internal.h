...
typedef struct {
  ...
  outC_CAST_Int_to_NID_BG_TM_conversions /* 1 */ _4_Context_1;
  outC_C_P005_extract_el_section_TM_lib_internal /* 4 */ Context_4;
  outC_CAST_Int_to_Q_NEWCOUNTRY_TM_conversions /* 1 */ _3_Context_1;
  outC_C_P005_extract_el_section_TM_lib_internal /* 2 */ Context_2;
  outC_CAST_Int_to_Q_LINKORIENTATION_TM_conversions /* 1 */ _2_Context_1;
  outC_C_P005_extract_el_section_TM_lib_internal /* 5 */ Context_5;
  outC_CAST_Int_to_Q_LINKREACTION_TM_conversions /* 1 */ _1_Context_1;
  outC_C_P005_extract_el_section_TM_lib_internal /* 6 */ Context_6;
  outC_CAST_Int_to_Q_LOCACC_TM_conversions /* 1 */ Context_1;
