#ifndef T_EXTRACT_NID_PACKET_FROM_TM_LIB_INTERNAL_TYPES_CONVERTION
#define T_EXTRACT_NID_PACKET_FROM_TM_LIB_INTERNAL_TYPES_CONVERTION
...
#endif /*T_EXTRACT_NID_PACKET_FROM_TM_LIB_INTERNAL_TYPES_CONVERTION */
