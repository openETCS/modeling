  ...
  outC_C_P005_fs_flatten_array_TM_lib_internal *outC)
{
  ...
  kcg_copy_P005_sections_array_flat_TM(&outC->_L1, Acc);
  outC->_L8 = i;
  kcg_copy_P005_sections_array_flat_TM(&outC->_L7, &outC->_L1);
  if ((0 <= outC->_L8) & (outC->_L8 < 224)) {
    outC->_L7[outC->_L8] = outC->_L10;
  }
  kcg_copy_P005_sections_array_flat_TM(&outC->flat, &outC->_L7);
}
