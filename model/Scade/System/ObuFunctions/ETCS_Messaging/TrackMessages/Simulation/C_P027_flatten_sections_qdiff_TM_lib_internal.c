...
void C_P027_flatten_sections_qdiff_TM_lib_internal(
  /* TM_lib_internal::C_P027_flatten_sections_qdiff::MergedSections */P027V1_OBU_sectionlist_int_qdiff_T_TM *MergedSections,
  outC_C_P027_flatten_sections_qdiff_TM_lib_internal *outC)
{
  kcg_int i2;
  kcg_int i1;
  P027V1_sections_array_flat_qdiff_T_TM tmp;
  kcg_int i;
  
  kcg_copy_P027V1_OBU_sectionlist_int_qdiff_T_TM(&outC->_L75, MergedSections);
  for (i2 = 0; i2 < 32; i2++) {
    /* 1 */
    C_P027V1_fs_struct_to_arr_TM_lib_internal(
      &outC->_L75[i2],
      &outC->Context_1[i2]);
    kcg_copy_P027V1_section_array_qdiff_T_TM(
      &outC->_L74[i2],
  ...
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(
    ...
    (P027V1_sections_array_flat_qdiff_T_TM *)
      &DEFAULT_P027V1_sections_array_qdiff_flat_TM);
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&outC->_L83, &outC->_L76);
  for (i = 0; i < 32; i++) {
    kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&tmp, &outC->_L83);
    /* 1 */
  ...
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&outC->Flattened, &outC->_L83);
}
