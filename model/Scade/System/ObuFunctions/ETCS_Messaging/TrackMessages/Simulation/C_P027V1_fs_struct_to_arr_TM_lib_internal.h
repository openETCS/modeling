...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P027V1_section_array_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_struct_to_array_qdiff::section_arrays */ section_arrays;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P027V1_section_int_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_struct_to_array_qdiff::_L1 */ _L1;
...
extern void C_P027V1_fs_struct_to_arr_TM_lib_internal(
  /* TM_lib_internal::C_P027V1_fs_struct_to_array_qdiff::section */P027V1_section_int_qdiff_T_TM *section,
