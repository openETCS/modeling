#ifndef INFRA_BG_PASSED_TYPES_CONVERTION
#define INFRA_BG_PASSED_TYPES_CONVERTION
...
extern TypeUtils _SCSIM_struct__382_Utils;
 ...
 ** struct__382
 ****************************************************************/
extern const char * struct__382_to_string(const void* pValue);
extern int check_struct__382_string(const char* strValue);
extern int string_to_struct__382(const char* strValue, void* pValue);
int is_struct__382_allow_double_convertion();
extern const char * get_struct__382_signature();
extern int compare_struct__382_type(int*, const char*, const void*);
#define struct__382_filter_size 5
extern FilterUtils get_struct__382_filter_utils(const char* strFilter, void* pValue);
extern const char * struct__382_filter_values[5];
/****************************************************************
 ** BaliseGroupData
 ****************************************************************/
...
#define get_BaliseGroupData_signature get_struct__382_signature
#define compare_BaliseGroupData_type compare_struct__382_type
#define BaliseGroupData_filter_size struct__382_filter_size
#define get_BaliseGroupData_filter_utils get_struct__382_filter_utils
#define BaliseGroupData_filter_values struct__382_filter_values
/****************************************************************
 ** OrBG
 ****************************************************************/
...
#endif /*INFRA_BG_PASSED_TYPES_CONVERTION */
