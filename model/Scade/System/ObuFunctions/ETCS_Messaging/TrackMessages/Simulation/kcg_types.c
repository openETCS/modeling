...
kcg_bool kcg_comp_array__258(array__258 *kcg_c1, array__258 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  kcg_equ = kcg_true;
  for (kcg_ci = 0; kcg_ci < 20; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__244(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_struct__244(struct__244 *kcg_c1, struct__244 *kcg_c2)
{
  kcg_bool kcg_equ;
