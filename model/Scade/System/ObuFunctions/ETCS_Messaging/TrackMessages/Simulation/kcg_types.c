...
kcg_bool kcg_comp_array__448(array__448 *kcg_c1, array__448 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 32; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__443(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_array__459(array__459 *kcg_c1, array__459 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 33; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__451(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_array__462(array__462 *kcg_c1, array__462 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
...
kcg_bool kcg_comp_struct__443(struct__443 *kcg_c1, struct__443 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__451(struct__451 *kcg_c1, struct__451 *kcg_c2)
{
  kcg_bool kcg_equ;
  
  kcg_equ = kcg_true;
  kcg_equ = kcg_equ & kcg_comp_array__448(
...
kcg_bool kcg_comp_struct__465(struct__465 *kcg_c1, struct__465 *kcg_c2)
{
  kcg_bool kcg_equ;
  
  kcg_equ = kcg_true;
  kcg_equ = kcg_equ & kcg_comp_array__462(
      &kcg_c1->SECTIONS_SSP,
      &kcg_c2->SECTIONS_SSP);
