...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_INFRA_BG_passed();
	pSimulator->m_pfnFinalizeMapping(pSimulator);
}

/****************************************************************
 ** INFRA_BG_passed/ mapping function
 ****************************************************************/
void _SCSIM_Mapping_INFRA_BG_passed() {
	pSimulator->m_pfnSetRoot(pSimulator, "INFRA_BG_passed/", &outputs_ctx, _SCSIM_Get_INFRA_BG_passed_Handle);
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L21", &_SCSIM_kcg_int_Utils, 18, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L22", &_SCSIM_kcg_int_Utils, 19, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L23", &_SCSIM_kcg_bool_Utils, 20, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L24", &_SCSIM_kcg_bool_Utils, 21, valid, 0, 0);
	pSimulator->m_pfnAddOutput(pSimulator, "BG_passed", &_SCSIM_kcg_bool_Utils, 22, valid, 0, 0);
	pSimulator->m_pfnAddOutput(pSimulator, "LRBG", &_SCSIM_kcg_int_Utils, 23, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "other_BG_passed", &_SCSIM_kcg_bool_Utils, 24, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "LRBG_in", &_SCSIM_kcg_int_Utils, 25, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "BG", &_SCSIM_BaliseGroupData_Utils, 26, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "B1passed", &_SCSIM_kcg_bool_Utils, 27, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "B2passed", &_SCSIM_kcg_bool_Utils, 28, valid, 0, 0);
}
...
void* _SCSIM_Get_INFRA_BG_passed_Handle(void* pInstance, int nHandleIdent, int* pIteratorFilter, int nSize) {
	switch (nHandleIdent) {
		...
		case 24:
			return &(inputs_ctx.other_BG_passed);
		case 25:
			return &(inputs_ctx.LRBG_in);
		case 26:
