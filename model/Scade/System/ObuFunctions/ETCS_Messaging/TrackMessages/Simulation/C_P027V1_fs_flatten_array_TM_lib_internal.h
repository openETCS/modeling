...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::flat */ flat;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::_L1 */ _L1;
  ...
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::_L7 */ _L7;
  kcg_int /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::_L8 */ _L8;
  _1_P027V1_OBU_sectionlist_array_qdiff_T_TM /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::_L2 */ _L2;
...
extern void C_P027V1_fs_flatten_array_TM_lib_internal(
  ...
  /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::Acc */P027V1_sections_array_flat_qdiff_T_TM *Acc,
  /* TM_lib_internal::C_P027V1_fs_flatten_array_qdiff::section_arrays */_1_P027V1_OBU_sectionlist_array_qdiff_T_TM *section_arrays,
