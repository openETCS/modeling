  ...
  outC_C_P027V1_fs_flatten_array_TM_lib_internal *outC)
{
  ...
  kcg_copy__1_P027V1_OBU_sectionlist_array_qdiff_T_TM(
    &outC->_L2,
    section_arrays);
  ...
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&outC->_L1, Acc);
  outC->_L8 = i;
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&outC->_L7, &outC->_L1);
  if ((0 <= outC->_L8) & (outC->_L8 < 64)) {
    outC->_L7[outC->_L8] = outC->_L10;
  }
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM(&outC->flat, &outC->_L7);
}
