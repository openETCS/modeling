...
void C_P027V1_tracksim_merge_s_reset_TM_conversions(
  outC_C_P027V1_tracksim_merge_s_TM_conversions *outC)
{
  ...
  /* 2 */ C_P027V1_tracksim_compr_o_reset_TM_conversions(&outC->Context_2);
}

/* TM_conversions::C_P027V1_tracksim_merge_sections */
void C_P027V1_tracksim_merge_s_TM_conversions(
  ...
  outC_C_P027V1_tracksim_merge_s_TM_conversions *outC)
{
  ...
  kcg_copy_P027V1_section_int_T_TM(&outC->_L440, P027V1_sections_from_track);
  /* 2 */
  C_P027V1_tracksim_compr_o_TM_conversions(
    outC->_L446,
    &outC->_L440,
    &outC->Context_2);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** C_P027V1_tracksim_merge_s_TM_conversions.c
** Generation date: 2015-06-09T19:50:49
*************************************************************$ */
