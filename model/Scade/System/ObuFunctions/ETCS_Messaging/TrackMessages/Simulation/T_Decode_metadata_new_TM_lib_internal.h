...
/* ========================  input structure  ====================== */
typedef struct {
  kcg_int /* TM_lib_internal::T_Decode_metadata_new::Metadata_in */ Metadata_in;
} inC_T_Decode_metadata_new_TM_lib_internal;
...
extern void T_Decode_metadata_new_TM_lib_internal(
  inC_T_Decode_metadata_new_TM_lib_internal *inC,
