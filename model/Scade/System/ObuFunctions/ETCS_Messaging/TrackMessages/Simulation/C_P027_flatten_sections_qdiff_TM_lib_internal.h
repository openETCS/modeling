...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027_flatten_sections_qdiff::Flattened */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027_flatten_sections_qdiff::_L76 */ _L76;
  P027V1_OBU_sectionlist_int_qdiff_T_TM /* TM_lib_internal::C_P027_flatten_sections_qdiff::_L75 */ _L75;
  array_int_2_32 /* TM_lib_internal::C_P027_flatten_sections_qdiff::_L74 */ _L74;
  P027V1_sections_array_flat_qdiff_T_TM /* TM_lib_internal::C_P027_flatten_sections_qdiff::_L83 */ _L83;
