...
void Write_P027V1_reset_TM_trackside(outC_Write_P027V1_TM_trackside *outC)
{
  kcg_int i;
  
  for (i = 0; i < 33; i++) {
    /* 1 */
    C_P027V1_tracksim_merge_s_reset_TM_conversions(&outC->_3_Context_1[i]);
  }
  ...
  /* 1 */ C_P027V1_tracksim_compr_body_reset_TM_conversions(&outC->Context_1);
}

/* TM_trackside::Write_P027V1 */
void Write_P027V1_TM_trackside(
  ...
  outC_Write_P027V1_TM_trackside *outC)
{
  ...
  kcg_copy_P027V1_trackside_int_T_TM(&outC->_L1, &inC->Packet27V1);
  /* 1 */
  C_P027V1_tracksim_compr_body_TM_conversions(&outC->_L1, &outC->Context_1);
  ...
  if (outC->_L52) {
    for (i = 0; i < 33; i++) {
      ...
      /* 1 */
      C_P027V1_tracksim_merge_s_TM_conversions(
        i,
        &tmp,
        &outC->_L45[i],
        outC->_L54[i],
