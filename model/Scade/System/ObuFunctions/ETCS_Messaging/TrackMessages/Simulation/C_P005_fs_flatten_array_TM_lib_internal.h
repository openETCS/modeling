...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005_sections_array_flat_TM /* TM_lib_internal::C_P005_fs_flatten_array::flat */ flat;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P005_sections_array_flat_TM /* TM_lib_internal::C_P005_fs_flatten_array::_L1 */ _L1;
  ...
  P005_sections_array_flat_TM /* TM_lib_internal::C_P005_fs_flatten_array::_L7 */ _L7;
...
extern void C_P005_fs_flatten_array_TM_lib_internal(
  ...
  /* TM_lib_internal::C_P005_fs_flatten_array::Acc */P005_sections_array_flat_TM *Acc,
