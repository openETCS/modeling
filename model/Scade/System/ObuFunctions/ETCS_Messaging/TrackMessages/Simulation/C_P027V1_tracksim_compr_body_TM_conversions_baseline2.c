...
{
  /* 1 */ T_Build_Metadata_Packet_I_reset_TM_lib_internal(&outC->Context_1);
  /* 3 */ T_Build_Metadata_Packet_I_reset_TM_lib_internal(&outC->Context_3);
}
  ...
  outC_C_P027V1_tracksim_compr_body_TM_conversions_baseline2 *outC)
{
  ...
  /* 3 */
  T_Build_Metadata_Packet_I_TM_lib_internal(
    outC->_L387,
    outC->_L215,
    1,
    27,
  ...
  kcg_copy_array__497(&outC->_L385[0], &outC->_L386);
  kcg_copy_P027V1_trackside_sectionlist_T_TM_baseline2(
    &outC->_L385[1],
    &outC->_L367);
