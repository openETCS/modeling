...
/* ========================  input structure  ====================== */
typedef struct {
  P027V1_trackside_int_T_TM_baseline2 /* TM_conversions_baseline2::C_P027V1_tracksim_compr_body::P027V1_from_track */ P027V1_from_track;
} inC_C_P027V1_tracksim_compr_body_TM_conversions_baseline2;
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_T_Build_Metadata_Packet_I_TM_lib_internal /* 1 */ Context_1;
  outC_T_Build_Metadata_Packet_I_TM_lib_internal /* 3 */ Context_3;
  ...
  array__497 /* TM_conversions_baseline2::C_P027V1_tracksim_compr_body::_L386 */ _L386;
  array__459 /* TM_conversions_baseline2::C_P027V1_tracksim_compr_body::_L385 */ _L385;
...
extern void C_P027V1_tracksim_compr_body_TM_conversions_baseline2(
  inC_C_P027V1_tracksim_compr_body_TM_conversions_baseline2 *inC,
