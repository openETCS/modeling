#include "RECV_ReadRadioPacket_mapping.h"
#include "RECV_ReadRadioPacket_interface.h"
...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_RECV_ReadRadioPacket();
...
void _SCSIM_Mapping_RECV_ReadRadioPacket() {
	pSimulator->m_pfnSetRoot(pSimulator, "RECV_ReadRadioPacket/", &outputs_ctx, _SCSIM_Get_RECV_ReadRadioPacket_Handle);
	pSimulator->m_pfnPushIterator(pSimulator, "mapwi", 500, 500);
	_SCSIM_Mapping_RECV_ReadRadioPacketLoop("RECV_ReadRadioPacketLoop", "1", 1, 0, 0);
	pSimulator->m_pfnPopIterator(pSimulator);
	pSimulator->m_pfnAddLocal(pSimulator, "_L3", &_SCSIM_CompressedRadioData_Utils, 2, valid, 0, 0);
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L6", &_SCSIM_array_int_500_Utils, 5, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L7", &_SCSIM_array_int_500_Utils, 6, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L8", &_SCSIM_kcg_bool_Utils, 7, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L10", &_SCSIM_array_int_500_Utils, 8, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L18", &_SCSIM_array_int_500_500_Utils, 9, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L22", &_SCSIM_kcg_int_Utils, 10, valid, 0, 0);
	pSimulator->m_pfnAddOutput(pSimulator, "PacketOut", &_SCSIM_array_int_500_Utils, 11, valid, 0, 0);
	...
	pSimulator->m_pfnAddInput(pSimulator, "PacketData", &_SCSIM_CompressedRadioData_Utils, 14, valid, 0, 0);
}
...
void _SCSIM_Mapping_RECV_ReadRadioPacketLoop(const char* pszPath, const char* pszInstanceName, int nHandleIdent, int nClockHandleIdent, int (*pfnClockActive)(void*)) {
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L9", &_SCSIM_CompressedRadioData_Utils, 18, valid, 0, 0);
