...
void C_P005_compr_onboard_TM_conversions(
  /* TM_conversions::C_P005_compr_onboard::P005_compressed */CompressedPacketData_T_Common_Types_Pkg *P005_compressed,
  ...
  outC_C_P005_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_bool noname_1;
  NID_PACKET noname;
  MetadataElement_T_Common_Types_Pkg _29_noname;
  
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(&outC->_L9, P005_compressed);
  ...
  kcg_copy_MetadataElement_T_Common_Types_Pkg(&_29_noname, &outC->_L20);
  outC->_L19 = kcg_true;
