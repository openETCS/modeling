...
kcg_bool kcg_comp_array_int_165(array_int_165 *kcg_c1, array_int_165 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  
  kcg_equ = kcg_true;
  for (kcg_ci = 0; kcg_ci < 165; kcg_ci++) {
    kcg_equ = kcg_equ & ((*kcg_c1)[kcg_ci] == (*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
}
...
kcg_bool kcg_comp_struct__337(struct__337 *kcg_c1, struct__337 *kcg_c2)
{
  ...
  kcg_equ = kcg_true;
  kcg_equ = kcg_equ & (kcg_c1->end_addr == kcg_c2->end_addr);
  kcg_equ = kcg_equ & (kcg_c1->start_addr == kcg_c2->start_addr);
  kcg_equ = kcg_equ & (kcg_c1->meta_id == kcg_c2->meta_id);
  return kcg_equ;
}

kcg_bool kcg_comp_struct__343(struct__343 *kcg_c1, struct__343 *kcg_c2)
{
  kcg_bool kcg_equ;
