...
kcg_bool kcg_comp_array__1055(array__1055 *kcg_c1, array__1055 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 30; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__1035(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_struct__1035(struct__1035 *kcg_c1, struct__1035 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__1046(struct__1046 *kcg_c1, struct__1046 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__1058(struct__1058 *kcg_c1, struct__1058 *kcg_c2)
{
  kcg_bool kcg_equ;
  ...
  kcg_equ = kcg_equ & kcg_comp_array_int_500(
      &kcg_c1->PacketData,
      &kcg_c2->PacketData);
  kcg_equ = kcg_equ & kcg_comp_array__1055(
