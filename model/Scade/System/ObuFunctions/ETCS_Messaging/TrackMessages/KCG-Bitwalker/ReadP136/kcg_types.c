...
kcg_bool kcg_comp_array__888(array__888 *kcg_c1, array__888 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 30; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__869(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_struct__869(struct__869 *kcg_c1, struct__869 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__880(struct__880 *kcg_c1, struct__880 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__891(struct__891 *kcg_c1, struct__891 *kcg_c2)
{
  kcg_bool kcg_equ;
  ...
  kcg_equ = kcg_equ & kcg_comp_array_int_500(
      &kcg_c1->PacketData,
      &kcg_c2->PacketData);
  kcg_equ = kcg_equ & kcg_comp_array__888(
