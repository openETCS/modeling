...
kcg_bool kcg_comp_array__669(array__669 *kcg_c1, array__669 *kcg_c2)
{
  kcg_bool kcg_equ;
  kcg_int kcg_ci;
  ...
  for (kcg_ci = 0; kcg_ci < 30; kcg_ci++) {
    kcg_equ = kcg_equ & kcg_comp_struct__650(
        &(*kcg_c1)[kcg_ci],
        &(*kcg_c2)[kcg_ci]);
  }
  return kcg_equ;
...
kcg_bool kcg_comp_struct__650(struct__650 *kcg_c1, struct__650 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__658(struct__658 *kcg_c1, struct__658 *kcg_c2)
{
  kcg_bool kcg_equ;
...
kcg_bool kcg_comp_struct__672(struct__672 *kcg_c1, struct__672 *kcg_c2)
{
  kcg_bool kcg_equ;
  ...
  kcg_equ = kcg_equ & kcg_comp_array_int_500(
      &kcg_c1->PacketData,
      &kcg_c2->PacketData);
  kcg_equ = kcg_equ & kcg_comp_array__669(
