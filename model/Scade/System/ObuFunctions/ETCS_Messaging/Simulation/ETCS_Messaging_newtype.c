...
int is_array_int_20_double_convertion_allowed()
{
    if (pSimarray_int_20VTable != NULL) {
        return is_VTable_double_convertion_allowed(pSimarray_int_20VTable);
    }
    return 0;
}
...
SimTypeUtils _Type_array_int_20_Utils = {
    ...
    is_array_int_20_double_convertion_allowed,
...
int Information_T_BM_Types_Flat_to_string(const void *pValue, PFNSTRAPPEND pfnStrAppend, void *pData)
{
    if (pSimInformation_T_BM_Types_FlatVTable != NULL
        && pSimInformation_T_BM_Types_FlatVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimInformation_T_BM_Types_FlatVTable->m_pfnToType(SptString, pValue), pData);
    }
    return array_int_20_to_string(pValue, pfnStrAppend, pData);
}

int string_to_Information_T_BM_Types_Flat(const char *str, void *pValue, char **endptr)
{
    int nRet=0;
    skip_whitespace(str);
    if (pSimInformation_T_BM_Types_FlatVTable != NULL) {
        nRet=string_to_VTable(str, pSimInformation_T_BM_Types_FlatVTable, pValue, endptr);
    }
    if (nRet==0) {
        nRet = string_to_array_int_20(str, pValue, endptr);
    }
    return nRet;
}

int is_Information_T_BM_Types_Flat_double_convertion_allowed()
{
    if (pSimInformation_T_BM_Types_FlatVTable != NULL) {
        return is_VTable_double_convertion_allowed(pSimInformation_T_BM_Types_FlatVTable);
    }
    return is_array_int_20_double_convertion_allowed();
}

void compare_Information_T_BM_Types_Flat(int *pResult, const void *pValue1, const void *pValue2, void *pData, const char *pszPath, PFNSTRAPPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult=0;
    /* Customized comparison */
    if (pSimInformation_T_BM_Types_FlatVTable != NULL
        && pSimInformation_T_BM_Types_FlatVTable->m_version >= Scv612
        && pSimInformation_T_BM_Types_FlatVTable->m_pfnCompare != NULL) {
        if (pSimInformation_T_BM_Types_FlatVTable->m_version >= Scv65) {
            /*R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult|=SIM_CMP_RES_LT/...): */
            unitResult=pSimInformation_T_BM_Types_FlatVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /*Before R15: VTable Compare function shall SET *pResult global flag (*pResult=-1/1/0): */
            pSimInformation_T_BM_Types_FlatVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        compare_array_int_20(pResult, pValue1, pValue2, pData, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult!=0 && pfnStrListAppend!=NULL && pszPath!=NULL && *pszPath!=0 && pListErrPaths!=NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int Information_T_BM_Types_Flat_to_double(const void *pValue, double *nRetValue)
{
    if (pSimInformation_T_BM_Types_FlatVTable != NULL) {
        return VTable_to_double(pValue, pSimInformation_T_BM_Types_FlatVTable, nRetValue);
    }
    return array_int_20_to_double(pValue, nRetValue);
}

int get_Information_T_BM_Types_Flat_signature(int (*pfnStrAppend)(const char *str, void *pData), void *pData)
{
    return get_array_int_20_signature(pfnStrAppend, pData);
}

int set_Information_T_BM_Types_Flat_default_value(void *pValue)
{
    return set_array_int_20_default_value(pValue);
}

int check_Information_T_BM_Types_Flat_string(const char *str, char **endptr)
{
    static Information_T_BM_Types_Flat rTemp;
    return string_to_Information_T_BM_Types_Flat(str, &rTemp, endptr);
}

SimTypeUtils _Type_Information_T_BM_Types_Flat_Utils = {
    Information_T_BM_Types_Flat_to_string,
    check_Information_T_BM_Types_Flat_string,
    string_to_Information_T_BM_Types_Flat,
    is_Information_T_BM_Types_Flat_double_convertion_allowed,
    Information_T_BM_Types_Flat_to_double,
    compare_Information_T_BM_Types_Flat,
    get_Information_T_BM_Types_Flat_signature,
    set_Information_T_BM_Types_Flat_default_value,
    sizeof(Information_T_BM_Types_Flat)
};
...
int InfoElement_T_BM_Types_Flat_to_string(const void *pValue, PFNSTRAPPEND pfnStrAppend, void *pData)
{
    if (pSimInfoElement_T_BM_Types_FlatVTable != NULL
        && pSimInfoElement_T_BM_Types_FlatVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimInfoElement_T_BM_Types_FlatVTable->m_pfnToType(SptString, pValue), pData);
    }
    return kcg_int_to_string(pValue, pfnStrAppend, pData);
}

int string_to_InfoElement_T_BM_Types_Flat(const char *str, void *pValue, char **endptr)
{
    int nRet=0;
    skip_whitespace(str);
    if (pSimInfoElement_T_BM_Types_FlatVTable != NULL) {
        nRet=string_to_VTable(str, pSimInfoElement_T_BM_Types_FlatVTable, pValue, endptr);
    }
    if (nRet==0) {
...
int is_InfoElement_T_BM_Types_Flat_double_convertion_allowed()
{
    if (pSimInfoElement_T_BM_Types_FlatVTable != NULL) {
        return is_VTable_double_convertion_allowed(pSimInfoElement_T_BM_Types_FlatVTable);
    }
    return is_kcg_int_double_convertion_allowed();
}

void compare_InfoElement_T_BM_Types_Flat(int *pResult, const void *pValue1, const void *pValue2, void *pData, const char *pszPath, PFNSTRAPPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult=0;
    /* Customized comparison */
    if (pSimInfoElement_T_BM_Types_FlatVTable != NULL
        && pSimInfoElement_T_BM_Types_FlatVTable->m_version >= Scv612
        && pSimInfoElement_T_BM_Types_FlatVTable->m_pfnCompare != NULL) {
        if (pSimInfoElement_T_BM_Types_FlatVTable->m_version >= Scv65) {
            /*R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult|=SIM_CMP_RES_LT/...): */
            unitResult=pSimInfoElement_T_BM_Types_FlatVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /*Before R15: VTable Compare function shall SET *pResult global flag (*pResult=-1/1/0): */
            pSimInfoElement_T_BM_Types_FlatVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
...
int InfoElement_T_BM_Types_Flat_to_double(const void *pValue, double *nRetValue)
{
    if (pSimInfoElement_T_BM_Types_FlatVTable != NULL) {
        return VTable_to_double(pValue, pSimInfoElement_T_BM_Types_FlatVTable, nRetValue);
    }
    return kcg_int_to_double(pValue, nRetValue);
}

int get_InfoElement_T_BM_Types_Flat_signature(int (*pfnStrAppend)(const char *str, void *pData), void *pData)
{
    return get_kcg_int_signature(pfnStrAppend, pData);
}

int set_InfoElement_T_BM_Types_Flat_default_value(void *pValue)
{
    return set_kcg_int_default_value(pValue);
}

int check_InfoElement_T_BM_Types_Flat_string(const char *str, char **endptr)
{
    static InfoElement_T_BM_Types_Flat rTemp;
    return string_to_InfoElement_T_BM_Types_Flat(str, &rTemp, endptr);
}

SimTypeUtils _Type_InfoElement_T_BM_Types_Flat_Utils = {
    InfoElement_T_BM_Types_Flat_to_string,
    check_InfoElement_T_BM_Types_Flat_string,
    string_to_InfoElement_T_BM_Types_Flat,
    is_InfoElement_T_BM_Types_Flat_double_convertion_allowed,
    InfoElement_T_BM_Types_Flat_to_double,
    compare_InfoElement_T_BM_Types_Flat,
    get_InfoElement_T_BM_Types_Flat_signature,
    set_InfoElement_T_BM_Types_Flat_default_value,
    sizeof(InfoElement_T_BM_Types_Flat)
};
...
int NID_VBCMK_T_Types_Notfound_to_string(const void *pValue, PFNSTRAPPEND pfnStrAppend, void *pData)
{
    if (pSimNID_VBCMK_T_Types_NotfoundVTable != NULL
        && pSimNID_VBCMK_T_Types_NotfoundVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimNID_VBCMK_T_Types_NotfoundVTable->m_pfnToType(SptString, pValue), pData);
    }
    return kcg_int_to_string(pValue, pfnStrAppend, pData);
}

int string_to_NID_VBCMK_T_Types_Notfound(const char *str, void *pValue, char **endptr)
{
    int nRet=0;
    skip_whitespace(str);
    if (pSimNID_VBCMK_T_Types_NotfoundVTable != NULL) {
        nRet=string_to_VTable(str, pSimNID_VBCMK_T_Types_NotfoundVTable, pValue, endptr);
    }
    if (nRet==0) {
        nRet = string_to_kcg_int(str, pValue, endptr);
    }
...
int is_NID_VBCMK_T_Types_Notfound_double_convertion_allowed()
{
    if (pSimNID_VBCMK_T_Types_NotfoundVTable != NULL) {
        return is_VTable_double_convertion_allowed(pSimNID_VBCMK_T_Types_NotfoundVTable);
    }
    return is_kcg_int_double_convertion_allowed();
}

void compare_NID_VBCMK_T_Types_Notfound(int *pResult, const void *pValue1, const void *pValue2, void *pData, const char *pszPath, PFNSTRAPPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult=0;
    /* Customized comparison */
    if (pSimNID_VBCMK_T_Types_NotfoundVTable != NULL
        && pSimNID_VBCMK_T_Types_NotfoundVTable->m_version >= Scv612
        && pSimNID_VBCMK_T_Types_NotfoundVTable->m_pfnCompare != NULL) {
        if (pSimNID_VBCMK_T_Types_NotfoundVTable->m_version >= Scv65) {
            /*R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult|=SIM_CMP_RES_LT/...): */
            unitResult=pSimNID_VBCMK_T_Types_NotfoundVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /*Before R15: VTable Compare function shall SET *pResult global flag (*pResult=-1/1/0): */
            pSimNID_VBCMK_T_Types_NotfoundVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
...
int NID_VBCMK_T_Types_Notfound_to_double(const void *pValue, double *nRetValue)
{
    if (pSimNID_VBCMK_T_Types_NotfoundVTable != NULL) {
        return VTable_to_double(pValue, pSimNID_VBCMK_T_Types_NotfoundVTable, nRetValue);
    }
    return kcg_int_to_double(pValue, nRetValue);
}

int get_NID_VBCMK_T_Types_Notfound_signature(int (*pfnStrAppend)(const char *str, void *pData), void *pData)
{
    return get_kcg_int_signature(pfnStrAppend, pData);
}

int set_NID_VBCMK_T_Types_Notfound_default_value(void *pValue)
{
    return set_kcg_int_default_value(pValue);
}

int check_NID_VBCMK_T_Types_Notfound_string(const char *str, char **endptr)
{
    static NID_VBCMK_T_Types_Notfound rTemp;
    return string_to_NID_VBCMK_T_Types_Notfound(str, &rTemp, endptr);
}

SimTypeUtils _Type_NID_VBCMK_T_Types_Notfound_Utils = {
    NID_VBCMK_T_Types_Notfound_to_string,
    check_NID_VBCMK_T_Types_Notfound_string,
    string_to_NID_VBCMK_T_Types_Notfound,
    is_NID_VBCMK_T_Types_Notfound_double_convertion_allowed,
    NID_VBCMK_T_Types_Notfound_to_double,
    compare_NID_VBCMK_T_Types_Notfound,
    get_NID_VBCMK_T_Types_Notfound_signature,
    set_NID_VBCMK_T_Types_Notfound_default_value,
    sizeof(NID_VBCMK_T_Types_Notfound)
};
