...
enum {
	portWke = 18118,  // Output to  Gleisplan
	portTrk = 18119,  // Input from Gleisplan
...
void MODEL_init(int argc, char **argv) {
...
int main(int argc, char **argv){
	...
	for(;;) {
		...
		if (CTX_testDMI.forceExit) break;
