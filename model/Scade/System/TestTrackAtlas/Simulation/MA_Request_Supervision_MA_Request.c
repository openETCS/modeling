  ...
  outC_MA_Request_Supervision_MA_Request *outC)
{
  ...
  kcg_bool tmp4;
  kcg_bool tmp5;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_TR_SM1 _13_SM1_fired;
  /* MA_Request::MA_Request_Supervision::SM1 */ kcg_bool _12_SM1_reset_nxt;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_ST_SM1 _11_SM1_state_nxt;
  /* MA_Request::MA_Request_Supervision::pendingReq */ kcg_bool _10_pendingReq;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_TR_SM1 _9_SM1_fired;
  /* MA_Request::MA_Request_Supervision::SM1 */ kcg_bool _8_SM1_reset_nxt;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_ST_SM1 _7_SM1_state_nxt;
  /* MA_Request::MA_Request_Supervision::pendingReq */ kcg_bool _6_pendingReq;
  ...
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_TR_SM1 _19_SM1_fired_strong;
  /* MA_Request::MA_Request_Supervision::SM1 */ kcg_bool _18_SM1_reset_act;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_ST_SM1 _17_SM1_state_act;
  /* MA_Request::MA_Request_Supervision::SM1::init */ kcg_bool br_1_guard_SM1_init;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_TR_SM1 _16_SM1_fired_strong;
  /* MA_Request::MA_Request_Supervision::SM1 */ kcg_bool _15_SM1_reset_act;
  /* MA_Request::MA_Request_Supervision::SM1 */ SSM_ST_SM1 _14_SM1_state_act;
  ...
  if (outC->tmp1) {
    ...
    tmp5 = outC->Context_op_3_8_2_3_a.triggerMA;
    tmp4 = outC->Context_op_3_8_2_3_a.exception;
  }
  outC->_L40 = kcg_false;
  if (outC->tmp1) {
    outC->_L73 = tmp4;
  ...
  outC->_L74 = outC->Context_1.exception;
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_init_SM1 :
      ...
      if (br_1_guard_SM1_init) {
        _17_SM1_state_act = SSM_st_NoReqPending_SM1;
      }
      else {
        _17_SM1_state_act = SSM_st_init_SM1;
      }
      outC->SM1_state_act = _17_SM1_state_act;
      break;
    case SSM_st_NoReqPending_SM1 :
      br_1_guard_SM1_NoReqPending = in_triggerMA == kcg_true;
      if (br_1_guard_SM1_NoReqPending) {
        _14_SM1_state_act = SSM_st_ReqPending_SM1;
      }
      else {
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_init_SM1 :
      _10_pendingReq = last_pendingReq;
      outC->pendingReq = _10_pendingReq;
      break;
    case SSM_st_NoReqPending_SM1 :
      outC->_L1_SM1_NoReqPending = kcg_false;
      _6_pendingReq = outC->_L1_SM1_NoReqPending;
      outC->pendingReq = _6_pendingReq;
      break;
    case SSM_st_ReqPending_SM1 :
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_init_SM1 :
      if (br_1_guard_SM1_init) {
        _19_SM1_fired_strong = SSM_TR_init_1_SM1;
      }
      else {
        _19_SM1_fired_strong = SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _19_SM1_fired_strong;
      break;
    case SSM_st_NoReqPending_SM1 :
      if (br_1_guard_SM1_NoReqPending) {
        _16_SM1_fired_strong = SSM_TR_NoReqPending_1_SM1;
      }
      else {
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_init_SM1 :
      ...
      _11_SM1_state_nxt = SSM_st_init_SM1;
      outC->SM1_fired = _13_SM1_fired;
      break;
    case SSM_st_NoReqPending_SM1 :
      _9_SM1_fired = outC->SM1_fired_strong;
      _8_SM1_reset_nxt = kcg_false;
      _7_SM1_state_nxt = SSM_st_NoReqPending_SM1;
      outC->SM1_fired = _9_SM1_fired;
      break;
    case SSM_st_ReqPending_SM1 :
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_init_SM1 :
      _18_SM1_reset_act = br_1_guard_SM1_init;
      break;
    case SSM_st_NoReqPending_SM1 :
      _15_SM1_reset_act = br_1_guard_SM1_NoReqPending;
      break;
    case SSM_st_ReqPending_SM1 :
