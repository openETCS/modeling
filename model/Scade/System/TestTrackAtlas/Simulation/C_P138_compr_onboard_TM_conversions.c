...
{
  /* 1 */ CAST_Int_to_D_STARTREVERSE_reset_TM_conversions(&outC->_1_Context_1);
  /* 1 */ CAST_Int_to_L_REVERSEAREA_reset_TM_conversions(&outC->Context_1);
}
  ...
  outC_C_P138_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int_6(&outC->_L45, (array_int_6 *) &outC->_L9[0]);
  outC->_L62 = outC->_L45[5];
  outC->_L61 = outC->_L45[4];
  outC->_L60 = outC->_L45[3];
  outC->_L59 = outC->_L45[2];
  outC->_L58 = outC->_L45[1];
  _25_noname = outC->_L59;
  outC->_L57 = outC->_L45[0];
  /* 1 */
  CAST_Int_to_L_REVERSEAREA_TM_conversions(outC->_L62, &outC->Context_1);
  outC->_L33 = outC->Context_1.l_reversearea;
  /* 1 */
  CAST_Int_to_D_STARTREVERSE_TM_conversions(outC->_L61, &outC->_1_Context_1);
  outC->_L31 = outC->_1_Context_1.d_startreverse;
  outC->q_scale_int_1 = outC->_L60;
  outC->_L2_17 = outC->q_scale_int_1;
  outC->q_scale_in_1 = outC->_L2_17;
  outC->_9_IfBlock1_clock_1 = outC->q_scale_in_1 ==
    INT_Q_SCALE_10cm_TM_conversions;
  if (outC->_9_IfBlock1_clock_1) {
    outC->_L2_118_IfBlock1 = ENUM_Q_SCALE_10cm_TM_conversions;
    _24_q_scale_1 = outC->_L2_118_IfBlock1;
    outC->q_scale_1 = _24_q_scale_1;
  }
  else {
    outC->_17_else_clock_1_IfBlock1 = outC->q_scale_in_1 ==
      INT_Q_SCALE_1m_TM_conversions;
    if (outC->_17_else_clock_1_IfBlock1) {
      outC->_L1_111_IfBlock1 = ENUM_Q_SCALE_1m_TM_conversions;
      q_scale_1 = outC->_L1_111_IfBlock1;
      _22_q_scale_1 = q_scale_1;
    }
    else {
      outC->_12_else_clock_1_IfBlock1 = outC->q_scale_in_1 ==
        INT_Q_SCALE_10m_TM_conversions;
      if (outC->_12_else_clock_1_IfBlock1) {
        outC->_L1_115_IfBlock1 = ENUM_Q_SCALE_10m_TM_conversions;
        _19_q_scale_1 = outC->_L1_115_IfBlock1;
        _16_q_scale_1 = _19_q_scale_1;
      }
      else {
        outC->_L1_114_IfBlock1 = ENUM_Q_SCALE_10cm_TM_conversions;
  ...
  outC->nid_packet_int_1 = outC->_L57;
  ...
  if (outC->_9_IfBlock1_clock_1) {
    outC->_L3_119_IfBlock1 = kcg_false;
    _23_error_1 = outC->_L3_119_IfBlock1;
    outC->_8_error_1 = _23_error_1;
  }
  else {
    if (outC->_17_else_clock_1_IfBlock1) {
      outC->_L3_110_IfBlock1 = kcg_false;
      _14_error_1 = outC->_L3_110_IfBlock1;
      _21_error_1 = _14_error_1;
    }
    else {
      if (outC->_12_else_clock_1_IfBlock1) {
        outC->_L4_116_IfBlock1 = kcg_false;
        _20_error_1 = outC->_L4_116_IfBlock1;
        _15_error_1 = _20_error_1;
      }
      else {
        outC->_L2_113_IfBlock1 = kcg_true;
        _18_error_1 = outC->_L2_113_IfBlock1;
  ...
  outC->_L4_16 = outC->_8_error_1;
  _13_noname_1 = outC->_L4_16;
}
