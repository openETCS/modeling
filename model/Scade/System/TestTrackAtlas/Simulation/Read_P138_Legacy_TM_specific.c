...
{
  /* 1 */ C_P138_to_legacy_t_reset_TM_conversions(&outC->_1_Context_1);
  /* 1 */ Read_P138_reset_TM(&outC->Context_1);
}
...
{
  P138_ReversingAreaInformation_T_Packet_Types_Pkg tmp;
  
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, Message_IN);
  /* 1 */ Read_P138_TM(&outC->_L3, &outC->Context_1);
  outC->_L1 = outC->Context_1.received;
  kcg_copy_P138_OBU_T_TM(&outC->_L2, &outC->Context_1.P138_OBU_out);
  outC->tmp = outC->_L1;
  if (outC->tmp) {
    /* 1 */ C_P138_to_legacy_t_TM_conversions(&outC->_L2, &outC->_1_Context_1);
    kcg_copy_P138_ReversingAreaInformation_T_Packet_Types_Pkg(
      &tmp,
      &outC->_1_Context_1.P138_legacy_out);
    kcg_copy_P138_ReversingAreaInformation_T_Packet_Types_Pkg(&outC->_L4, &tmp);
  }
  else {
    kcg_copy_P138_ReversingAreaInformation_T_Packet_Types_Pkg(
      &outC->_L4,
