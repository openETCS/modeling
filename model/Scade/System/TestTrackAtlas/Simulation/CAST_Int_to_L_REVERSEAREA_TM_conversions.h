...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  L_REVERSEAREA /* TM_conversions::CAST_Int_to_L_REVERSEAREA::l_reversearea */ l_reversearea;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L10 */ _L10;
  kcg_int /* TM_conversions::CAST_Int_to_L_REVERSEAREA::_L11 */ _L11;
