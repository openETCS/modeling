...
{
  /* 1 */ C_P015_to_legacy_t_reset_TM_conversions(&outC->_1_Context_1);
...
{
  P15_Level23MovementAuthorities_T_Packet_Types_Pkg tmp;
  
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, Message_IN);
  /* 1 */ Read_P015_TM(&outC->_L3, &outC->Context_1);
  outC->_L1 = outC->Context_1.received;
  kcg_copy_P015_OBU_T_TM(&outC->_L2, &outC->Context_1.P015_OBU_out);
  outC->tmp = outC->_L1;
  if (outC->tmp) {
    /* 1 */ C_P015_to_legacy_t_TM_conversions(&outC->_L2, &outC->_1_Context_1);
    kcg_copy_P15_Level23MovementAuthorities_T_Packet_Types_Pkg(
      &tmp,
      &outC->_1_Context_1.P015_legacy_out);
    kcg_copy_P15_Level23MovementAuthorities_T_Packet_Types_Pkg(
      &outC->_L4,
      &tmp);
  }
