...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P021_OBU_T_TM /* Internal_Tests::TestP021::PacketOut */ PacketOut;
  /* -----------------------  no local probes  ----------------------- */
...
extern void TestP021_Internal_Tests(outC_TestP021_Internal_Tests *outC);

extern void TestP021_reset_Internal_Tests(outC_TestP021_Internal_Tests *outC);
