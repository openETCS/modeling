...
{
  /* 2 */ SSP_Truncate_at_BG_reset_TA_SSP(&outC->_3_Context_2);
  /* 2 */ SSP_Normalize_Profile_reset_TA_SSP(&outC->Context_2);
  /* 1 */ SSP_Truncate_at_BG_reset_TA_SSP(&outC->_2_Context_1);
  /* 1 */ SSP_Normalize_Profile_reset_TA_SSP(&outC->_1_Context_1);
  ...
  outC_SSP_Position_SSP_with_BGs_TA_SSP *outC)
{
  ...
  outC->_L9 = pos_LRBG;
  /* 1 */
  SSP_Normalize_Profile_TA_SSP(&outC->_L6, outC->_L9, &outC->_1_Context_1);
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(
    &outC->_L16,
    &outC->_1_Context_1.ProfileNormalized_LRBG);
  /* 1 */ SSP_Truncate_at_BG_TA_SSP(&outC->_L16, &outC->_2_Context_1);
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(
    &outC->_L22,
    &outC->_2_Context_1.Profile_out);
  outC->_L28 = outC->_L22[0].valid;
  ...
  /* 2 */ SSP_Truncate_at_BG_TA_SSP(&outC->_L18, &outC->_3_Context_2);
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(
    &outC->_L23,
    &outC->_3_Context_2.Profile_out);
  outC->_L15 = there_is_prvLRBG;
  noname = outC->_L15;
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(
    &outC->ProfileLoopOut,
    &outC->_L23);
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(&outC->ProfileOut, &outC->_L22);
}
