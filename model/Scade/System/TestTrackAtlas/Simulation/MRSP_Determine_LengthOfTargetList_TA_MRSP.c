...
void MRSP_Determine_LengthOfTargetList_reset_TA_MRSP(
  outC_MRSP_Determine_LengthOfTargetList_TA_MRSP *outC)
{
  ...
  for (i = 0; i < 363; i++) {
    /* 1 */
    MRSP_Determine_LengthOfTargetList_LOOP_reset_TA_MRSP(&outC->Context_1[i]);
  }
}

/* TA_MRSP::MRSP_Determine_LengthOfTargetList */
void MRSP_Determine_LengthOfTargetList_TA_MRSP(
