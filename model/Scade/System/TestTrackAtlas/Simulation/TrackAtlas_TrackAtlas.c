...
void TrackAtlas_reset_TrackAtlas(outC_TrackAtlas_TrackAtlas *outC)
{
  ...
  /* 1_1 */
  C_P003V1_OBU_P003_OBU_reset_TM_conversions_baseline2(&outC->_10_Context_1_1);
  /* 1_1 */ TA_to_ML_reset_TA_Export(&outC->_9_Context_1_1);
  for (i = 0; i < 200; i++) {
    /* 1_1 */ MRSP_to_MRSP_to_DMI_reset_TA_Export(&outC->_8_Context_1_1[i]);
  }
  ...
  outC_TrackAtlas_TrackAtlas *outC)
{
  ...
  kcg_int i1;
  kcg_int i;
  DataForSupervision_nextGen_t_TrackAtlasTypes tmp3;
  kcg_bool _8_noname_1;
  kcg_bool _7_noname_1;
  FromTIU_t_TrackAtlasTypes _6_noname_1;
  MRSP_Profile_t_TrackAtlasTypes _5_noname_1;
  kcg_int _4_noname_1;
  kcg_int noname_1;
  kcg_bool tmp9;
  kcg_bool tmp10;
  kcg_bool tmp11;
  Radio_TrainTrack_Message_T_Radio_Types_Pkg tmp12;
  Radio_TrainTrack_Message_T_Radio_Types_Pkg tmp13;
  MovementAuthority_t_TrackAtlasTypes tmp14;
  DataForSupervision_nextGen_t_TrackAtlasTypes tmp15;
  kcg_bool tmp16;
  DataForDMI_t_TrackAtlasTypes tmp17;
  DataForModeAndLevel_t_TrackAtlasTypes tmp18;
  P003_OBU_T_TM tmp19;
  ...
  if (outC->tmp11) {
    ...
    tmp9 = outC->trip_train_1;
  }
  outC->_L70 = kcg_false;
  if (outC->tmp11) {
    outC->_L11 = tmp9;
    outC->ces_revoked_1 = outC->_L93_1;
    tmp10 = outC->ces_revoked_1;
    outC->_L10 = tmp10;
    outC->ces_accepted_1 = outC->_L90_1;
    tmp11 = outC->ces_accepted_1;
    outC->_L9 = tmp11;
    kcg_copy_Radio_TrainTrack_Message_T_Radio_Types_Pkg(
      &outC->message147_1,
      &outC->_L88_1);
  ...
  if (outC->tmp11) {
    kcg_copy_Radio_TrainTrack_Message_T_Radio_Types_Pkg(&outC->_L8, &tmp12);
    kcg_copy_trainPosition_T_TrainPosition_Types_Pck(
      &outC->_L74_1,
      &outC->TrainPositionIn_1);
    ...
    kcg_copy_Radio_TrainTrack_Message_T_Radio_Types_Pkg(
      &tmp13,
      &outC->MA_request_out_1);
    kcg_copy_Radio_TrainTrack_Message_T_Radio_Types_Pkg(&outC->_L7, &tmp13);
    kcg_copy_MovementAuthority_t_TrackAtlasTypes(
  ...
  if (outC->tmp11) {
    kcg_copy_MovementAuthority_t_TrackAtlasTypes(&outC->_L5, &tmp14);
    ...
    outC->_L123_1 = outC->TrainData_in_1;
    kcg_copy_T_Mode_Level_Level_And_Mode_Types_Pkg(
      &outC->_L26_1,
      &outC->ModeAndLevel_in_1);
    outC->_L30_1 = outC->train_length_1;
    /* 1_1 */
    Build_MRSP_TA_MRSP(
      &outC->_L24_1,
      outC->_L123_1,
    ...
    if (outC->_L121_1) {
      for (i1 = 0; i1 < 200; i1++) {
        ...
        SSP_to_MRSP_TA_Export(
          ...
          &tmp,
          &outC->_L122_1[i1],
          &outC->_6_Context_1_1[i1]);
        kcg_copy_MRSP_Profile_t_TrackAtlasTypes(
          &outC->_L119_1,
          &outC->_6_Context_1_1[i1].MRSP);
        outC->_L118_1 = i1 + 1;
        if (!outC->_6_Context_1_1[i1].cont) {
          break;
        }
      }
    }
  ...
  if (outC->tmp11) {
    kcg_copy_DataForSupervision_nextGen_t_TrackAtlasTypes(&outC->_L4, &tmp15);
    outC->SSP_available_1 = outC->_L100_1;
    tmp16 = outC->SSP_available_1;
    outC->_L76 = tmp16;
    /* 1_1 */
    ...
    if (outC->_L128_1) {
      for (i = 0; i < 200; i++) {
        ...
        MRSP_to_MRSP_to_DMI_TA_Export(
          i,
          &outC->_L129_1[i],
          &outC->_8_Context_1_1[i]);
        kcg_copy_MRSP_section_t_TrackAtlasTypes(
          &outC->_L127_1[i],
          &outC->_8_Context_1_1[i].MRSP_to_DMI);
        outC->_L126_1 = i + 1;
        if (!outC->_8_Context_1_1[i].cont) {
          break;
        }
      }
    }
    ...
    kcg_copy_MRSP_Profile_t_TrackAtlasTypes(&outC->_L35_1.MRSP, &outC->_L131_1);
    outC->_L35_1.MRSP_updated = outC->_L32_1;
    kcg_copy_DataForDMI_t_TrackAtlasTypes(&outC->to_DMI_1, &outC->_L35_1);
    kcg_copy_DataForDMI_t_TrackAtlasTypes(&tmp17, &outC->to_DMI_1);
  }
  else {
    kcg_copy_DataForSupervision_nextGen_t_TrackAtlasTypes(
      &outC->_L4,
  ...
  if (outC->tmp11) {
    kcg_copy_DataForDMI_t_TrackAtlasTypes(&outC->_L3, &tmp17);
    kcg_copy_ReceivedMessage_T_Common_Types_Pkg(
      &outC->_L79_1,
      &outC->MessageIn_1);
    ...
    kcg_copy_T_Data_From_Track_Packet_Level_And_Mode_Types_Pkg(
      &outC->_L77_1,
      &outC->_9_Context_1_1.Data_to_From_Track_Packets_at_ML);
    kcg_copy_T_Data_From_Track_Mess_Level_And_Mode_Types_Pkg(
      &outC->_L78_1,
      &outC->_9_Context_1_1.Data_to_From_Track_Messages_at_ML);
    outC->_L85_1 = outC->_9_Context_1_1.P_12_to_Input_MA_SSP_Gradient_at_ML;
    outC->_L84_1 = outC->_9_Context_1_1.P_15_to_Input_MA_SSP_Gradient_at_ML;
    outC->_L83_1 = outC->_9_Context_1_1.P_21_to_Input_MA_SSP_Gradient_at_ML;
    outC->_L82_1 = outC->_9_Context_1_1.P_27_to_Input_MA_SSP_Gradient_at_ML;
    kcg_copy_T_Data_From_Track_Packet_Level_And_Mode_Types_Pkg(
  ...
  if (outC->tmp11) {
    kcg_copy_DataForModeAndLevel_t_TrackAtlasTypes(&outC->_L2, &tmp18);
    ...
    C_P003V1_OBU_P003_OBU_TM_conversions_baseline2(
      ...
      &outC->_L51_1,
      &outC->_L52_1,
      &outC->_10_Context_1_1);
    kcg_copy_P003_OBU_T_TM(
      &outC->_L50_1,
      &outC->_10_Context_1_1.P003_onbaord_out);
    kcg_copy_P003_OBU_T_TM(&outC->NV_raw_out_1, &outC->_L50_1);
    kcg_copy_P003_OBU_T_TM(&tmp19, &outC->NV_raw_out_1);
  }
  else {
  ...
  if (outC->tmp) {
    ...
    kcg_copy_DataForSupervision_nextGen_t_TrackAtlasTypes(&outC->_L74, &tmp3);
  }
  else {
    kcg_copy_DataForSupervision_nextGen_t_TrackAtlasTypes(
      &outC->_L74,
  ...
  kcg_copy_DataForModeAndLevel_t_TrackAtlasTypes(
    ...
    &outC->_L2);
  if (outC->tmp11) {
    kcg_copy_P003_OBU_T_TM(&outC->_L1, &tmp19);
  }
  else {
  ...
  if (outC->tmp11) {
    noname_1 = outC->_L126_1;
    _4_noname_1 = outC->_L118_1;
    kcg_copy_MRSP_Profile_t_TrackAtlasTypes(&_5_noname_1, &outC->_L19_1);
    outC->_L27_1 = outC->TrainData_in_1;
    _6_noname_1 = outC->_L27_1;
    _7_noname_1 = outC->_L22_1;
    _8_noname_1 = outC->_L20_1;
    outC->init = kcg_false;
  }
}
