  ...
  outC_Receive_MA_RequestParameters_MA_Request *outC)
{
  ...
  outC->IsNew = outC->_L9;
  kcg_copy_struct__23810(&outC->_L7_1, &outC->Init_1);
  if (outC->init) {
    kcg_copy_struct__23810(&outC->_L6_1, &outC->_L7_1);
  }
  else {
    kcg_copy_struct__23810(&outC->_L6_1, &outC->_L4_1);
  }
  outC->_L5_1 = outC->Write_1;
  kcg_copy_P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg(
    &outC->BM_Input_1,
    &outC->_L8);
  kcg_copy_struct__23810(&outC->_L2_1, &outC->BM_Input_1);
  if (outC->_L5_1) {
    kcg_copy_struct__23810(&outC->_L4_1, &outC->_L2_1);
  }
  else {
    kcg_copy_struct__23810(&outC->_L4_1, &outC->_L6_1);
  }
  kcg_copy_struct__23810(&outC->Memorized_1, &outC->_L4_1);
  kcg_copy_P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg(
    &outC->_L2,
    &outC->Memorized_1);
  kcg_copy_P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg(
