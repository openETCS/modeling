...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_MRSP_SplitAndReverseSSP_LOOP1_TA_MRSP /* 1 */ Context_1[11];
  ...
  array__23925 /* TA_MRSP::MRSP_Split_And_Reverse_SSP_matrix::_L51 */ _L51;
} outC_MRSP_Split_And_Reverse_SSP_matrix_TA_MRSP;
...
extern void MRSP_Split_And_Reverse_SSP_matrix_TA_MRSP(
  ...
  outC_MRSP_Split_And_Reverse_SSP_matrix_TA_MRSP *outC);

extern void MRSP_Split_And_Reverse_SSP_matrix_reset_TA_MRSP(
  outC_MRSP_Split_And_Reverse_SSP_matrix_TA_MRSP *outC);
