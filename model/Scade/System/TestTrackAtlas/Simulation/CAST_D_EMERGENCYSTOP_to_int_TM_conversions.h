...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::d_emergencystop_int */ d_emergencystop_int;
  /* -----------------------  no local probes  ----------------------- */
  ...
  D_EMERGENCYSTOP /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::_L9 */ _L9;
  kcg_int /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::_L7 */ _L7;
  kcg_bool /* TM_conversions::CAST_D_EMERGENCYSTOP_to_int::_L6 */ _L6;
