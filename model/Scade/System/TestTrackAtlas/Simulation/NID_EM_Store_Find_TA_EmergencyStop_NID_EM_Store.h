...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store /* TA_EmergencyStop::NID_EM_Store::NID_EM_Store_Find::outAcc */ outAcc;
  /* -----------------------  no local probes  ----------------------- */
  ...
  NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store /* TA_EmergencyStop::NID_EM_Store::NID_EM_Store_Find::_L1 */ _L1;
  struct__23707 /* TA_EmergencyStop::NID_EM_Store::NID_EM_Store_Find::_L3 */ _L3;
  kcg_bool /* TA_EmergencyStop::NID_EM_Store::NID_EM_Store_Find::_L4 */ _L4;
  struct__23707 /* TA_EmergencyStop::NID_EM_Store::NID_EM_Store_Find::_L5 */ _L5;
