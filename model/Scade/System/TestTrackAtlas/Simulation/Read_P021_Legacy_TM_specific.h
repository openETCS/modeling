...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P21_GradientProfiles_T_Packet_Types_Pkg /* TM_specific::Read_P021_Legacy::P015_legacy_out */ P015_legacy_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P021_to_legacy_t_TM_conversions /* 1 */ _1_Context_1;
  outC_Read_P021_TM /* 1 */ Context_1;
  /* ------------------ clocks of observable data -------------------- */
  kcg_bool tmp;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P021_OBU_T_TM /* TM_specific::Read_P021_Legacy::_L2 */ _L2;
  kcg_bool /* TM_specific::Read_P021_Legacy::_L1 */ _L1;
  CompressedPackets_T_Common_Types_Pkg /* TM_specific::Read_P021_Legacy::_L3 */ _L3;
  P21_GradientProfiles_T_Packet_Types_Pkg /* TM_specific::Read_P021_Legacy::_L4 */ _L4;
