...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P003V1_OBU_P003_OBU_convert_nid_c_list_TM_conversions_baseline2 /* 1 */ Context_1;
  ...
  P003_OBU_nid_c_sectionlist_enum_T_TM /* TM_conversions_baseline2::C_P003V1_OBU_P003_OBU::_L59 */ _L59;
