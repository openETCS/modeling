...
void insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  ...
  outC_insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::cont */ kcg_bool cont2;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_out */ positionedBG_T_TrainPosition_Types_Pck _1_BG_out;
  ...
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::cont */ kcg_bool cont3;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_out */ positionedBG_T_TrainPosition_Types_Pck _4_BG_out;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::cont */ kcg_bool cont5;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::insertBG_atIndex_itr::BG_out */ positionedBG_T_TrainPosition_Types_Pck _6_BG_out;
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
        &outC->_L13_IfBlock1,
        BG_shifted_in);
      outC->_L22_IfBlock1 = outC->_L13_IfBlock1.valid;
      cont3 = outC->_L22_IfBlock1;
      kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
        &_4_BG_out,
        &outC->_L13_IfBlock1);
