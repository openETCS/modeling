...
void GP_Processing_reset_TA_Gradient(outC_GP_Processing_TA_Gradient *outC)
{
  outC->init = kcg_true;
  /* 1 */ GP_Position_GP_with_BGs_reset_TA_Gradient(&outC->_2_Context_1);
...
void GP_Processing_TA_Gradient(
  ...
  outC_GP_Processing_TA_Gradient *outC)
{
  ...
  if (outC->init) {
    ...
    kcg_copy_GradientProfile_t_TrackAtlasTypes(&outC->_L7, &outC->_L10);
  }
  outC->_L12 = there_is_prvLRBG;
  /* 1 */
  ...
  outC->_L9 = outC->_2_Context_1.available;
  kcg_copy_GradientProfile_t_TrackAtlasTypes(
    &outC->_L10,
    &outC->_2_Context_1.ProfileLoopOut);
  outC->available = outC->_L9;
  kcg_copy_GradientProfile_t_TrackAtlasTypes(&outC->GP, &outC->_L8);
  outC->init = kcg_false;
}

/* $*************** KCG Version 6.1.3 (build i6) ****************
** GP_Processing_TA_Gradient.c
** Generation date: 2015-09-02T01:48:41
*************************************************************$ */
