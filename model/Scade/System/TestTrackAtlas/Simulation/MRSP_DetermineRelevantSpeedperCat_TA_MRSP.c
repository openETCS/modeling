...
void MRSP_DetermineRelevantSpeedperCat_reset_TA_MRSP(
  outC_MRSP_DetermineRelevantSpeedperCat_TA_MRSP *outC)
{
  ...
  for (i = 0; i < 33; i++) {
    /* 1 */
    MRSP_DetermineRelevantSpeedperCat_LOOP_reset_TA_MRSP(
      &outC->_1_Context_1[i]);
  }
...
void MRSP_DetermineRelevantSpeedperCat_TA_MRSP(
