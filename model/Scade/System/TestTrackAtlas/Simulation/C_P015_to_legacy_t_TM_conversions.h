...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P15_Level23MovementAuthorities_T_Packet_Types_Pkg /* TM_conversions::C_P015_to_legacy_t::P015_legacy_out */ P015_legacy_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P015_to_legacy_loop_TM_conversions /* 1 */ Context_1[5];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P015_OBU_T_TM /* TM_conversions::C_P015_to_legacy_t::_L1 */ _L1;
  array__23570 /* TM_conversions::C_P015_to_legacy_t::_L20 */ _L20;
  array__24111 /* TM_conversions::C_P015_to_legacy_t::_L23 */ _L23;
  array__24114 /* TM_conversions::C_P015_to_legacy_t::_L26 */ _L26;
  P015_OBU_sectionlist_enum_T_TM /* TM_conversions::C_P015_to_legacy_t::_L45 */ _L45;
