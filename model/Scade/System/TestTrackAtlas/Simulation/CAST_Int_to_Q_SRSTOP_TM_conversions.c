...
void CAST_Int_to_Q_SRSTOP_TM_conversions(
  ...
  outC_CAST_Int_to_Q_SRSTOP_TM_conversions *outC)
{
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::q_srstop */ Q_SRSTOP _2_q_srstop;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::error */ kcg_bool error1;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::q_srstop */ Q_SRSTOP q_srstop;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::error */ kcg_bool error;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::q_srstop */ Q_SRSTOP _3_q_srstop;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::error */ kcg_bool error4;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::q_srstop */ Q_SRSTOP _5_q_srstop;
  /* TM_conversions::CAST_Int_to_Q_SRSTOP::error */ kcg_bool error6;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L4_IfBlock1 = ENUM_Q_SRSTOP_go_TM_conversions;
    _2_q_srstop = outC->_L4_IfBlock1;
    outC->q_srstop = _2_q_srstop;
    outC->error = error1;
  }
  else {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L3_IfBlock1 = ENUM_Q_SRSTOP_stop_TM_conversions;
      _5_q_srstop = outC->_L3_IfBlock1;
      error = error6;
      ...
      outC->_L1_IfBlock1 = ENUM_Q_SRSTOP_stop_TM_conversions;
      _3_q_srstop = outC->_L1_IfBlock1;
      error = error4;
      q_srstop = _3_q_srstop;
    }
    outC->q_srstop = q_srstop;
    outC->error = error;
  }
