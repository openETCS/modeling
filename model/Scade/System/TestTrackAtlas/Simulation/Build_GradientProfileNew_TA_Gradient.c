  ...
  outC_Build_GradientProfileNew_TA_Gradient *outC)
{
  ...
  /* 2 */ Convert_P21_to_DistanceProfile_reset_TA_Gradient(&outC->Context_2);
  ...
  outC_Build_GradientProfileNew_TA_Gradient *outC)
{
  ...
  outC->there_is_prvLRBG = outC->_L209;
  outC->_L211 = outC->there_is_prvLRBG;
  if (outC->init) {
  ...
  /* 2 */
  Convert_P21_to_DistanceProfile_TA_Gradient(&outC->_L187, &outC->Context_2);
  kcg_copy_GradientProfile_t_TrackAtlasTypes(
    &outC->_L186,
