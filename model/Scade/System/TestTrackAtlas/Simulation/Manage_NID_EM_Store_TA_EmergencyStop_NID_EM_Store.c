  ...
  outC_Manage_NID_EM_Store_TA_EmergencyStop_NID_EM_Store *outC)
{
  ...
  if (outC->IfBlock1_clock) {
    ...
    kcg_copy_array__23718(&outC->_L16_IfBlock1, &(*inStore).items);
    ...
    kcg_copy_array__23718(&outC->_L5_IfBlock1, &(*inStore).items);
    kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
      &outC->_L1_IfBlock1,
      &outC->_L15_IfBlock1);
    for (i = 0; i < 8; i++) {
    ...
    kcg_copy_array__23718(&outC->_L4_IfBlock1.items, &outC->_L2_IfBlock1);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      kcg_copy_array__23718(&outC->_L44_IfBlock1, &(*inStore).items);
      kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
        &outC->_L17_IfBlock1,
        &outC->_L33_IfBlock1);
      for (i3 = 0; i3 < 8; i3++) {
      ...
      kcg_copy_array__23718(&outC->_L52_IfBlock1.items, &outC->_L28_IfBlock1);
      kcg_copy_NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store(
        &_10_outStore,
        &outC->_L52_IfBlock1);
      kcg_copy_NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store(
