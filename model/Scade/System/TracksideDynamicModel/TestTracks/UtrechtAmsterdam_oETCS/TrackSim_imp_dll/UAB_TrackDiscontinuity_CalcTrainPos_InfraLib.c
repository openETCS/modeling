...
kcg_real UAB_TrackDiscontinuity_CalcTrainPos_InfraLib(
  ...
  /* InfraLib::TrackDiscontinuity_CalcTrainPos::SectionDataIn */UAB_TrackSectionData_T_InfraLib *SectionDataIn)
{
  static kcg_real tmp;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** UAB_TrackDiscontinuity_CalcTrainPos_InfraLib.c
** Generation date: 2015-08-20T20:42:34
*************************************************************$ */
