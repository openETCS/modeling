...
#include "UAB_CAST_Int_to_D_ENDTIMERSTARTLOC_TM_conversions.h"

/* TM_conversions::CAST_Int_to_D_ENDTIMERSTARTLOC */
UAB_D_ENDTIMERSTARTLOC UAB_CAST_Int_to_D_ENDTIMERSTARTLOC_TM_conversions(
  /* TM_conversions::CAST_Int_to_D_ENDTIMERSTARTLOC::d_endtimerstartloc_int */kcg_int d_endtimerstartloc_int)
{
  ...
  static UAB_D_ENDTIMERSTARTLOC d_endtimerstartloc;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** UAB_CAST_Int_to_D_ENDTIMERSTARTLOC_TM_conversions.c
** Generation date: 2015-08-27T15:14:25
*************************************************************$ */
