...
void Balise_Interdistance_reset_FirstTest_InfraLibInt(
  outC_Balise_Interdistance_FirstTest_InfraLibInt *outC)
{
}

/* FirstTest::InfraLibInt::Balise_Interdistance */
void Balise_Interdistance_FirstTest_InfraLibInt(
  ...
  outC_Balise_Interdistance_FirstTest_InfraLibInt *outC)
{
  ...
  outC->_L3 = Distance_Balises_in_BG_FirstTest_InfraLibInt;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Interdistance_FirstTest_InfraLibInt.c
** Generation date: 2015-06-02T15:02:42
*************************************************************$ */
