...
void Balise_364_0_reset_FirstTest_InfraLib(
  outC_Balise_364_0_FirstTest_InfraLib *outC)
{
  /* 1 */ Balise_Packets_364_reset_FirstTest_InfraLib(&outC->_1_Context_1);
  /* 1 */ Balise_Localisation_reset_FirstTest_InfraLib(&outC->Context_1);
}

/* FirstTest::InfraLib::Balise_364_0 */
void Balise_364_0_FirstTest_InfraLib(
  ...
  outC_Balise_364_0_FirstTest_InfraLib *outC)
{
  ...
  if (outC->tmp) {
    /* 1 */
    Balise_Packets_364_FirstTest_InfraLib(
      &outC->_L23,
      &outC->_L5,
      &outC->_1_Context_1);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_364_0_FirstTest_InfraLib.c
** Generation date: 2015-04-25T17:50:04
*************************************************************$ */
