...
{
  /* 2 */ Send_P255_reset_MessageLibBaseline2(&outC->_3_Context_2);
  /* 3 */ Send_P005_reset_MessageLibBaseline2(&outC->Context_3);
  /* 2 */ Send_P027V1_reset_MessageLibBaseline2(&outC->_2_Context_2);
  /* 2 */ Send_P021_reset_MessageLibBaseline2(&outC->_1_Context_2);
  /* 2 */ Send_P015_reset_MessageLibBaseline2(&outC->Context_2);
}
  ...
  outC_SendRadioPackets_LRBG_371_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_RBC *outC)
{
  ...
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
    &outC->_L8,
    &outC->_3_Context_2.packet_data_out);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
