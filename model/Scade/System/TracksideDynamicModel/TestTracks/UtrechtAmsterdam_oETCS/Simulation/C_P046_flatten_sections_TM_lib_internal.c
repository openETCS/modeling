  ...
  outC_C_P046_flatten_sections_TM_lib_internal *outC)
{
  ...
  for (i = 0; i < 99; i++) {
    /* 1 */
    C_P046_fs_flatten_array_reset_TM_lib_internal(&outC->_1_Context_1[i]);
  }
  for (i = 0; i < 33; i++) {
    /* 1 */
    C_P046_fs_struct_to_array_reset_TM_lib_internal(&outC->Context_1[i]);
  }
}
  ...
  outC_C_P046_flatten_sections_TM_lib_internal *outC)
{
  ...
  for (i1 = 0; i1 < 99; i1++) {
    kcg_copy_array_int_2_33(&outC->_L80[i1], &outC->_L74);
  }
  ...
  for (i = 0; i < 99; i++) {
    kcg_copy_P046_sections_array_flat_T_TM(&tmp, &outC->_L78);
    /* 1 */
