...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  TrackSectionData_T_InfraLib /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::SectionData_out */ SectionData_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Balise_Group_373_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises /* 2 */ Context_2;
  outC_Balise_Group_372_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises /* 1 */ _1_Context_1;
  outC_Balise_Group_371_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises /* 1 */ Context_1;
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  TrackSectionData_T_InfraLib /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L4 */ _L4;
  CompressedBaliseMessage_TM /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L3 */ _L3;
  kcg_real /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L2 */ _L2;
  CompressedBaliseMessage_TM /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L1 */ _L1;
  TrackSectionData_T_InfraLib /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L6 */ _L6;
  CompressedBaliseMessage_TM /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L7 */ _L7;
  CompressedBaliseMessage_TM /* AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Balises0004_BijlmerAbcoude::_L8 */ _L8;
