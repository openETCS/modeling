...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005E_array_Told_TM /* TM_conversions::SEND_ConvertP005forWriteSection_IT::SectionArray */ SectionArray;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P005E_Told_TM /* TM_conversions::SEND_ConvertP005forWriteSection_IT::_L365 */ _L365;
