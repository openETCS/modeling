...
void Write_P137_reset_TM_trackside(outC_Write_P137_TM_trackside *outC)
{
  ...
  /* 1 */ C_P137_tracksim_compr_reset_TM_conversions(&outC->Context_1);
}
  ...
  outC_Write_P137_TM_trackside *outC)
{
  ...
  /* 1 */ C_P137_tracksim_compr_TM_conversions(&outC->_L1, &outC->Context_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_1.P137_compressed);
