  ...
  outC_Balise_Group_365_FirstTest_InfraLib *outC)
{
  ...
  kcg_int _1_noname_1;
  TM_BaliseTelegramHeader_int_T noname_1;
  kcg_bool noname;
  ...
  outC->_L20 = 0;
  /* 1 */
  Balise_365_1_FirstTest_InfraLib(
    &outC->_L9,
    (TM_BaliseTelegramHeader_int_T *) &BG365_header_B1_Balises426,
    outC->_L20,
    &outC->_1_Context_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->_L8,
  ...
  outC->_L21 = 1;
  /* 1 */
  Balise_365_0_FirstTest_InfraLib(
    &outC->_L8,
    (TM_BaliseTelegramHeader_int_T *) &BG365_header_B0_Balises426,
    outC->_L21,
    &outC->_2_Context_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->_L7,
    &outC->_2_Context_1.B_data_out);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_1, &outC->_L7);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_1, &outC->B_data_in_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_1,
    &outC->_L1_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L6, &outC->B_data_out_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_2, &outC->_L6);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_2, &outC->B_data_in_2);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_2,
    &outC->_L1_2);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L5, &outC->B_data_out_2);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_3, &outC->_L5);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_3, &outC->B_data_in_3);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_3,
    &outC->_L1_3);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L4, &outC->B_data_out_3);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_4, &outC->_L4);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_4, &outC->B_data_in_4);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_4,
    &outC->_L1_4);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L3, &outC->B_data_out_4);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_5, &outC->_L3);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_5, &outC->B_data_in_5);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_5,
    &outC->_L1_5);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L2, &outC->B_data_out_5);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->B_data_in_6, &outC->_L2);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1_6, &outC->B_data_in_6);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->B_data_out_6,
    &outC->_L1_6);
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L1, &outC->B_data_out_6);
  ...
  kcg_copy_TM_BaliseTelegramHeader_int_T(&outC->_L3_1, &outC->Header_1);
  kcg_copy_TM_BaliseTelegramHeader_int_T(&noname_1, &outC->_L3_1);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_365_FirstTest_InfraLib.c
** Generation date: 2015-04-24T10:59:33
*************************************************************$ */
