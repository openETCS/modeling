...
void Balise_Interdistance_reset_FirstTest_InfraLib(
  outC_Balise_Interdistance_FirstTest_InfraLib *outC)
{
}

/* FirstTest::InfraLib::Balise_Interdistance */
void Balise_Interdistance_FirstTest_InfraLib(
  ...
  outC_Balise_Interdistance_FirstTest_InfraLib *outC)
{
  ...
  outC->_L3 = Distance_Balises_in_BG_FirstTest_InfraLib;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Interdistance_FirstTest_InfraLib.c
** Generation date: 2015-04-25T17:50:04
*************************************************************$ */
