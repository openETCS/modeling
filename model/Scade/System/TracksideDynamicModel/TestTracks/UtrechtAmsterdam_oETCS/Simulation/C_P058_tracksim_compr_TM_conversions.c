  ...
  outC_C_P058_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */ C_P058_flatten_sections_reset_TM_lib_internal(&outC->_1_Context_1);
  ...
  outC_C_P058_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */
  C_P058_flatten_sections_TM_lib_internal(&outC->_L369, &outC->_1_Context_1);
  kcg_copy_P058_sections_array_flat_T_TM(
    &outC->_L380,
    &outC->_1_Context_1.Flattened);
  kcg_copy_array_int_8(&outC->_L384[0], &outC->_L373);
  kcg_copy_P058_sections_array_flat_T_TM(&outC->_L384[8], &outC->_L380);
  outC->_L336 = 0;
  for (i = 0; i < 428; i++) {
    outC->_L209[i] = outC->_L336;
  }
  kcg_copy_array_int_72(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int_428(&outC->_L383[72], &outC->_L209);
  /* 1 */
