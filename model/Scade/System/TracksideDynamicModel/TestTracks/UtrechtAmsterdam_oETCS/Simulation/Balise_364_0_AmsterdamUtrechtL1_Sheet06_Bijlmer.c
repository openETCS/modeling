...
void Balise_364_0_reset_AmsterdamUtrechtL1_Sheet06_Bijlmer(
  outC_Balise_364_0_AmsterdamUtrechtL1_Sheet06_Bijlmer *outC)
{
  /* 1 */
  Packets_BG364_reset_AmsterdamUtrechtL1_Sheet06_Bijlmer(&outC->_1_Context_1);
  /* 1 */ Balise_Localisation_reset_InfraLib(&outC->Context_1);
}

/* AmsterdamUtrechtL1::Sheet06_Bijlmer::Balise_364_0 */
void Balise_364_0_AmsterdamUtrechtL1_Sheet06_Bijlmer(
  ...
  outC_Balise_364_0_AmsterdamUtrechtL1_Sheet06_Bijlmer *outC)
{
  ...
  if (outC->tmp) {
    /* 1 */
    Packets_BG364_AmsterdamUtrechtL1_Sheet06_Bijlmer(
      &outC->_L23,
      &outC->_L5,
      &outC->_1_Context_1);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_364_0_AmsterdamUtrechtL1_Sheet06_Bijlmer.c
** Generation date: 2015-06-09T11:10:49
*************************************************************$ */
