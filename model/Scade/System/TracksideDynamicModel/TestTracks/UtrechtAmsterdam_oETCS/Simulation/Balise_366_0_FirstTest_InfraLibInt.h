...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  B_data_internal_FirstTest_InfraLibInt /* FirstTest::InfraLibInt::Balise_366_0::B_data_out */ B_data_out;
  /* -----------------------  no local probes  ----------------------- */
...
/* FirstTest::InfraLibInt::Balise_366_0 */
extern void Balise_366_0_FirstTest_InfraLibInt(
  /* FirstTest::InfraLibInt::Balise_366_0::B_data_in */B_data_internal_FirstTest_InfraLibInt *B_data_in,
  /* FirstTest::InfraLibInt::Balise_366_0::Header */BaliseTelegramHeader_int_T_TM *Header,
  /* FirstTest::InfraLibInt::Balise_366_0::PIG_nom */kcg_int PIG_nom,
  outC_Balise_366_0_FirstTest_InfraLibInt *outC);

extern void Balise_366_0_reset_FirstTest_InfraLibInt(
  outC_Balise_366_0_FirstTest_InfraLibInt *outC);
