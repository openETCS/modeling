...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Balise_Group_341_FirstTest_InfraLibInt /* 1 */ _6_Context_1;
  outC_Balise_Group_369_FirstTest_InfraLibInt /* 1 */ _5_Context_1;
  outC_Balise_Group_368_FirstTest_InfraLibInt /* 1 */ _4_Context_1;
  outC_Balise_Group_367_FirstTest_InfraLibInt /* 1 */ _3_Context_1;
  outC_Balise_Group_366_FirstTest_InfraLibInt /* 1 */ _2_Context_1;
  outC_Balise_Group_365_FirstTest_InfraLibInt /* 1 */ _1_Context_1;
  outC_Balise_Group_364_FirstTest_InfraLibInt /* 1 */ Context_1;
