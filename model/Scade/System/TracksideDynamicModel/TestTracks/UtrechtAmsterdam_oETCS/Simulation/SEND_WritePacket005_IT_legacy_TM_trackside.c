...
void SEND_WritePacket005_IT_legacy_TM_trackside(
  /* TM_trackside::SEND_WritePacket005_IT_legacy::Packet05 */P005old_TM *Packet05,
  /* TM_trackside::SEND_WritePacket005_IT_legacy::Packets */CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_SEND_WritePacket005_IT_legacy_TM_trackside *outC)
{
  ...
  kcg_copy_P005old_TM(&outC->_L1, Packet05);
  /* 1 */
