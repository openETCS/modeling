...
{
  /* 1 */ Balise_Group_Close_reset_InfraLib(&outC->_2_Context_1);
  /* 2 */
  ...
  outC_Balise_Group_387_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  ...
  Balise_387_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    ...
    outC->_L21,
    &outC->Context_2);
  kcg_copy_B_data_internal_T_InfraLib(&outC->_L7, &outC->Context_2.B_data_out);
  ...
  /* 1 */
  Balise_Group_Close_InfraLib(&outC->_L16, &outC->_L29, &outC->_2_Context_1);
