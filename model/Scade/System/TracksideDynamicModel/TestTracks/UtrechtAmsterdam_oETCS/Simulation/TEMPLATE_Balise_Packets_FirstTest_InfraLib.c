...
void TEMPLATE_Balise_Packets_reset_FirstTest_InfraLib(
  outC_TEMPLATE_Balise_Packets_FirstTest_InfraLib *outC)
{
}

/* FirstTest::InfraLib::TEMPLATE_Balise_Packets */
void TEMPLATE_Balise_Packets_FirstTest_InfraLib(
  ...
  outC_TEMPLATE_Balise_Packets_FirstTest_InfraLib *outC)
{
  ...
  kcg_copy_B_data_internal_FirstTest_InfraLib(&outC->_L32, &outC->_L31);
  if (kcg_true) {
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** TEMPLATE_Balise_Packets_FirstTest_InfraLib.c
** Generation date: 2015-04-24T10:59:33
*************************************************************$ */
