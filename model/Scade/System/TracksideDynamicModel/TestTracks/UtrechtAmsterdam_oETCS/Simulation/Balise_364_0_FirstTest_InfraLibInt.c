...
void Balise_364_0_reset_FirstTest_InfraLibInt(
  outC_Balise_364_0_FirstTest_InfraLibInt *outC)
{
  /* 1 */ Balise_Packets_364_reset_FirstTest_InfraLibInt(&outC->_1_Context_1);
  /* 1 */ Balise_Localisation_reset_FirstTest_InfraLibInt(&outC->Context_1);
}

/* FirstTest::InfraLibInt::Balise_364_0 */
void Balise_364_0_FirstTest_InfraLibInt(
  ...
  outC_Balise_364_0_FirstTest_InfraLibInt *outC)
{
  ...
  if (outC->tmp) {
    /* 1 */
    Balise_Packets_364_FirstTest_InfraLibInt(
      &outC->_L23,
      &outC->_L5,
      &outC->_1_Context_1);
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_364_0_FirstTest_InfraLibInt.c
** Generation date: 2015-06-02T15:02:42
*************************************************************$ */
