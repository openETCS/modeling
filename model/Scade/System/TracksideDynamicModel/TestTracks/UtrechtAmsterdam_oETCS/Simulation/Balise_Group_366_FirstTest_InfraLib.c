  ...
  outC_Balise_Group_366_FirstTest_InfraLib *outC)
{
  ...
  outC->_L20 = 0;
  /* 1 */
  Balise_366_1_FirstTest_InfraLib(
    &outC->_L9,
    (TM_BaliseTelegramHeader_int_T *) &BG366_header_B1_Balises426,
    outC->_L20,
    &outC->_1_Context_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->_L8,
  ...
  outC->_L21 = 1;
  /* 1 */
  Balise_366_0_FirstTest_InfraLib(
    &outC->_L8,
    (TM_BaliseTelegramHeader_int_T *) &BG366_header_B0_Balises426,
    outC->_L21,
    &outC->_2_Context_1);
  kcg_copy_B_data_internal_FirstTest_InfraLib(
    &outC->_L7,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_366_FirstTest_InfraLib.c
** Generation date: 2015-04-24T10:59:33
*************************************************************$ */
