...
typedef struct {
  ...
  _3_Radio_TrackTrain_Header_T_TM /* TM_specific::DIRTY_m_version_filter_for_aprobst::_L2 */ _L2;
  ...
  _3_Radio_TrackTrain_Header_T_TM /* TM_specific::DIRTY_m_version_filter_for_aprobst::_L38 */ _L38;
