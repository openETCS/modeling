...
#include "SmuTypes.h"
#include "kcg_types.h"
#include "SIM_05_Amstel_Standalone_AmsterdamUtrechtL1_Sheet05_Amstel_type.h"
...
TypeUtils _SCSIM_struct__1383_Utils = {struct__1383_to_string,
	check_struct__1383_string,
	string_to_struct__1383,
	is_struct__1383_allow_double_convertion,
	0,
	compare_struct__1383_type,
	get_struct__1383_signature,
	get_struct__1383_filter_utils,
	struct__1383_filter_size,
	struct__1383_filter_values};
TypeUtils _SCSIM_array__1391_Utils = {array__1391_to_string,
	check_array__1391_string,
	string_to_array__1391,
	is_array__1391_allow_double_convertion,
	0,
	compare_array__1391_type,
	get_array__1391_signature,
	get_array__1391_filter_utils,
	array__1391_filter_size,
	array__1391_filter_values};
TypeUtils _SCSIM_struct__1394_Utils = {struct__1394_to_string,
	check_struct__1394_string,
	string_to_struct__1394,
	is_struct__1394_allow_double_convertion,
	0,
	compare_struct__1394_type,
	get_struct__1394_signature,
	get_struct__1394_filter_utils,
	struct__1394_filter_size,
	struct__1394_filter_values};
TypeUtils _SCSIM_struct__1399_Utils = {struct__1399_to_string,
	check_struct__1399_string,
	string_to_struct__1399,
	is_struct__1399_allow_double_convertion,
	0,
	compare_struct__1399_type,
	get_struct__1399_signature,
	get_struct__1399_filter_utils,
	struct__1399_filter_size,
	struct__1399_filter_values};
TypeUtils _SCSIM_struct__1412_Utils = {struct__1412_to_string,
	check_struct__1412_string,
	string_to_struct__1412,
	is_struct__1412_allow_double_convertion,
	0,
	compare_struct__1412_type,
	get_struct__1412_signature,
	get_struct__1412_filter_utils,
	struct__1412_filter_size,
	struct__1412_filter_values};
TypeUtils _SCSIM_struct__1417_Utils = {struct__1417_to_string,
	check_struct__1417_string,
	string_to_struct__1417,
	is_struct__1417_allow_double_convertion,
	0,
	compare_struct__1417_type,
	get_struct__1417_signature,
	get_struct__1417_filter_utils,
	struct__1417_filter_size,
	struct__1417_filter_values};
TypeUtils _SCSIM_struct__1423_Utils = {struct__1423_to_string,
	check_struct__1423_string,
	string_to_struct__1423,
	is_struct__1423_allow_double_convertion,
	0,
	compare_struct__1423_type,
	get_struct__1423_signature,
	get_struct__1423_filter_utils,
	struct__1423_filter_size,
	struct__1423_filter_values};
...
TypeUtils _SCSIM_struct__1436_Utils = {struct__1436_to_string,
	check_struct__1436_string,
	string_to_struct__1436,
	is_struct__1436_allow_double_convertion,
	0,
	compare_struct__1436_type,
	get_struct__1436_signature,
	get_struct__1436_filter_utils,
	struct__1436_filter_size,
	struct__1436_filter_values};
 ...
 ** struct__1383
 ****************************************************************/
static void Fill_struct__1383_StructSimValue(struct__1383 * pStruct, StructSimValue * pValues) {
	/*nid_packet label.*/
...
const char * struct__1383_to_string(const void* pValue) {
	static StructSimValue values[5];
	Fill_struct__1383_StructSimValue(((struct__1383*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 5);
}

int string_to_struct__1383(const char* strValue, void* pValue) {
	static struct__1383 rTemp;
	int nResult = 0;
	static StructSimValue values[5];
	kcg_copy_struct__1383(&(rTemp), &(*((struct__1383*)pValue)));
	Fill_struct__1383_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 5);
	if (nResult == 1)
		kcg_copy_struct__1383(&(*((struct__1383*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1383_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[5];
	Fill_struct__1383_StructSimValue((struct__1383*)pValue, values);
...
const char * get_struct__1383_signature() {
	static StructSimValue values[5];
	Fill_struct__1383_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 5);
}

FilterUtils get_struct__1383_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[5];
	Fill_struct__1383_StructSimValue((struct__1383*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 5, strFilter);
}

const char * struct__1383_filter_values[5] = {"nid_packet", "q_dir", "valid", "startAddress", "endAddress"};
int check_struct__1383_string(const char* strValue) {
	static struct__1383 rTemp;
	return string_to_struct__1383(strValue, &rTemp);
}
 ...
 ** array__1391
 ****************************************************************/
void* array__1391_projection(void** pValues, int nIndex) {
	return &((*(array__1391*)pValues)[nIndex]);
}

const char * array__1391_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, struct__1383_to_string, 30, array__1391_projection);
}

int compare_array__1391_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_struct__1383_type , 30, array__1391_projection);
}
...
int string_to_array__1391(const char* strValue, void* pValue) {
	static array__1391 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_struct__1383, 30, array__1391_projection);
	if (nResult == 1)
		kcg_copy_array__1391(&(*((array__1391*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array__1391_signature() {
	return pSimulator->m_pfnArraySignature(get_struct__1383_signature, 30);
}

FilterUtils get_array__1391_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_struct__1383_Utils, strFilter, (void**)pValue, 30, array__1391_projection);
}

int check_array__1391_string(const char* strValue) {
	static array__1391 rTemp;
	return string_to_array__1391(strValue, &rTemp);
}
 ...
 ** struct__1394
 ****************************************************************/
static void Fill_struct__1394_StructSimValue(struct__1394 * pStruct, StructSimValue * pValues) {
	/*PacketHeaders label.*/
	pValues[0].m_pPtr = pStruct != 0 ? &(pStruct->PacketHeaders) : 0;
	pValues[0].m_pTypeUtils = &_SCSIM_array__1391_Utils;
...
const char * struct__1394_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1394_StructSimValue(((struct__1394*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__1394(const char* strValue, void* pValue) {
	static struct__1394 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__1394(&(rTemp), &(*((struct__1394*)pValue)));
	Fill_struct__1394_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__1394(&(*((struct__1394*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1394_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1394_StructSimValue((struct__1394*)pValue, values);
...
const char * get_struct__1394_signature() {
	static StructSimValue values[2];
	Fill_struct__1394_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__1394_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1394_StructSimValue((struct__1394*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__1394_filter_values[2] = {"PacketHeaders", "PacketData"};
int check_struct__1394_string(const char* strValue) {
	static struct__1394 rTemp;
	return string_to_struct__1394(strValue, &rTemp);
}
 ...
 ** struct__1399
 ****************************************************************/
static void Fill_struct__1399_StructSimValue(struct__1399 * pStruct, StructSimValue * pValues) {
	/*q_updown label.*/
...
const char * struct__1399_to_string(const void* pValue) {
	static StructSimValue values[10];
	Fill_struct__1399_StructSimValue(((struct__1399*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 10);
}

int string_to_struct__1399(const char* strValue, void* pValue) {
	static struct__1399 rTemp;
	int nResult = 0;
	static StructSimValue values[10];
	kcg_copy_struct__1399(&(rTemp), &(*((struct__1399*)pValue)));
	Fill_struct__1399_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 10);
	if (nResult == 1)
		kcg_copy_struct__1399(&(*((struct__1399*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1399_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[10];
	Fill_struct__1399_StructSimValue((struct__1399*)pValue, values);
...
const char * get_struct__1399_signature() {
	static StructSimValue values[10];
	Fill_struct__1399_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 10);
}

FilterUtils get_struct__1399_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[10];
	Fill_struct__1399_StructSimValue((struct__1399*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 10, strFilter);
}

const char * struct__1399_filter_values[10] = {"q_updown", "m_version", "q_media", "n_pig", "n_total", "m_dup", "m_mcount", "nid_c", "nid_bg", "q_link"};
int check_struct__1399_string(const char* strValue) {
	static struct__1399 rTemp;
	return string_to_struct__1399(strValue, &rTemp);
}
 ...
 ** struct__1412
 ****************************************************************/
static void Fill_struct__1412_StructSimValue(struct__1412 * pStruct, StructSimValue * pValues) {
	/*Header label.*/
	pValues[0].m_pPtr = pStruct != 0 ? &(pStruct->Header) : 0;
	pValues[0].m_pTypeUtils = &_SCSIM_struct__1399_Utils;
	pValues[0].m_pszName = "Header";
	/*Messages label.*/
	pValues[1].m_pPtr = pStruct != 0 ? &(pStruct->Messages) : 0;
	pValues[1].m_pTypeUtils = &_SCSIM_struct__1394_Utils;
	pValues[1].m_pszName = "Messages";
}

const char * struct__1412_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1412_StructSimValue(((struct__1412*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__1412(const char* strValue, void* pValue) {
	static struct__1412 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__1412(&(rTemp), &(*((struct__1412*)pValue)));
	Fill_struct__1412_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__1412(&(*((struct__1412*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1412_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1412_StructSimValue((struct__1412*)pValue, values);
	return pSimulator->m_pfnStructureComparison(pResult, toCompare, values, 2);
}
...
const char * get_struct__1412_signature() {
	static StructSimValue values[2];
	Fill_struct__1412_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__1412_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1412_StructSimValue((struct__1412*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__1412_filter_values[2] = {"Header", "Messages"};
int check_struct__1412_string(const char* strValue) {
	static struct__1412 rTemp;
	return string_to_struct__1412(strValue, &rTemp);
}
 ...
 ** struct__1417
 ****************************************************************/
static void Fill_struct__1417_StructSimValue(struct__1417 * pStruct, StructSimValue * pValues) {
	/*TrainPos_in label.*/
...
const char * struct__1417_to_string(const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__1417_StructSimValue(((struct__1417*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 3);
}

int string_to_struct__1417(const char* strValue, void* pValue) {
	static struct__1417 rTemp;
	int nResult = 0;
	static StructSimValue values[3];
	kcg_copy_struct__1417(&(rTemp), &(*((struct__1417*)pValue)));
	Fill_struct__1417_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 3);
	if (nResult == 1)
		kcg_copy_struct__1417(&(*((struct__1417*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1417_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[3];
	Fill_struct__1417_StructSimValue((struct__1417*)pValue, values);
...
const char * get_struct__1417_signature() {
	static StructSimValue values[3];
	Fill_struct__1417_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 3);
}

FilterUtils get_struct__1417_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[3];
	Fill_struct__1417_StructSimValue((struct__1417*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 3, strFilter);
}

const char * struct__1417_filter_values[3] = {"TrainPos_in", "OffsetTotal", "TrainPosCalibrated"};
int check_struct__1417_string(const char* strValue) {
	static struct__1417 rTemp;
	return string_to_struct__1417(strValue, &rTemp);
}
 ...
 ** struct__1423
 ****************************************************************/
static void Fill_struct__1423_StructSimValue(struct__1423 * pStruct, StructSimValue * pValues) {
	/*TrainPosRaw label.*/
	pValues[0].m_pPtr = pStruct != 0 ? &(pStruct->TrainPosRaw) : 0;
	pValues[0].m_pTypeUtils = &_SCSIM_struct__1417_Utils;
	pValues[0].m_pszName = "TrainPosRaw";
	/*BG_Message label.*/
	pValues[1].m_pPtr = pStruct != 0 ? &(pStruct->BG_Message) : 0;
	pValues[1].m_pTypeUtils = &_SCSIM_struct__1412_Utils;
	pValues[1].m_pszName = "BG_Message";
}

const char * struct__1423_to_string(const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1423_StructSimValue(((struct__1423*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 2);
}

int string_to_struct__1423(const char* strValue, void* pValue) {
	static struct__1423 rTemp;
	int nResult = 0;
	static StructSimValue values[2];
	kcg_copy_struct__1423(&(rTemp), &(*((struct__1423*)pValue)));
	Fill_struct__1423_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 2);
	if (nResult == 1)
		kcg_copy_struct__1423(&(*((struct__1423*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1423_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1423_StructSimValue((struct__1423*)pValue, values);
	return pSimulator->m_pfnStructureComparison(pResult, toCompare, values, 2);
}
...
const char * get_struct__1423_signature() {
	static StructSimValue values[2];
	Fill_struct__1423_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 2);
}

FilterUtils get_struct__1423_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[2];
	Fill_struct__1423_StructSimValue((struct__1423*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 2, strFilter);
}

const char * struct__1423_filter_values[2] = {"TrainPosRaw", "BG_Message"};
int check_struct__1423_string(const char* strValue) {
	static struct__1423 rTemp;
	return string_to_struct__1423(strValue, &rTemp);
}
...
const char * struct__1428_filter_values[5] = {"NID_C", "NID_BG", "Pos", "Or_BG", "Or_Line"};
 ...
 ** struct__1436
 ****************************************************************/
static void Fill_struct__1436_StructSimValue(struct__1436 * pStruct, StructSimValue * pValues) {
	/*header label.*/
	pValues[0].m_pPtr = pStruct != 0 ? &(pStruct->header) : 0;
	pValues[0].m_pTypeUtils = &_SCSIM_struct__1399_Utils;
	pValues[0].m_pszName = "header";
...
const char * struct__1436_to_string(const void* pValue) {
	static StructSimValue values[6];
	Fill_struct__1436_StructSimValue(((struct__1436*)pValue), values);
	return pSimulator->m_pfnStructureToString(values, 6);
}

int string_to_struct__1436(const char* strValue, void* pValue) {
	static struct__1436 rTemp;
	int nResult = 0;
	static StructSimValue values[6];
	kcg_copy_struct__1436(&(rTemp), &(*((struct__1436*)pValue)));
	Fill_struct__1436_StructSimValue(&rTemp, values);
	nResult = pSimulator->m_pfnStructureFromString(strValue, values, 6);
	if (nResult == 1)
		kcg_copy_struct__1436(&(*((struct__1436*)pValue)), &(rTemp));
	return nResult;
}

int compare_struct__1436_type(int* pResult, const char* toCompare, const void* pValue) {
	static StructSimValue values[6];
	Fill_struct__1436_StructSimValue((struct__1436*)pValue, values);
...
const char * get_struct__1436_signature() {
	static StructSimValue values[6];
	Fill_struct__1436_StructSimValue(0, values);
	return pSimulator->m_pfnStructureSignature(values, 6);
}

FilterUtils get_struct__1436_filter_utils(const char* strFilter, void* pValue) {
	static StructSimValue values[6];
	Fill_struct__1436_StructSimValue((struct__1436*)pValue, values);
	return pSimulator->m_pfnGetStructureFilterUtils(values, 6, strFilter);
}

const char * struct__1436_filter_values[6] = {"header", "packets", "engineering_BG_location", "TrainPos", "pig_nom_0", "balise_passed"};
int check_struct__1436_string(const char* strValue) {
	static struct__1436 rTemp;
	return string_to_struct__1436(strValue, &rTemp);
}
...
const char * TrackSectionData_T_InfraLib_to_string(const void* pValue) {
	...
	return struct__1423_to_string(pValue);
}
...
int string_to_TrackSectionData_T_InfraLib(const char* strValue, void* pValue) {
	if (pSimTrackSectionData_T_InfraLibVTable != 0 && pSimTrackSectionData_T_InfraLibVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1423(&(*((TrackSectionData_T_InfraLib*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1423(strValue, pValue);
}
...
int is_TrackSectionData_T_InfraLib_allow_double_convertion() {
	...
	return is_struct__1423_allow_double_convertion();
}
...
int TrackSectionData_T_InfraLib_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1423_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1423_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * TrainPosRaw_T_InfraLib_to_string(const void* pValue) {
	...
	return struct__1417_to_string(pValue);
}
...
int string_to_TrainPosRaw_T_InfraLib(const char* strValue, void* pValue) {
	if (pSimTrainPosRaw_T_InfraLibVTable != 0 && pSimTrainPosRaw_T_InfraLibVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1417(&(*((TrainPosRaw_T_InfraLib*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1417(strValue, pValue);
}
...
int is_TrainPosRaw_T_InfraLib_allow_double_convertion() {
	...
	return is_struct__1417_allow_double_convertion();
}
...
int TrainPosRaw_T_InfraLib_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1417_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1417_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * B_data_internal_T_InfraLib_to_string(const void* pValue) {
	...
	return struct__1436_to_string(pValue);
}
...
int string_to_B_data_internal_T_InfraLib(const char* strValue, void* pValue) {
	if (pSimB_data_internal_T_InfraLibVTable != 0 && pSimB_data_internal_T_InfraLibVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1436(&(*((B_data_internal_T_InfraLib*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1436(strValue, pValue);
}
...
int is_B_data_internal_T_InfraLib_allow_double_convertion() {
	...
	return is_struct__1436_allow_double_convertion();
}
...
int B_data_internal_T_InfraLib_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1436_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1436_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * CompressedBaliseMessage_TM_to_string(const void* pValue) {
	...
	return struct__1412_to_string(pValue);
}
...
int string_to_CompressedBaliseMessage_TM(const char* strValue, void* pValue) {
	if (pSimCompressedBaliseMessage_TMVTable != 0 && pSimCompressedBaliseMessage_TMVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1412(&(*((CompressedBaliseMessage_TM*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1412(strValue, pValue);
}
...
int is_CompressedBaliseMessage_TM_allow_double_convertion() {
	...
	return is_struct__1412_allow_double_convertion();
}
...
int CompressedBaliseMessage_TM_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1412_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1412_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * BaliseTelegramHeader_int_T_TM_to_string(const void* pValue) {
	...
	return struct__1399_to_string(pValue);
}
...
int string_to_BaliseTelegramHeader_int_T_TM(const char* strValue, void* pValue) {
	if (pSimBaliseTelegramHeader_int_T_TMVTable != 0 && pSimBaliseTelegramHeader_int_T_TMVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1399(&(*((BaliseTelegramHeader_int_T_TM*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1399(strValue, pValue);
}
...
int is_BaliseTelegramHeader_int_T_TM_allow_double_convertion() {
	...
	return is_struct__1399_allow_double_convertion();
}
...
int BaliseTelegramHeader_int_T_TM_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1399_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1399_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
int string_to_BaliseGroupData_TM(const char* strValue, void* pValue) {
	if (pSimBaliseGroupData_TMVTable != 0 && pSimBaliseGroupData_TMVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1428(&(*((BaliseGroupData_TM*)pValue)), &(rTemp));
		return nResult;
	}
...
const char * CompressedPackets_T_Common_Types_Pkg_to_string(const void* pValue) {
	...
	return struct__1394_to_string(pValue);
}
...
int string_to_CompressedPackets_T_Common_Types_Pkg(const char* strValue, void* pValue) {
	if (pSimCompressedPackets_T_Common_Types_PkgVTable != 0 && pSimCompressedPackets_T_Common_Types_PkgVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1394(&(*((CompressedPackets_T_Common_Types_Pkg*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1394(strValue, pValue);
}
...
int is_CompressedPackets_T_Common_Types_Pkg_allow_double_convertion() {
	...
	return is_struct__1394_allow_double_convertion();
}
...
int CompressedPackets_T_Common_Types_Pkg_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1394_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1394_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * Metadata_T_Common_Types_Pkg_to_string(const void* pValue) {
	...
	return array__1391_to_string(pValue);
}
...
int string_to_Metadata_T_Common_Types_Pkg(const char* strValue, void* pValue) {
	if (pSimMetadata_T_Common_Types_PkgVTable != 0 && pSimMetadata_T_Common_Types_PkgVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_array__1391(&(*((Metadata_T_Common_Types_Pkg*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_array__1391(strValue, pValue);
}
...
int is_Metadata_T_Common_Types_Pkg_allow_double_convertion() {
	...
	return is_array__1391_allow_double_convertion();
}
...
int Metadata_T_Common_Types_Pkg_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_array__1391_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_array__1391_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
const char * MetadataElement_T_Common_Types_Pkg_to_string(const void* pValue) {
	...
	return struct__1383_to_string(pValue);
}
...
int string_to_MetadataElement_T_Common_Types_Pkg(const char* strValue, void* pValue) {
	if (pSimMetadataElement_T_Common_Types_PkgVTable != 0 && pSimMetadataElement_T_Common_Types_PkgVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1383(&(*((MetadataElement_T_Common_Types_Pkg*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1383(strValue, pValue);
}
...
int is_MetadataElement_T_Common_Types_Pkg_allow_double_convertion() {
	...
	return is_struct__1383_allow_double_convertion();
}
...
int MetadataElement_T_Common_Types_Pkg_to_double(double * nValue, const void* pValue) {
	...
	if (_SCSIM_struct__1383_Utils.m_pfnTypeToDouble != 0)
		return _SCSIM_struct__1383_Utils.m_pfnTypeToDouble(nValue, pValue);
	return 0;
}
...
int string_to_BaliseGroupData_Basics(const char* strValue, void* pValue) {
	if (pSimBaliseGroupData_BasicsVTable != 0 && pSimBaliseGroupData_BasicsVTable->m_pfnGetConvInfo(SptNone, SptString) == 1) {
		...
		if (nResult == 1)
			kcg_copy_struct__1428(&(*((BaliseGroupData_Basics*)pValue)), &(rTemp));
		return nResult;
	}
	return string_to_struct__1428(strValue, pValue);
}
