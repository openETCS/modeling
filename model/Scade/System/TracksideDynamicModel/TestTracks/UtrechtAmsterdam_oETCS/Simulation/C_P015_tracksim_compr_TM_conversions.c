  ...
  outC_C_P015_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */ C_P015_flatten_sections_reset_TM_lib_internal(&outC->Context_1);
}
  ...
  outC_C_P015_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */
  C_P015_flatten_sections_TM_lib_internal(&outC->_L398, &outC->Context_1);
  ...
  if (outC->IfBlock1_clock_1) {
    ...
    _11_q_dir_1 = outC->_L4_14_IfBlock1;
    ...
    if (outC->_3_else_clock_1_IfBlock1) {
      ...
      if (outC->else_clock_1_IfBlock1) {
        ...
        _6_q_dir_1 = outC->_L2_12_IfBlock1;
  ...
  if (outC->IfBlock1_clock_1) {
    ...
    _10_error_1 = outC->_L5_15_IfBlock1;
