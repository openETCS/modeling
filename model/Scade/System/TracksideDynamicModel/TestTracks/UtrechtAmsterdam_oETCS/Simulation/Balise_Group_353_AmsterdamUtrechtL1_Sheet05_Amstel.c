...
void Balise_Group_353_reset_AmsterdamUtrechtL1_Sheet05_Amstel(
  outC_Balise_Group_353_AmsterdamUtrechtL1_Sheet05_Amstel *outC)
{
  /* 1 */ Balise_Group_Close_reset_InfraLib(&outC->_3_Context_1);
  /* 1 */
  Balise_353_1_reset_AmsterdamUtrechtL1_Sheet05_Amstel(&outC->_2_Context_1);
  /* 1 */
  Balise_353_0_reset_AmsterdamUtrechtL1_Sheet05_Amstel(&outC->_1_Context_1);
  /* 1 */ Balise_Group_Init_reset_InfraLib(&outC->Context_1);
}

/* AmsterdamUtrechtL1::Sheet05_Amstel::Balise_Group_353 */
void Balise_Group_353_AmsterdamUtrechtL1_Sheet05_Amstel(
  /* AmsterdamUtrechtL1::Sheet05_Amstel::Balise_Group_353::BG_message_in */CompressedBaliseMessage_TM *BG_message_in,
  /* AmsterdamUtrechtL1::Sheet05_Amstel::Balise_Group_353::TrainPos */kcg_real TrainPos,
  /* AmsterdamUtrechtL1::Sheet05_Amstel::Balise_Group_353::Engineering_Data */BaliseGroupData_TM *Engineering_Data,
  outC_Balise_Group_353_AmsterdamUtrechtL1_Sheet05_Amstel *outC)
{
  kcg_int _6_noname_6;
  ...
  outC->_L20 = 0;
  /* 1 */
  Balise_353_0_AmsterdamUtrechtL1_Sheet05_Amstel(
    &outC->_L9,
  ...
  outC->_L21 = 1;
  /* 1 */
  Balise_353_1_AmsterdamUtrechtL1_Sheet05_Amstel(
    &outC->_L8,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_353_AmsterdamUtrechtL1_Sheet05_Amstel.c
** Generation date: 2015-06-06T10:22:38
*************************************************************$ */
