...
void C_header_to_M003_reset_TM_radio_messages(
  outC_C_header_to_M003_TM_radio_messages *outC)
{
  /* 1 */ CAST_Int_to_M_ACK_reset_TM_conversions(&outC->_1_Context_1);
  /* 1 */ CAST_Int_to_NID_LRBG_reset_TM_conversions(&outC->Context_1);
}
