...
void DIRTY_m_version_filter_fo_TM_specific(
  /* TM_specific::DIRTY_m_version_filter_for_aprobst::RadioMessage_in */CompressedRadioMessage_TM *RadioMessage_in,
  outC_DIRTY_m_version_filter_fo_TM_specific *outC)
{
  kcg_copy_CompressedRadioMessage_TM(&outC->_L1, RadioMessage_in);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
    &outC->_L3,
    &outC->_L1.Messages);
  outC->_L40 = 32;
  kcg_copy__3_Radio_TrackTrain_Header_T_TM(&outC->_L2, &outC->_L1.Header);
  ...
  kcg_copy__3_Radio_TrackTrain_Header_T_TM(&outC->_L38, &outC->_L2);
  if (kcg_true) {
    outC->_L38.m_version = outC->_L43;
  }
  kcg_copy__3_Radio_TrackTrain_Header_T_TM(&outC->_L6.Header, &outC->_L38);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
    &outC->_L6.Messages,
    &outC->_L3);
