...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P058_sections_array_flat_T_TM /* TM_lib_internal::C_P058_flatten_sections::Flattened */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P058_fs_flatten_array_TM_lib_internal /* 1 */ _1_Context_1[64];
  outC_C_P058_fs_struct_to_array_TM_lib_internal /* 1 */ Context_1[32];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P058_sections_array_flat_T_TM /* TM_lib_internal::C_P058_flatten_sections::_L76 */ _L76;
  P058_OBU_sectionlist_int_T_TM /* TM_lib_internal::C_P058_flatten_sections::_L75 */ _L75;
  array_int_2_32 /* TM_lib_internal::C_P058_flatten_sections::_L74 */ _L74;
  P058_sections_array_flat_T_TM /* TM_lib_internal::C_P058_flatten_sections::_L78 */ _L78;
  array_int_2_32_64 /* TM_lib_internal::C_P058_flatten_sections::_L80 */ _L80;
