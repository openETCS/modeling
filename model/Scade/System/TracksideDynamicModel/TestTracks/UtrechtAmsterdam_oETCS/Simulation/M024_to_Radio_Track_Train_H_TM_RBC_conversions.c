...
void M024_to_Radio_Track_Train_H_reset_TM_RBC_conversions(
  ...
  outC_M024_to_Radio_Track_Train_H_TM_RBC_conversions *outC)
{
  ...
  outC->_L25 = default_receivedSystemTime_TM_RBC_conversions;
  outC->_L24 = default_radioDevice_TM_RBC_conversions;
  outC->_L23 = default_m_version_TM_RBC_conversions;
  outC->_L22 = default_d_emergencystop_TM_RBC_conversions;
  outC->_L21 = default_q_dir_TM_RBC_conversions;
  outC->_L20 = default_d_ref_TM_RBC_conversions;
  outC->_L19 = default_t_sh_rqst_TM_RBC_conversions;
  outC->_L18 = default_d_sr_TM_RBC_conversions;
  outC->_L17 = default_q_scale_TM_RBC_conversions;
  outC->_L16 = default_nid_em_TM_RBC_conversions;
