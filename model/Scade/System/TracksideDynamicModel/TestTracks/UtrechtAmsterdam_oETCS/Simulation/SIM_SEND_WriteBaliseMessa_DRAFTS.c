...
void SIM_SEND_WriteBaliseMessa_reset_DRAFTS(
  outC_SIM_SEND_WriteBaliseMessa_DRAFTS *outC)
{
  kcg_int i;
  
  for (i = 0; i < 30; i++) {
    /* 1 */ SEND_FindSlot_reset_DRAFTS(&outC->Context_1[i]);
  }
}

/* DRAFTS::SIM_SEND_WriteBaliseMessageHeader */
void SIM_SEND_WriteBaliseMessa_DRAFTS(
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** SIM_SEND_WriteBaliseMessa_DRAFTS.c
** Generation date: 2015-06-09T14:04:51
*************************************************************$ */
