...
/* ========================  input structure  ====================== */
typedef struct {
  B_data_internal_InfraLib /* InfraLib::Balise_Localisation::B_data_in */ B_data_in;
  TM_BaliseTelegramHeader_int_T /* InfraLib::Balise_Localisation::Header */ Header;
  kcg_int /* InfraLib::Balise_Localisation::PIG_nom */ PIG_nom;
} inC_Balise_Localisation_InfraLib;
...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_TOOLS_convert_engineering /* 1 */ _1_Context_1;
  outC_Balise_Interdistance_InfraLib /* 1 */ Context_1;
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  kcg_int /* InfraLib::Balise_Localisation::_L15 */ _L15;
  TM_BaliseTelegramHeader_int_T /* InfraLib::Balise_Localisation::_L16 */ _L16;
  ...
  B_data_internal_InfraLib /* InfraLib::Balise_Localisation::_L65 */ _L65;
  kcg_int /* InfraLib::Balise_Localisation::_L66 */ _L66;
  kcg_bool /* InfraLib::Balise_Localisation::_L72 */ _L72;
  B_data_internal_InfraLib /* InfraLib::Balise_Localisation::_L71 */ _L71;
