...
\paragraph{API\_persistentDataIn}

\begin{longtable}{p{.25\textwidth}p{.7\textwidth}}
\toprule
Input name				& API\_persistentDataIn \\
\midrule
...
\paragraph{API\_persistentDataOut}

\begin{longtable}{p{.25\textwidth}p{.7\textwidth}}
\toprule
Output name				& API\_persistentDataOut \\
\midrule
Description				& Storage of data which need to be loaded in order to be able to start the start of mission procedure. The data has to be saved as a part of the end of mission procedure. \\
\midrule
Destination				& EVC-Storage \\ 
\midrule
Type					& structure \\
\midrule
Valid range of values	& n/a \\
