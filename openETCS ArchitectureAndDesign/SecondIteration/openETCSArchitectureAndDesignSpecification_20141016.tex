...
\begin{figure}[hbtp]
\centering
\includegraphics [angle=90, scale=0.6] {images/F1 Exchange input.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics [angle=90, scale=1.0] {images/Manage inputs.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics [angle=90, scale=0.8] {images/F 1.png}
...
The data, which is based on the monitoring.\\
 ...
 \begin{figure}[hbtp]
\centering
\includegraphics [angle=90, scale=0.5] {images/Manage Level and Modes.png}
\caption{Elaboration track messages breakdown}
\end{figure}
