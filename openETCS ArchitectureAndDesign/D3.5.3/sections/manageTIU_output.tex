...
\midrule
Description				& This module allows to send  command the change of traction, the raising / lowering of an overhead pantograph and command the air tightness function to activate/deactivate where certain trackside data has been received\\
\midrule
Input documents	& 
Alstom API\newline
Subset-034\\
