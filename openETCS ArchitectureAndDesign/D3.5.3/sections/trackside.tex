...
\todo[inline]{Chapter needs to be completed. Will there be more components?}
...
An overview of the interface of component TrackMessages is shown in Figure~\ref{f:trackside_interface}. The inputs and outputs are described in detail in Section~\ref{s:trackside_inputs} respectively \ref{s:trackside_outputs}.
