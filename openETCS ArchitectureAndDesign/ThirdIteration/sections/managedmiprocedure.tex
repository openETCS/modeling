...
\subsubsection{Macrofunction x in Manage DMI Procedure}%Mainfunction receive track data. Name should be be defined and substituded by the designer of the function. 
