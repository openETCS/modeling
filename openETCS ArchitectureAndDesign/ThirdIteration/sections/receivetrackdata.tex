...
\subsubsection{Macrofunction x in Receive Track Data}%Mainfunction receive track data. Name should be be defined and substituded by the designer of the function. 
