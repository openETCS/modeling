...
\subsubsection{functional block x in Manage Outputs}%Mainfunction Manage Outputs. Name should be be defined and substituded by the designer of the function. 
