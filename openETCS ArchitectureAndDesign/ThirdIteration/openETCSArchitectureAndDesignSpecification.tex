...
\item \gls{LTM} (Loop Transmission Module): Not part of this openETCS implementation;
\item EURORADIO;
...
% LocalWords:  Alstom openETCS \gls{EVC} BIU TIU Odometry \gls{DMI} \gls{STM} \gls{BTM} Balise \gls{LTM} \gls{API}
