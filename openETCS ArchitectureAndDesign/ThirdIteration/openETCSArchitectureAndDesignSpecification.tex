...
\item Output is encoded according to the \gls{SRS} and passed to the buffers of the units.
\end{itemize}
\end{itemize}
...
9: Request To Shorten MA &
 % 49: List of balises for SH Area\newline  %% Packet not allowed in message 9 (according to SRS 8.7.5)
 80: Mode profile\newline 
...
\subsubsection{Data}
The module makes use of internal data for collecting and checking the balise telegrams.
...
The first stage of the module is the reception of Euroradio-messages and Eurobalise-Telegrams from the openETCS-API.
...
\paragraph{Part 2: Check BG Consistency}
...
\paragraph{Part 3: ReceiveEuroRadioFromAPI}
\subparagraph{Short Description of Functionality}
...
\paragraph{Part 4: CheckEuroradioMessage}
\subparagraph{Short Description of Functionality}
...
\paragraph{Part 5: MergeInputChannel}
...
\paragraph{Part 6: ValidateDataDirection}
