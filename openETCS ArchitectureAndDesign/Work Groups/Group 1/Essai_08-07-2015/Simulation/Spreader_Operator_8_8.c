...
void Spreader_Operator_reset_8_8(outC_Spreader_Operator_8_8 *outC)
{
  kcg_int i;
  
  for (i = 0; i < 25; i++) {
    /* 1 */ ScanPositions_reset_8_8(&outC->Context_1[i]);
  }
}

/* Spreader_Operator */
void Spreader_Operator_8_8(
  ...
  outC_Spreader_Operator_8_8 *outC)
{
  ...
  kcg_copy_array__1553(&outC->_L11, SSP_n);
  for (i3 = 0; i3 < 25; i3++) {
    kcg_copy_array__1553(&outC->_L2[i3], &outC->_L11);
  }
  outC->_L10 = Vmax;
  for (i2 = 0; i2 < 25; i2++) {
