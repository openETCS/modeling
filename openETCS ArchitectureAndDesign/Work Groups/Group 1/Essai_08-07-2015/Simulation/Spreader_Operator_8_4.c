...
void Spreader_Operator_reset_8_4(outC_Spreader_Operator_8_4 *outC)
{
  kcg_int i;
  
  for (i = 0; i < 25; i++) {
    /* 1 */ ScanPositions_reset_8_4(&outC->Context_1[i]);
  }
}

/* Spreader_Operator */
void Spreader_Operator_8_4(
