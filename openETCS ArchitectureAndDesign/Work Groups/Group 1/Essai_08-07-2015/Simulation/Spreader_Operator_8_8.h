...
*************************************************************$ */
#ifndef _Spreader_Operator_8_8_H_
#define _Spreader_Operator_8_8_H_
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_ScanPositions_8_8 /* 1 */ Context_1[25];
...
} outC_Spreader_Operator_8_8;

/* ===========  node initialization and cycle functions  =========== */
/* Spreader_Operator */
extern void Spreader_Operator_8_8(
  /* Spreader_Operator::SSP_n */array__1553 *SSP_n,
  /* Spreader_Operator::Position */array_real_25 *Position,
  outC_Spreader_Operator_8_8 *outC);

extern void Spreader_Operator_reset_8_8(outC_Spreader_Operator_8_8 *outC);

#endif /* _Spreader_Operator_8_8_H_ */
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Spreader_Operator_8_8.h
** Generation date: 2015-06-24T16:37:31
*************************************************************$ */
