...
TypeUtils _SCSIM_array_bool_12_Utils = {array_bool_12_to_string,
	check_array_bool_12_string,
	string_to_array_bool_12,
	is_array_bool_12_allow_double_convertion,
	0,
	compare_array_bool_12_type,
	get_array_bool_12_signature,
	get_array_bool_12_filter_utils,
	array_bool_12_filter_size,
	array_bool_12_filter_values};
TypeUtils _SCSIM_array_real_12_Utils = {array_real_12_to_string,
	check_array_real_12_string,
	string_to_array_real_12,
	is_array_real_12_allow_double_convertion,
	0,
	compare_array_real_12_type,
	get_array_real_12_signature,
	get_array_real_12_filter_utils,
	array_real_12_filter_size,
	array_real_12_filter_values};
 ...
 ** array_bool_12
 ****************************************************************/
void* array_bool_12_projection(void** pValues, int nIndex) {
	return &((*(array_bool_12*)pValues)[nIndex]);
}

const char * array_bool_12_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, kcg_bool_to_string, 12, array_bool_12_projection);
}

int compare_array_bool_12_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_kcg_bool_type , 12, array_bool_12_projection);
}
...
int string_to_array_bool_12(const char* strValue, void* pValue) {
	static array_bool_12 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_kcg_bool, 12, array_bool_12_projection);
	if (nResult == 1)
		kcg_copy_array_bool_12(&(*((array_bool_12*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array_bool_12_signature() {
	return pSimulator->m_pfnArraySignature(get_kcg_bool_signature, 12);
}

FilterUtils get_array_bool_12_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_kcg_bool_Utils, strFilter, (void**)pValue, 12, array_bool_12_projection);
}

int check_array_bool_12_string(const char* strValue) {
	static array_bool_12 rTemp;
	return string_to_array_bool_12(strValue, &rTemp);
}
 ...
 ** array_real_12
 ****************************************************************/
void* array_real_12_projection(void** pValues, int nIndex) {
	return &((*(array_real_12*)pValues)[nIndex]);
}

const char * array_real_12_to_string(const void* pValue) {
	return (char*) pSimulator->m_pfnArrayToString((const void**)pValue, kcg_real_to_string, 12, array_real_12_projection);
}

int compare_array_real_12_type(int* pResult, const char* toCompare, const void* pValue) {
	return pSimulator->m_pfnArrayComparison(pResult, toCompare, (const void**)pValue, compare_kcg_real_type , 12, array_real_12_projection);
}
...
int string_to_array_real_12(const char* strValue, void* pValue) {
	static array_real_12 rTemp;
	int nResult = pSimulator->m_pfnArrayFromString(strValue, (void**)(void*)&rTemp, string_to_kcg_real, 12, array_real_12_projection);
	if (nResult == 1)
		kcg_copy_array_real_12(&(*((array_real_12*)pValue)), &(rTemp));
	return nResult;
}

const char * get_array_real_12_signature() {
	return pSimulator->m_pfnArraySignature(get_kcg_real_signature, 12);
}

FilterUtils get_array_real_12_filter_utils(const char* strFilter, void* pValue) {
	return pSimulator->m_pfnGetArrayFilterUtils(&_SCSIM_kcg_real_Utils, strFilter, (void**)pValue, 12, array_real_12_projection);
}

int check_array_real_12_string(const char* strValue) {
	static array_real_12 rTemp;
	return string_to_array_real_12(strValue, &rTemp);
}
